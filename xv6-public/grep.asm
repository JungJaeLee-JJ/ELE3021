...
main(int argc, char *argv[])
{
  ...
  3b:	6a 00                	push   $0x0
  3d:	ff 33                	pushl  (%ebx)
  3f:	e8 ae 05 00 00       	call   5f2 <open>
  ...
  62:	e8 73 05 00 00       	call   5da <close>
  if(argc <= 2){
    grep(pattern, 0);
    exit();
  }
  ...
  exit();
  6f:	e8 3e 05 00 00       	call   5b2 <exit>
    exit();
  }
  ...
  7e:	e8 ad 06 00 00       	call   730 <printf>
      exit();
  83:	e8 2a 05 00 00       	call   5b2 <exit>
    exit();
  }
  pattern = argv[1];
  ...
  8d:	e8 8e 01 00 00       	call   220 <grep>
    exit();
  92:	e8 1b 05 00 00       	call   5b2 <exit>
{
  int fd, i;
  char *pattern;
  ...
  a0:	e8 8b 06 00 00       	call   730 <printf>
    exit();
  a5:	e8 08 05 00 00       	call   5b2 <exit>
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ae:	66 90                	xchg   %ax,%ax
...
grep(char *pattern, int fd)
{
 ...
 250:	e8 75 03 00 00       	call   5ca <read>
 ...
 260:	01 45 e4             	add    %eax,-0x1c(%ebp)
    buf[m] = '\0';
    p = buf;
 263:	bb 60 0e 00 00       	mov    $0xe60,%ebx
  int n, m;
  char *p, *q;
 ...
 268:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    buf[m] = '\0';
 26b:	c6 82 60 0e 00 00 00 	movb   $0x0,0xe60(%edx)
 ...
 27b:	6a 0a                	push   $0xa
 27d:	53                   	push   %ebx
 27e:	e8 bd 01 00 00       	call   440 <strchr>
 ...
 2b9:	6a 01                	push   $0x1
 2bb:	e8 12 03 00 00       	call   5d2 <write>
 ...
 2c5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if(p == buf)
 2c8:	81 fb 60 0e 00 00    	cmp    $0xe60,%ebx
 ...
 2dd:	83 ec 04             	sub    $0x4,%esp
    ...
    if(m > 0){
      m -= p - buf;
 2e0:	2d 60 0e 00 00       	sub    $0xe60,%eax
 2e5:	29 45 e4             	sub    %eax,-0x1c(%ebp)
 2e8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
      memmove(buf, p, m);
 2eb:	51                   	push   %ecx
 2ec:	53                   	push   %ebx
 2ed:	68 60 0e 00 00       	push   $0xe60
 2f2:	e8 89 02 00 00       	call   580 <memmove>
...
strcmp(const char *p, const char *q)
{
 ...
 35c:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(*p && *p == *q){
 35f:	0f be 03             	movsbl (%ebx),%eax
 362:	0f be 16             	movsbl (%esi),%edx
 365:	84 c0                	test   %al,%al
 367:	74 76                	je     3df <strcmp+0x8f>
 369:	38 c2                	cmp    %al,%dl
 36b:	89 f7                	mov    %esi,%edi
 36d:	74 0f                	je     37e <strcmp+0x2e>
 36f:	eb 38                	jmp    3a9 <strcmp+0x59>
 371:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 378:	38 d0                	cmp    %dl,%al
 37a:	89 fe                	mov    %edi,%esi
 37c:	75 2b                	jne    3a9 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
 37e:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
 ...
 385:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
 388:	50                   	push   %eax
 389:	0f be 03             	movsbl (%ebx),%eax
 38c:	50                   	push   %eax
 38d:	68 86 0a 00 00       	push   $0xa86
 392:	6a 02                	push   $0x2
 394:	e8 97 03 00 00       	call   730 <printf>
}
...
{
  while(*p && *p == *q){
 399:	0f be 03             	movsbl (%ebx),%eax
 39c:	83 c4 10             	add    $0x10,%esp
 39f:	0f be 56 01          	movsbl 0x1(%esi),%edx
 3a3:	84 c0                	test   %al,%al
 3a5:	75 d1                	jne    378 <strcmp+0x28>
 ...
 3a9:	52                   	push   %edx
 3aa:	50                   	push   %eax
 3ab:	68 8d 0a 00 00       	push   $0xa8d
 3b0:	6a 02                	push   $0x2
 3b2:	e8 79 03 00 00       	call   730 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
 3b7:	0f b6 17             	movzbl (%edi),%edx
 3ba:	0f b6 03             	movzbl (%ebx),%eax
 3bd:	83 c4 0c             	add    $0xc,%esp
 3c0:	29 d0                	sub    %edx,%eax
 3c2:	50                   	push   %eax
 3c3:	68 90 0a 00 00       	push   $0xa90
 3c8:	6a 02                	push   $0x2
 3ca:	e8 61 03 00 00       	call   730 <printf>
  return (uchar)*p - (uchar)*q;
 3cf:	0f b6 03             	movzbl (%ebx),%eax
 3d2:	0f b6 17             	movzbl (%edi),%edx
}
...
{
  while(*p && *p == *q){
 3df:	89 f7                	mov    %esi,%edi
 3e1:	31 c0                	xor    %eax,%eax
 3e3:	eb c4                	jmp    3a9 <strcmp+0x59>
...
gets(char *buf, int max)
{
 48b:	83 ec 1c             	sub    $0x1c,%esp
  ...
  for(i=0; i+1 < max; ){
 48e:	eb 29                	jmp    4b9 <gets+0x39>
    cc = read(0, &c, 1);
 490:	83 ec 04             	sub    $0x4,%esp
 493:	6a 01                	push   $0x1
 495:	57                   	push   %edi
 496:	6a 00                	push   $0x0
 498:	e8 2d 01 00 00       	call   5ca <read>
    if(cc < 1)
 ...
 4ad:	3c 0a                	cmp    $0xa,%al
  ...
  for(i=0; i+1 < max; ){
    ...
    if(cc < 1)
      break;
    buf[i++] = c;
 4af:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
 4b3:	74 1b                	je     4d0 <gets+0x50>
 4b5:	3c 0d                	cmp    $0xd,%al
 4b7:	74 17                	je     4d0 <gets+0x50>
gets(char *buf, int max)
{
  int i, cc;
  char c;
...
00000682 <list>:
SYSCALL(list)
 682:	b8 1c 00 00 00       	mov    $0x1c,%eax
 687:	cd 40                	int    $0x40
 689:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6cf:	f7 f6                	div    %esi
 6d1:	0f b6 92 9c 0a 00 00 	movzbl 0xa9c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 708:	e8 c5 fe ff ff       	call   5d2 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 778:	50                   	push   %eax
 779:	57                   	push   %edi
 77a:	e8 53 fe ff ff       	call   5d2 <write>
...
putc(int fd, char c)
{
 ...
 7da:	50                   	push   %eax
 7db:	57                   	push   %edi
 7dc:	e8 f1 fd ff ff       	call   5d2 <write>
...
putc(int fd, char c)
{
 ...
 848:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 84b:	b8 94 0a 00 00       	mov    $0xa94,%eax
...
putc(int fd, char c)
{
 ...
 8bf:	50                   	push   %eax
 8c0:	57                   	push   %edi
 8c1:	e8 0c fd ff ff       	call   5d2 <write>
...
free(void *ap)
{
 ...
 927:	89 08                	mov    %ecx,(%eax)
  freep = p;
 929:	a3 40 0e 00 00       	mov    %eax,0xe40
}
 92e:	5b                   	pop    %ebx
 92f:	5e                   	pop    %esi
 930:	5f                   	pop    %edi
 ...
 94a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 94d:	a3 40 0e 00 00       	mov    %eax,0xe40
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 9ce:	53                   	push   %ebx
 9cf:	e8 66 fc ff ff       	call   63a <sbrk>
  if(p == (char*)-1)
 ...
 a0c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 a0f:	89 15 40 0e 00 00    	mov    %edx,0xe40
      return (void*)(p + 1);
 ...
 a24:	eb e9                	jmp    a0f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a26:	c7 05 40 0e 00 00 44 	movl   $0xe44,0xe40
 a2d:	0e 00 00 
 a30:	c7 05 44 0e 00 00 44 	movl   $0xe44,0xe44
 a37:	0e 00 00 
    base.s.size = 0;
 a3a:	b8 44 0e 00 00       	mov    $0xe44,%eax
 a3f:	c7 05 48 0e 00 00 00 	movl   $0x0,0xe48
 a46:	00 00 00 
