...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 28 03 00 00       	call   362 <unlink>
  ...
  exit();
  4b:	e8 c2 02 00 00       	call   312 <exit>
    exit();
  }
...
main(int argc, char *argv[])
{
  ...
  64:	52                   	push   %edx
  65:	52                   	push   %edx
  66:	68 b0 07 00 00       	push   $0x7b0
  6b:	6a 02                	push   $0x2
  6d:	e8 1e 04 00 00       	call   490 <printf>
    exit();
  72:	e8 9b 02 00 00       	call   312 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q){
  bf:	0f be 03             	movsbl (%ebx),%eax
  c2:	0f be 16             	movsbl (%esi),%edx
  c5:	84 c0                	test   %al,%al
  c7:	74 76                	je     13f <strcmp+0x8f>
  c9:	38 c2                	cmp    %al,%dl
  cb:	89 f7                	mov    %esi,%edi
  cd:	74 0f                	je     de <strcmp+0x2e>
  cf:	eb 38                	jmp    109 <strcmp+0x59>
  d1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  d8:	38 d0                	cmp    %dl,%al
  da:	89 fe                	mov    %edi,%esi
  dc:	75 2b                	jne    109 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
  de:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
  ...
  e5:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
  e8:	50                   	push   %eax
  e9:	0f be 03             	movsbl (%ebx),%eax
  ec:	50                   	push   %eax
  ed:	68 dd 07 00 00       	push   $0x7dd
  f2:	6a 02                	push   $0x2
  f4:	e8 97 03 00 00       	call   490 <printf>
}
...
{
  while(*p && *p == *q){
  f9:	0f be 03             	movsbl (%ebx),%eax
  fc:	83 c4 10             	add    $0x10,%esp
  ff:	0f be 56 01          	movsbl 0x1(%esi),%edx
 103:	84 c0                	test   %al,%al
 105:	75 d1                	jne    d8 <strcmp+0x28>
 ...
 109:	52                   	push   %edx
 10a:	50                   	push   %eax
 10b:	68 e4 07 00 00       	push   $0x7e4
 110:	6a 02                	push   $0x2
 112:	e8 79 03 00 00       	call   490 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
 117:	0f b6 17             	movzbl (%edi),%edx
 11a:	0f b6 03             	movzbl (%ebx),%eax
 11d:	83 c4 0c             	add    $0xc,%esp
 120:	29 d0                	sub    %edx,%eax
 122:	50                   	push   %eax
 123:	68 e7 07 00 00       	push   $0x7e7
 128:	6a 02                	push   $0x2
 12a:	e8 61 03 00 00       	call   490 <printf>
  return (uchar)*p - (uchar)*q;
 12f:	0f b6 03             	movzbl (%ebx),%eax
 132:	0f b6 17             	movzbl (%edi),%edx
}
...
{
  while(*p && *p == *q){
 13f:	89 f7                	mov    %esi,%edi
 141:	31 c0                	xor    %eax,%eax
 143:	eb c4                	jmp    109 <strcmp+0x59>
...
putc(int fd, char c)
{
 ...
 468:	e8 c5 fe ff ff       	call   332 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4d8:	50                   	push   %eax
 4d9:	57                   	push   %edi
 4da:	e8 53 fe ff ff       	call   332 <write>
...
putc(int fd, char c)
{
 ...
 53a:	50                   	push   %eax
 53b:	57                   	push   %edi
 53c:	e8 f1 fd ff ff       	call   332 <write>
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 eb 07 00 00       	mov    $0x7eb,%eax
...
putc(int fd, char c)
{
 ...
 61f:	50                   	push   %eax
 620:	57                   	push   %edi
 621:	e8 0c fd ff ff       	call   332 <write>
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 94 0a 00 00       	mov    %eax,0xa94
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 94 0a 00 00    	mov    0xa94,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 94 0a 00 00    	mov    %edx,0xa94
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 78d:	0a 00 00 
 790:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 98 0a 00 00       	mov    $0xa98,%eax
 79f:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 7a6:	00 00 00 
