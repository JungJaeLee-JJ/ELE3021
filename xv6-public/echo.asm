...
main(int argc, char *argv[])
{
  ...
  28:	68 a0 07 00 00       	push   $0x7a0
  2d:	ff 74 9f fc          	pushl  -0x4(%edi,%ebx,4)
  31:	68 a2 07 00 00       	push   $0x7a2
  36:	6a 01                	push   $0x1
  38:	e8 43 04 00 00       	call   480 <printf>
  3d:	83 c4 10             	add    $0x10,%esp
  40:	83 c3 01             	add    $0x1,%ebx
  43:	39 de                	cmp    %ebx,%esi
  45:	75 e1                	jne    28 <main+0x28>
  47:	68 ac 07 00 00       	push   $0x7ac
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q){
  af:	0f be 03             	movsbl (%ebx),%eax
  b2:	0f be 16             	movsbl (%esi),%edx
  b5:	84 c0                	test   %al,%al
  b7:	74 76                	je     12f <strcmp+0x8f>
  b9:	38 c2                	cmp    %al,%dl
  bb:	89 f7                	mov    %esi,%edi
  bd:	74 0f                	je     ce <strcmp+0x2e>
  bf:	eb 38                	jmp    f9 <strcmp+0x59>
  c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  c8:	38 d0                	cmp    %dl,%al
  ca:	89 fe                	mov    %edi,%esi
  cc:	75 2b                	jne    f9 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
  ce:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
  ...
  d5:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
  d8:	50                   	push   %eax
  d9:	0f be 03             	movsbl (%ebx),%eax
  dc:	50                   	push   %eax
  dd:	68 a7 07 00 00       	push   $0x7a7
  e2:	6a 02                	push   $0x2
  e4:	e8 97 03 00 00       	call   480 <printf>
}
...
strcmp(const char *p, const char *q)
{
  ...
  ef:	0f be 56 01          	movsbl 0x1(%esi),%edx
  f3:	84 c0                	test   %al,%al
  f5:	75 d1                	jne    c8 <strcmp+0x28>
  ...
  f9:	52                   	push   %edx
  fa:	50                   	push   %eax
  fb:	68 ae 07 00 00       	push   $0x7ae
 100:	6a 02                	push   $0x2
 102:	e8 79 03 00 00       	call   480 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
 107:	0f b6 17             	movzbl (%edi),%edx
 10a:	0f b6 03             	movzbl (%ebx),%eax
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	29 d0                	sub    %edx,%eax
 112:	50                   	push   %eax
 113:	68 b1 07 00 00       	push   $0x7b1
 118:	6a 02                	push   $0x2
 11a:	e8 61 03 00 00       	call   480 <printf>
  return (uchar)*p - (uchar)*q;
 11f:	0f b6 03             	movzbl (%ebx),%eax
 122:	0f b6 17             	movzbl (%edi),%edx
}
...
putc(int fd, char c)
{
 ...
 458:	e8 c5 fe ff ff       	call   322 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 4c8:	50                   	push   %eax
 4c9:	57                   	push   %edi
 4ca:	e8 53 fe ff ff       	call   322 <write>
...
putc(int fd, char c)
{
 ...
 52a:	50                   	push   %eax
 52b:	57                   	push   %edi
 52c:	e8 f1 fd ff ff       	call   322 <write>
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 b5 07 00 00       	mov    $0x7b5,%eax
...
free(void *ap)
{
 ...
 677:	89 08                	mov    %ecx,(%eax)
  freep = p;
 679:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 70f:	76 3f                	jbe    750 <malloc+0xa0>
    ...
    if(p == freep)
 711:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
 ...
 736:	e8 e5 fe ff ff       	call   620 <free>
  return freep;
 73b:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 77d:	0a 00 00 
 780:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 60 0a 00 00       	mov    $0xa60,%eax
 78f:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 796:	00 00 00 
