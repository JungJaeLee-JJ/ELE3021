...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 f4 09 00 00       	mov    %eax,0x9f4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6af:	76 3f                	jbe    6f0 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	39 05 f4 09 00 00    	cmp    %eax,0x9f4
 ...
 6d6:	e8 e5 fe ff ff       	call   5c0 <free>
  return freep;
 6db:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 f4 09 00 00    	mov    %edx,0x9f4
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 f4 09 00 00 f8 	movl   $0x9f8,0x9f4
 71d:	09 00 00 
 720:	c7 05 f8 09 00 00 f8 	movl   $0x9f8,0x9f8
 727:	09 00 00 
    base.s.size = 0;
 72a:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 72f:	c7 05 fc 09 00 00 00 	movl   $0x0,0x9fc
 736:	00 00 00 
