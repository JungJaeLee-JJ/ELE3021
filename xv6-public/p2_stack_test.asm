...
_p2_stack_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  f(1);
  11:	6a 01                	push   $0x1
  13:	e8 08 00 00 00       	call   20 <f>
  exit();
  18:	e8 a5 02 00 00       	call   2c2 <exit>
  1d:	66 90                	xchg   %ax,%ax
  1f:	90                   	nop
...
void f(int depth)
{
  ...
  23:	b9 fa 00 00 00       	mov    $0xfa,%ecx
#include "types.h"
#include "stat.h"
#include "user.h"
...
void f(int depth)
{
  ...
  2b:	53                   	push   %ebx
  volatile char arr[1000] = {0};
  2c:	8d bd 10 fc ff ff    	lea    -0x3f0(%ebp),%edi
#include "types.h"
#include "stat.h"
#include "user.h"
...
void f(int depth)
{
  32:	81 ec fc 03 00 00    	sub    $0x3fc,%esp
  38:	8b 5d 08             	mov    0x8(%ebp),%ebx
  volatile char arr[1000] = {0};
  3b:	f3 ab                	rep stos %eax,%es:(%edi)
  sleep(100);
  3d:	6a 64                	push   $0x64
  3f:	e8 0e 03 00 00       	call   352 <sleep>
  printf(1, "Recursion depth: %d\n", depth + arr[0]);
  44:	0f be 85 10 fc ff ff 	movsbl -0x3f0(%ebp),%eax
...
void f(int depth)
{
  ...
  printf(1, "Recursion depth: %d\n", depth + arr[0]);
  53:	50                   	push   %eax
  54:	68 60 07 00 00       	push   $0x760
  59:	6a 01                	push   $0x1
  5b:	e8 e0 03 00 00       	call   440 <printf>
  f(depth + 1);
  60:	89 1c 24             	mov    %ebx,(%esp)
  63:	e8 b8 ff ff ff       	call   20 <f>
}
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 75 07 00 00       	mov    $0x775,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 3c 0a 00 00       	mov    0xa3c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 73d:	0a 00 00 
 740:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 40 0a 00 00       	mov    $0xa40,%eax
 74f:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 756:	00 00 00 
