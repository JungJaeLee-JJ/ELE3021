...
void f(int depth)
{
  ...
  printf(1, "Recursion depth: %d\n", depth + arr[0]);
  53:	50                   	push   %eax
  54:	68 70 07 00 00       	push   $0x770
  59:	6a 01                	push   $0x1
  5b:	e8 f0 03 00 00       	call   450 <printf>
  f(depth + 1);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 85 07 00 00       	mov    $0x785,%eax
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 4c 0a 00 00       	mov    %eax,0xa4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 74d:	0a 00 00 
 750:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 50 0a 00 00       	mov    $0xa50,%eax
 75f:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 766:	00 00 00 
