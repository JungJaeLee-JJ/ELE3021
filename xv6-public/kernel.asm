...
80103614:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103617:	c7 40 14 c1 56 10 80 	movl   $0x801056c1,0x14(%eax)
...
801037b3:	e8 f8 34 00 00       	call   80106cb0 <setupkvm>
...
801037d1:	e8 ea 31 00 00       	call   801069c0 <inituvm>
  p->sz = PGSIZE;
...
801038be:	e8 3d 32 00 00       	call   80106b00 <allocuvm>
...
801038d0:	e8 db 2f 00 00       	call   801068b0 <switchuvm>
  return 0;
...
801038f4:	e8 07 33 00 00       	call   80106c00 <deallocuvm>
...
80103948:	e8 33 34 00 00       	call   80106d80 <copyuvm>
...
80103ab9:	83 c7 7c             	add    $0x7c,%edi
      ...
      c->proc = p;
      switchuvm(p);
80103abc:	e8 ef 2d 00 00       	call   801068b0 <switchuvm>
      p->state = RUNNING;
...
80103ace:	e8 28 0c 00 00       	call   801046fb <swtch>
      switchkvm();
80103ad3:	e8 b8 2d 00 00       	call   80106890 <switchkvm>
      c->proc = 0; 
...
80103b31:	e8 7a 2d 00 00       	call   801068b0 <switchuvm>
        p->state = RUNNING;
        swtch(&(c->scheduler), p->context);
80103b36:	58                   	pop    %eax
80103b37:	5a                   	pop    %edx
...
80103b43:	e8 b3 0b 00 00       	call   801046fb <swtch>
        switchkvm();
80103b48:	e8 43 2d 00 00       	call   80106890 <switchkvm>
        c->proc = 0; 
	    break;
...
8010406b:	68 db 78 10 80       	push   $0x801078db
...
801048b5:	83 fa 15             	cmp    $0x15,%edx
...
80104a44:	68 b8 76 10 80       	push   $0x801076b8
...
80104a5c:	68 b7 76 10 80       	push   $0x801076b7
...
80104a71:	68 ab 76 10 80       	push   $0x801076ab
...
80104a7e:	68 ba 76 10 80       	push   $0x801076ba
...
80104a8b:	68 9c 76 10 80       	push   $0x8010769c
...
80104ac4:	e8 a7 ec ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104b2b:	e8 40 ec ff ff       	call   80103770 <myproc>
...
80104c63:	78 2b                	js     80104c90 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104c65:	e8 06 eb ff ff       	call   80103770 <myproc>
...
80104e9d:	58                   	pop    %eax
80104e9e:	5a                   	pop    %edx
80104e9f:	68 b8 76 10 80       	push   $0x801076b8
...
80104eb8:	68 b7 76 10 80       	push   $0x801076b7
...
8010500d:	68 dc 76 10 80       	push   $0x801076dc
...
8010501a:	68 ee 76 10 80       	push   $0x801076ee
...
80105027:	68 ca 76 10 80       	push   $0x801076ca
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801050c3:	e8 a8 e6 ff ff       	call   80103770 <myproc>
801050c8:	90                   	nop
...
80105295:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105298:	e8 d3 e4 ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105459:	e8 12 e3 ff ff       	call   80103770 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801054a2:	e8 c9 e2 ff ff       	call   80103770 <myproc>
...
801054be:	75 f0                	jne    801054b0 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801054c0:	e8 ab e2 ff ff       	call   80103770 <myproc>
...
{
  return fork();
801054f4:	e9 17 e4 ff ff       	jmp    80103910 <fork>
...
80105563:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105566:	e8 05 e2 ff ff       	call   80103770 <myproc>
...
80105587:	78 27                	js     801055b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105589:	e8 e2 e1 ff ff       	call   80103770 <myproc>
  if(growproc(n) < 0)
...
80105596:	e8 f5 e2 ff ff       	call   80103890 <growproc>
...
8010561f:	73 2f                	jae    80105650 <sys_sleep+0x90>
    if(myproc()->killed){
80105621:	e8 4a e1 ff ff       	call   80103770 <myproc>
...
{
  return yield();
801056a4:	e9 b7 e6 ff ff       	jmp    80103d60 <yield>
...
80105729:	68 fd 76 10 80       	push   $0x801076fd
...
801057c0:	ff 24 85 a4 77 10 80 	jmp    *-0x7fef885c(,%eax,4)
...
801057d0:	e8 9b df ff ff       	call   80103770 <myproc>
...
80105825:	68 60 77 10 80       	push   $0x80107760
...
80105832:	e8 39 df ff ff       	call   80103770 <myproc>
...
80105840:	e8 2b df ff ff       	call   80103770 <myproc>
...
80105855:	e8 16 df ff ff       	call   80103770 <myproc>
8010585a:	85 c0                	test   %eax,%eax
8010585c:	74 0b                	je     80105869 <trap+0xc9>
8010585e:	e8 0d df ff ff       	call   80103770 <myproc>
...
801058ab:	75 a8                	jne    80105855 <trap+0xb5>
    exit();
801058ad:	e8 7e e3 ff ff       	call   80103c30 <exit>
...
801058bc:	75 ab                	jne    80105869 <trap+0xc9>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();
801058be:	e8 9d e4 ff ff       	call   80103d60 <yield>
...
801058c5:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801058c8:	e8 83 de ff ff       	call   80103750 <cpuid>
...
80105907:	e8 44 de ff ff       	call   80103750 <cpuid>
8010590c:	56                   	push   %esi
8010590d:	53                   	push   %ebx
8010590e:	50                   	push   %eax
8010590f:	68 08 77 10 80       	push   $0x80107708
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
80105940:	e8 2b de ff ff       	call   80103770 <myproc>
80105945:	8b 58 24             	mov    0x24(%eax),%ebx
80105948:	85 db                	test   %ebx,%ebx
8010594a:	75 2c                	jne    80105978 <trap+0x1d8>
      exit();
    myproc()->tf = tf;
8010594c:	e8 1f de ff ff       	call   80103770 <myproc>
80105951:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105954:	e8 47 ef ff ff       	call   801048a0 <syscall>
    if(myproc()->killed)
80105959:	e8 12 de ff ff       	call   80103770 <myproc>
...
8010596f:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105970:	e9 bb e2 ff ff       	jmp    80103c30 <exit>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105978:	e8 b3 e2 ff ff       	call   80103c30 <exit>
...
80105988:	e8 13 ea ff ff       	call   801043a0 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105994:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010599b:	e8 c0 e5 ff ff       	call   80103f60 <wakeup>
      release(&tickslock);
801059a0:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801059a7:	e8 a4 ea ff ff       	call   80104450 <release>
...
801059ba:	e8 91 dd ff ff       	call   80103750 <cpuid>
...
801059c8:	68 2c 77 10 80       	push   $0x8010772c
801059cd:	e8 8e ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059d2:	83 c4 14             	add    $0x14,%esp
801059d5:	68 02 77 10 80       	push   $0x80107702
...
80105acf:	bb 24 78 10 80       	mov    $0x80107824,%ebx
...
80105b67:	6a 00                	push   $0x0
  jmp alltraps
80105b69:	e9 3b fb ff ff       	jmp    801056a9 <alltraps>
...
80105b70:	6a 01                	push   $0x1
  jmp alltraps
80105b72:	e9 32 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b79:	6a 02                	push   $0x2
  jmp alltraps
80105b7b:	e9 29 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b82:	6a 03                	push   $0x3
  jmp alltraps
80105b84:	e9 20 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b8b:	6a 04                	push   $0x4
  jmp alltraps
80105b8d:	e9 17 fb ff ff       	jmp    801056a9 <alltraps>
...
80105b94:	6a 05                	push   $0x5
  jmp alltraps
80105b96:	e9 0e fb ff ff       	jmp    801056a9 <alltraps>
...
80105b9d:	6a 06                	push   $0x6
  jmp alltraps
80105b9f:	e9 05 fb ff ff       	jmp    801056a9 <alltraps>
...
80105ba6:	6a 07                	push   $0x7
  jmp alltraps
80105ba8:	e9 fc fa ff ff       	jmp    801056a9 <alltraps>
...
80105bad:	6a 08                	push   $0x8
  jmp alltraps
80105baf:	e9 f5 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bb6:	6a 09                	push   $0x9
  jmp alltraps
80105bb8:	e9 ec fa ff ff       	jmp    801056a9 <alltraps>
...
80105bbd:	6a 0a                	push   $0xa
  jmp alltraps
80105bbf:	e9 e5 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bc4:	6a 0b                	push   $0xb
  jmp alltraps
80105bc6:	e9 de fa ff ff       	jmp    801056a9 <alltraps>
...
80105bcb:	6a 0c                	push   $0xc
  jmp alltraps
80105bcd:	e9 d7 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bd2:	6a 0d                	push   $0xd
  jmp alltraps
80105bd4:	e9 d0 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bd9:	6a 0e                	push   $0xe
  jmp alltraps
80105bdb:	e9 c9 fa ff ff       	jmp    801056a9 <alltraps>
...
80105be2:	6a 0f                	push   $0xf
  jmp alltraps
80105be4:	e9 c0 fa ff ff       	jmp    801056a9 <alltraps>
...
80105beb:	6a 10                	push   $0x10
  jmp alltraps
80105bed:	e9 b7 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bf2:	6a 11                	push   $0x11
  jmp alltraps
80105bf4:	e9 b0 fa ff ff       	jmp    801056a9 <alltraps>
...
80105bfb:	6a 12                	push   $0x12
  jmp alltraps
80105bfd:	e9 a7 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c04:	6a 13                	push   $0x13
  jmp alltraps
80105c06:	e9 9e fa ff ff       	jmp    801056a9 <alltraps>
...
80105c0d:	6a 14                	push   $0x14
  jmp alltraps
80105c0f:	e9 95 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c16:	6a 15                	push   $0x15
  jmp alltraps
80105c18:	e9 8c fa ff ff       	jmp    801056a9 <alltraps>
...
80105c1f:	6a 16                	push   $0x16
  jmp alltraps
80105c21:	e9 83 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c28:	6a 17                	push   $0x17
  jmp alltraps
80105c2a:	e9 7a fa ff ff       	jmp    801056a9 <alltraps>
...
80105c31:	6a 18                	push   $0x18
  jmp alltraps
80105c33:	e9 71 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c3a:	6a 19                	push   $0x19
  jmp alltraps
80105c3c:	e9 68 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c43:	6a 1a                	push   $0x1a
  jmp alltraps
80105c45:	e9 5f fa ff ff       	jmp    801056a9 <alltraps>
...
80105c4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c4e:	e9 56 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c55:	6a 1c                	push   $0x1c
  jmp alltraps
80105c57:	e9 4d fa ff ff       	jmp    801056a9 <alltraps>
...
80105c5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c60:	e9 44 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c67:	6a 1e                	push   $0x1e
  jmp alltraps
80105c69:	e9 3b fa ff ff       	jmp    801056a9 <alltraps>
...
80105c70:	6a 1f                	push   $0x1f
  jmp alltraps
80105c72:	e9 32 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c79:	6a 20                	push   $0x20
  jmp alltraps
80105c7b:	e9 29 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c82:	6a 21                	push   $0x21
  jmp alltraps
80105c84:	e9 20 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c8b:	6a 22                	push   $0x22
  jmp alltraps
80105c8d:	e9 17 fa ff ff       	jmp    801056a9 <alltraps>
...
80105c94:	6a 23                	push   $0x23
  jmp alltraps
80105c96:	e9 0e fa ff ff       	jmp    801056a9 <alltraps>
...
80105c9d:	6a 24                	push   $0x24
  jmp alltraps
80105c9f:	e9 05 fa ff ff       	jmp    801056a9 <alltraps>
...
80105ca6:	6a 25                	push   $0x25
  jmp alltraps
80105ca8:	e9 fc f9 ff ff       	jmp    801056a9 <alltraps>
...
80105caf:	6a 26                	push   $0x26
  jmp alltraps
80105cb1:	e9 f3 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cb8:	6a 27                	push   $0x27
  jmp alltraps
80105cba:	e9 ea f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cc1:	6a 28                	push   $0x28
  jmp alltraps
80105cc3:	e9 e1 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cca:	6a 29                	push   $0x29
  jmp alltraps
80105ccc:	e9 d8 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cd5:	e9 cf f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cdc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cde:	e9 c6 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105ce5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ce7:	e9 bd f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cee:	6a 2d                	push   $0x2d
  jmp alltraps
80105cf0:	e9 b4 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105cf7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cf9:	e9 ab f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d00:	6a 2f                	push   $0x2f
  jmp alltraps
80105d02:	e9 a2 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d09:	6a 30                	push   $0x30
  jmp alltraps
80105d0b:	e9 99 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d12:	6a 31                	push   $0x31
  jmp alltraps
80105d14:	e9 90 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d1b:	6a 32                	push   $0x32
  jmp alltraps
80105d1d:	e9 87 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d24:	6a 33                	push   $0x33
  jmp alltraps
80105d26:	e9 7e f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d2d:	6a 34                	push   $0x34
  jmp alltraps
80105d2f:	e9 75 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d36:	6a 35                	push   $0x35
  jmp alltraps
80105d38:	e9 6c f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d3f:	6a 36                	push   $0x36
  jmp alltraps
80105d41:	e9 63 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d48:	6a 37                	push   $0x37
  jmp alltraps
80105d4a:	e9 5a f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d51:	6a 38                	push   $0x38
  jmp alltraps
80105d53:	e9 51 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d5a:	6a 39                	push   $0x39
  jmp alltraps
80105d5c:	e9 48 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d63:	6a 3a                	push   $0x3a
  jmp alltraps
80105d65:	e9 3f f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d6c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d6e:	e9 36 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d75:	6a 3c                	push   $0x3c
  jmp alltraps
80105d77:	e9 2d f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d7e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d80:	e9 24 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d87:	6a 3e                	push   $0x3e
  jmp alltraps
80105d89:	e9 1b f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d90:	6a 3f                	push   $0x3f
  jmp alltraps
80105d92:	e9 12 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105d99:	6a 40                	push   $0x40
  jmp alltraps
80105d9b:	e9 09 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105da2:	6a 41                	push   $0x41
  jmp alltraps
80105da4:	e9 00 f9 ff ff       	jmp    801056a9 <alltraps>
...
80105dab:	6a 42                	push   $0x42
  jmp alltraps
80105dad:	e9 f7 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105db4:	6a 43                	push   $0x43
  jmp alltraps
80105db6:	e9 ee f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dbd:	6a 44                	push   $0x44
  jmp alltraps
80105dbf:	e9 e5 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dc6:	6a 45                	push   $0x45
  jmp alltraps
80105dc8:	e9 dc f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dcf:	6a 46                	push   $0x46
  jmp alltraps
80105dd1:	e9 d3 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dd8:	6a 47                	push   $0x47
  jmp alltraps
80105dda:	e9 ca f8 ff ff       	jmp    801056a9 <alltraps>
...
80105de1:	6a 48                	push   $0x48
  jmp alltraps
80105de3:	e9 c1 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dea:	6a 49                	push   $0x49
  jmp alltraps
80105dec:	e9 b8 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105df3:	6a 4a                	push   $0x4a
  jmp alltraps
80105df5:	e9 af f8 ff ff       	jmp    801056a9 <alltraps>
...
80105dfc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dfe:	e9 a6 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e05:	6a 4c                	push   $0x4c
  jmp alltraps
80105e07:	e9 9d f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e0e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e10:	e9 94 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e17:	6a 4e                	push   $0x4e
  jmp alltraps
80105e19:	e9 8b f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e20:	6a 4f                	push   $0x4f
  jmp alltraps
80105e22:	e9 82 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e29:	6a 50                	push   $0x50
  jmp alltraps
80105e2b:	e9 79 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e32:	6a 51                	push   $0x51
  jmp alltraps
80105e34:	e9 70 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e3b:	6a 52                	push   $0x52
  jmp alltraps
80105e3d:	e9 67 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e44:	6a 53                	push   $0x53
  jmp alltraps
80105e46:	e9 5e f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e4d:	6a 54                	push   $0x54
  jmp alltraps
80105e4f:	e9 55 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e56:	6a 55                	push   $0x55
  jmp alltraps
80105e58:	e9 4c f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e5f:	6a 56                	push   $0x56
  jmp alltraps
80105e61:	e9 43 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e68:	6a 57                	push   $0x57
  jmp alltraps
80105e6a:	e9 3a f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e71:	6a 58                	push   $0x58
  jmp alltraps
80105e73:	e9 31 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e7a:	6a 59                	push   $0x59
  jmp alltraps
80105e7c:	e9 28 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e83:	6a 5a                	push   $0x5a
  jmp alltraps
80105e85:	e9 1f f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e8c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e8e:	e9 16 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e95:	6a 5c                	push   $0x5c
  jmp alltraps
80105e97:	e9 0d f8 ff ff       	jmp    801056a9 <alltraps>
...
80105e9e:	6a 5d                	push   $0x5d
  jmp alltraps
80105ea0:	e9 04 f8 ff ff       	jmp    801056a9 <alltraps>
...
80105ea7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ea9:	e9 fb f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eb0:	6a 5f                	push   $0x5f
  jmp alltraps
80105eb2:	e9 f2 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eb9:	6a 60                	push   $0x60
  jmp alltraps
80105ebb:	e9 e9 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ec2:	6a 61                	push   $0x61
  jmp alltraps
80105ec4:	e9 e0 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ecb:	6a 62                	push   $0x62
  jmp alltraps
80105ecd:	e9 d7 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ed4:	6a 63                	push   $0x63
  jmp alltraps
80105ed6:	e9 ce f7 ff ff       	jmp    801056a9 <alltraps>
...
80105edd:	6a 64                	push   $0x64
  jmp alltraps
80105edf:	e9 c5 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ee6:	6a 65                	push   $0x65
  jmp alltraps
80105ee8:	e9 bc f7 ff ff       	jmp    801056a9 <alltraps>
...
80105eef:	6a 66                	push   $0x66
  jmp alltraps
80105ef1:	e9 b3 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105ef8:	6a 67                	push   $0x67
  jmp alltraps
80105efa:	e9 aa f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f01:	6a 68                	push   $0x68
  jmp alltraps
80105f03:	e9 a1 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f0a:	6a 69                	push   $0x69
  jmp alltraps
80105f0c:	e9 98 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f13:	6a 6a                	push   $0x6a
  jmp alltraps
80105f15:	e9 8f f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f1c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f1e:	e9 86 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f25:	6a 6c                	push   $0x6c
  jmp alltraps
80105f27:	e9 7d f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f2e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f30:	e9 74 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f37:	6a 6e                	push   $0x6e
  jmp alltraps
80105f39:	e9 6b f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f40:	6a 6f                	push   $0x6f
  jmp alltraps
80105f42:	e9 62 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f49:	6a 70                	push   $0x70
  jmp alltraps
80105f4b:	e9 59 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f52:	6a 71                	push   $0x71
  jmp alltraps
80105f54:	e9 50 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f5b:	6a 72                	push   $0x72
  jmp alltraps
80105f5d:	e9 47 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f64:	6a 73                	push   $0x73
  jmp alltraps
80105f66:	e9 3e f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f6d:	6a 74                	push   $0x74
  jmp alltraps
80105f6f:	e9 35 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f76:	6a 75                	push   $0x75
  jmp alltraps
80105f78:	e9 2c f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f7f:	6a 76                	push   $0x76
  jmp alltraps
80105f81:	e9 23 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f88:	6a 77                	push   $0x77
  jmp alltraps
80105f8a:	e9 1a f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f91:	6a 78                	push   $0x78
  jmp alltraps
80105f93:	e9 11 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105f9a:	6a 79                	push   $0x79
  jmp alltraps
80105f9c:	e9 08 f7 ff ff       	jmp    801056a9 <alltraps>
...
80105fa3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fa5:	e9 ff f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fac:	6a 7b                	push   $0x7b
  jmp alltraps
80105fae:	e9 f6 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fb5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fb7:	e9 ed f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fbe:	6a 7d                	push   $0x7d
  jmp alltraps
80105fc0:	e9 e4 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fc7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fc9:	e9 db f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fd0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fd2:	e9 d2 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fd9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105fde:	e9 c6 f6 ff ff       	jmp    801056a9 <alltraps>
...
80105fe5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fea:	e9 ba f6 ff ff       	jmp    801056a9 <alltraps>
...
80105ff1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105ff6:	e9 ae f6 ff ff       	jmp    801056a9 <alltraps>
...
80105ffd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106002:	e9 a2 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106009:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010600e:	e9 96 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106015:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010601a:	e9 8a f6 ff ff       	jmp    801056a9 <alltraps>
...
80106021:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106026:	e9 7e f6 ff ff       	jmp    801056a9 <alltraps>
...
8010602d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106032:	e9 72 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106039:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010603e:	e9 66 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106045:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010604a:	e9 5a f6 ff ff       	jmp    801056a9 <alltraps>
...
80106051:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106056:	e9 4e f6 ff ff       	jmp    801056a9 <alltraps>
...
8010605d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106062:	e9 42 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106069:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010606e:	e9 36 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106075:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010607a:	e9 2a f6 ff ff       	jmp    801056a9 <alltraps>
...
80106081:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106086:	e9 1e f6 ff ff       	jmp    801056a9 <alltraps>
...
8010608d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106092:	e9 12 f6 ff ff       	jmp    801056a9 <alltraps>
...
80106099:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010609e:	e9 06 f6 ff ff       	jmp    801056a9 <alltraps>
...
801060a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060aa:	e9 fa f5 ff ff       	jmp    801056a9 <alltraps>
...
801060b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060b6:	e9 ee f5 ff ff       	jmp    801056a9 <alltraps>
...
801060bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060c2:	e9 e2 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060ce:	e9 d6 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060da:	e9 ca f5 ff ff       	jmp    801056a9 <alltraps>
...
801060e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801060e6:	e9 be f5 ff ff       	jmp    801056a9 <alltraps>
...
801060ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801060f2:	e9 b2 f5 ff ff       	jmp    801056a9 <alltraps>
...
801060f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801060fe:	e9 a6 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106105:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010610a:	e9 9a f5 ff ff       	jmp    801056a9 <alltraps>
...
80106111:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106116:	e9 8e f5 ff ff       	jmp    801056a9 <alltraps>
...
8010611d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106122:	e9 82 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106129:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010612e:	e9 76 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106135:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010613a:	e9 6a f5 ff ff       	jmp    801056a9 <alltraps>
...
80106141:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106146:	e9 5e f5 ff ff       	jmp    801056a9 <alltraps>
...
8010614d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106152:	e9 52 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106159:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010615e:	e9 46 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106165:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010616a:	e9 3a f5 ff ff       	jmp    801056a9 <alltraps>
...
80106171:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106176:	e9 2e f5 ff ff       	jmp    801056a9 <alltraps>
...
8010617d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106182:	e9 22 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106189:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010618e:	e9 16 f5 ff ff       	jmp    801056a9 <alltraps>
...
80106195:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010619a:	e9 0a f5 ff ff       	jmp    801056a9 <alltraps>
...
801061a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061a6:	e9 fe f4 ff ff       	jmp    801056a9 <alltraps>
...
801061ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061b2:	e9 f2 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061be:	e9 e6 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061ca:	e9 da f4 ff ff       	jmp    801056a9 <alltraps>
...
801061d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061d6:	e9 ce f4 ff ff       	jmp    801056a9 <alltraps>
...
801061dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801061e2:	e9 c2 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801061ee:	e9 b6 f4 ff ff       	jmp    801056a9 <alltraps>
...
801061f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801061fa:	e9 aa f4 ff ff       	jmp    801056a9 <alltraps>
...
80106201:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106206:	e9 9e f4 ff ff       	jmp    801056a9 <alltraps>
...
8010620d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106212:	e9 92 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106219:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010621e:	e9 86 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106225:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010622a:	e9 7a f4 ff ff       	jmp    801056a9 <alltraps>
...
80106231:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106236:	e9 6e f4 ff ff       	jmp    801056a9 <alltraps>
...
8010623d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106242:	e9 62 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106249:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010624e:	e9 56 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106255:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010625a:	e9 4a f4 ff ff       	jmp    801056a9 <alltraps>
...
80106261:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106266:	e9 3e f4 ff ff       	jmp    801056a9 <alltraps>
...
8010626d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106272:	e9 32 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106279:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010627e:	e9 26 f4 ff ff       	jmp    801056a9 <alltraps>
...
80106285:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010628a:	e9 1a f4 ff ff       	jmp    801056a9 <alltraps>
...
80106291:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106296:	e9 0e f4 ff ff       	jmp    801056a9 <alltraps>
...
8010629d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062a2:	e9 02 f4 ff ff       	jmp    801056a9 <alltraps>
...
801062a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062ae:	e9 f6 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062ba:	e9 ea f3 ff ff       	jmp    801056a9 <alltraps>
...
801062c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062c6:	e9 de f3 ff ff       	jmp    801056a9 <alltraps>
...
801062cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062d2:	e9 d2 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062de:	e9 c6 f3 ff ff       	jmp    801056a9 <alltraps>
...
801062e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801062ea:	e9 ba f3 ff ff       	jmp    801056a9 <alltraps>
...
801062f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801062f6:	e9 ae f3 ff ff       	jmp    801056a9 <alltraps>
...
801062fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106302:	e9 a2 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106309:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010630e:	e9 96 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106315:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010631a:	e9 8a f3 ff ff       	jmp    801056a9 <alltraps>
...
80106321:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106326:	e9 7e f3 ff ff       	jmp    801056a9 <alltraps>
...
8010632d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106332:	e9 72 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106339:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010633e:	e9 66 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106345:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010634a:	e9 5a f3 ff ff       	jmp    801056a9 <alltraps>
...
80106351:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106356:	e9 4e f3 ff ff       	jmp    801056a9 <alltraps>
...
8010635d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106362:	e9 42 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106369:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010636e:	e9 36 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106375:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010637a:	e9 2a f3 ff ff       	jmp    801056a9 <alltraps>
...
80106381:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106386:	e9 1e f3 ff ff       	jmp    801056a9 <alltraps>
...
8010638d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106392:	e9 12 f3 ff ff       	jmp    801056a9 <alltraps>
...
80106399:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010639e:	e9 06 f3 ff ff       	jmp    801056a9 <alltraps>
...
801063a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063aa:	e9 fa f2 ff ff       	jmp    801056a9 <alltraps>
...
801063b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063b6:	e9 ee f2 ff ff       	jmp    801056a9 <alltraps>
...
801063bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063c2:	e9 e2 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063ce:	e9 d6 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063da:	e9 ca f2 ff ff       	jmp    801056a9 <alltraps>
...
801063e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801063e6:	e9 be f2 ff ff       	jmp    801056a9 <alltraps>
...
801063ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801063f2:	e9 b2 f2 ff ff       	jmp    801056a9 <alltraps>
...
801063f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801063fe:	e9 a6 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106405:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010640a:	e9 9a f2 ff ff       	jmp    801056a9 <alltraps>
...
80106411:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106416:	e9 8e f2 ff ff       	jmp    801056a9 <alltraps>
...
8010641d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106422:	e9 82 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106429:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010642e:	e9 76 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106435:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010643a:	e9 6a f2 ff ff       	jmp    801056a9 <alltraps>
...
80106441:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106446:	e9 5e f2 ff ff       	jmp    801056a9 <alltraps>
...
8010644d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106452:	e9 52 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106459:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010645e:	e9 46 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106465:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010646a:	e9 3a f2 ff ff       	jmp    801056a9 <alltraps>
...
80106471:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106476:	e9 2e f2 ff ff       	jmp    801056a9 <alltraps>
...
8010647d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106482:	e9 22 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106489:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010648e:	e9 16 f2 ff ff       	jmp    801056a9 <alltraps>
...
80106495:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010649a:	e9 0a f2 ff ff       	jmp    801056a9 <alltraps>
...
801064a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064a6:	e9 fe f1 ff ff       	jmp    801056a9 <alltraps>
...
801064ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064b2:	e9 f2 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064be:	e9 e6 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064ca:	e9 da f1 ff ff       	jmp    801056a9 <alltraps>
...
801064d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064d6:	e9 ce f1 ff ff       	jmp    801056a9 <alltraps>
...
801064dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801064e2:	e9 c2 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801064ee:	e9 b6 f1 ff ff       	jmp    801056a9 <alltraps>
...
801064f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801064fa:	e9 aa f1 ff ff       	jmp    801056a9 <alltraps>
...
80106501:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106506:	e9 9e f1 ff ff       	jmp    801056a9 <alltraps>
...
8010650d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106512:	e9 92 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106519:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010651e:	e9 86 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106525:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010652a:	e9 7a f1 ff ff       	jmp    801056a9 <alltraps>
...
80106531:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106536:	e9 6e f1 ff ff       	jmp    801056a9 <alltraps>
...
8010653d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106542:	e9 62 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106549:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010654e:	e9 56 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106555:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010655a:	e9 4a f1 ff ff       	jmp    801056a9 <alltraps>
...
80106561:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106566:	e9 3e f1 ff ff       	jmp    801056a9 <alltraps>
...
8010656d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106572:	e9 32 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106579:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010657e:	e9 26 f1 ff ff       	jmp    801056a9 <alltraps>
...
80106585:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010658a:	e9 1a f1 ff ff       	jmp    801056a9 <alltraps>
...
80106591:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106596:	e9 0e f1 ff ff       	jmp    801056a9 <alltraps>
...
8010659d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065a2:	e9 02 f1 ff ff       	jmp    801056a9 <alltraps>
...
801065a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065ae:	e9 f6 f0 ff ff       	jmp    801056a9 <alltraps>
...
801065b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065ba:	e9 ea f0 ff ff       	jmp    801056a9 <alltraps>
...
801065c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065c6:	e9 de f0 ff ff       	jmp    801056a9 <alltraps>
...
801065cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065d2:	e9 d2 f0 ff ff       	jmp    801056a9 <alltraps>
...
8010663a:	e8 61 de ff ff       	call   801044a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066dd:	68 2c 78 10 80       	push   $0x8010782c
...
80106793:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106796:	e8 b5 cf ff ff       	call   80103750 <cpuid>
...
801068d4:	0f 84 c4 00 00 00    	je     8010699e <switchuvm+0xee>
  ...
  pushcli();
801068da:	e8 e1 d9 ff ff       	call   801042c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068df:	e8 ec cd ff ff       	call   801036d0 <mycpu>
801068e4:	89 c3                	mov    %eax,%ebx
801068e6:	e8 e5 cd ff ff       	call   801036d0 <mycpu>
801068eb:	89 c7                	mov    %eax,%edi
801068ed:	e8 de cd ff ff       	call   801036d0 <mycpu>
801068f2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068f5:	83 c7 08             	add    $0x8,%edi
801068f8:	e8 d3 cd ff ff       	call   801036d0 <mycpu>
...
80106939:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010693e:	e8 8d cd ff ff       	call   801036d0 <mycpu>
80106943:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010694a:	e8 81 cd ff ff       	call   801036d0 <mycpu>
...
80106966:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106969:	e8 62 cd ff ff       	call   801036d0 <mycpu>
...
8010698b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010698c:	e9 6f d9 ff ff       	jmp    80104300 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106994:	68 32 78 10 80       	push   $0x80107832
...
801069a1:	68 5d 78 10 80       	push   $0x8010785d
...
801069ae:	68 48 78 10 80       	push   $0x80107848
...
801069ef:	e8 ac da ff ff       	call   801044a0 <memset>
...
80106a20:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a21:	e9 2a db ff ff       	jmp    80104550 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106a29:	68 71 78 10 80       	push   $0x80107871
...
80106add:	68 8b 78 10 80       	push   $0x8010788b
...
80106aea:	68 2c 79 10 80       	push   $0x8010792c
...
80106b43:	e8 58 d9 ff ff       	call   801044a0 <memset>
...
80106b81:	68 a9 78 10 80       	push   $0x801078a9
...
80106bb3:	68 c1 78 10 80       	push   $0x801078c1
...
80106c9c:	68 dd 78 10 80       	push   $0x801078dd
...
80106cd0:	e8 cb d7 ff ff       	call   801044a0 <memset>
...
80106d6f:	68 ee 78 10 80       	push   $0x801078ee
...
80106dc0:	e8 8b d7 ff ff       	call   80104550 <memmove>
...
80106e65:	68 12 79 10 80       	push   $0x80107912
...
80106e72:	68 f8 78 10 80       	push   $0x801078f8
...
80106eff:	e8 4c d6 ff ff       	call   80104550 <memmove>
    len -= n;
    buf += n;
