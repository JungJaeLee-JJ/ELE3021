...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 83 7b 10 80 	movl   $0x80107b83,(%esp)
...
801004d3:	e8 e8 58 00 00       	call   80105dc0 <uartputc>
801004d8:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004df:	e8 dc 58 00 00       	call   80105dc0 <uartputc>
801004e4:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004eb:	e8 d0 58 00 00       	call   80105dc0 <uartputc>
...
801007c8:	e8 13 3d 00 00       	call   801044e0 <acquire>
...
80100803:	e8 d8 3c 00 00       	call   801044e0 <acquire>
  while((c = getc()) >= 0){
...
801009b0:	e8 cb 39 00 00       	call   80104380 <initlock>
...
80100a72:	75 d2                	jne    80100a46 <exec+0x56>
  ...
  if((pgdir = setupkvm()) == 0)
80100a74:	e8 d7 64 00 00       	call   80106f50 <setupkvm>
...
80100b04:	e8 97 62 00 00       	call   80106da0 <allocuvm>
...
80100b3a:	e8 a1 61 00 00       	call   80106ce0 <loaduvm>
...
80100b59:	e8 72 63 00 00       	call   80106ed0 <freevm>
...
80100b95:	e8 06 62 00 00       	call   80106da0 <allocuvm>
...
80100bac:	e8 1f 63 00 00       	call   80106ed0 <freevm>
...
80100bf1:	e8 fa 63 00 00       	call   80106ff0 <clearpteu>
  sp = sz;
...
80100d2c:	e8 1f 5e 00 00       	call   80106b50 <switchuvm>
  freevm(oldpgdir);
80100d31:	89 3c 24             	mov    %edi,(%esp)
80100d34:	e8 97 61 00 00       	call   80106ed0 <freevm>
  return 0;
...
80100d60:	e8 1b 36 00 00       	call   80104380 <initlock>
}
...
80100d81:	e8 5a 37 00 00       	call   801044e0 <acquire>
...
80100def:	e8 ec 36 00 00       	call   801044e0 <acquire>
  if(f->ref < 1)
...
80101165:	68 bf 72 10 80       	push   $0x801072bf
...
80101212:	68 d2 72 10 80       	push   $0x801072d2
...
80101255:	e8 86 33 00 00       	call   801045e0 <memset>
  log_write(bp);
...
8010129a:	e8 41 32 00 00       	call   801044e0 <acquire>
...
801012df:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
801012e2:	e8 a9 32 00 00       	call   80104590 <release>
      return ip;
...
8010132f:	e8 5c 32 00 00       	call   80104590 <release>
...
80101344:	68 e8 72 10 80       	push   $0x801072e8
...
8010140a:	68 f8 72 10 80       	push   $0x801072f8
...
80101441:	e8 4a 32 00 00       	call   80104690 <memmove>
  brelse(bp);
...
801014d9:	68 78 73 10 80       	push   $0x80107378
...
8010156e:	e8 6d 30 00 00       	call   801045e0 <memset>
      dip->type = type;
...
801015a3:	68 18 73 10 80       	push   $0x80107318
...
80101611:	e8 7a 30 00 00       	call   80104690 <memmove>
  log_write(bp);
...
8010163f:	e8 9c 2e 00 00       	call   801044e0 <acquire>
  ip->ref++;
80101644:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101648:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010164f:	e8 3c 2f 00 00       	call   80104590 <release>
  return ip;
}
...
801016f8:	e8 93 2f 00 00       	call   80104690 <memmove>
    brelse(bp);
...
8010171d:	68 30 73 10 80       	push   $0x80107330
...
8010172a:	68 2a 73 10 80       	push   $0x8010732a
...
80101777:	68 3f 73 10 80       	push   $0x8010733f
...
801017a0:	e8 eb 2a 00 00       	call   80104290 <acquiresleep>
...
801017ba:	e8 31 2b 00 00       	call   801042f0 <releasesleep>

  acquire(&icache.lock);
801017bf:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017c6:	e8 15 2d 00 00       	call   801044e0 <acquire>
  ip->ref--;
...
801017df:	5d                   	pop    %ebp
  ...
  ip->ref--;
  release(&icache.lock);
801017e0:	e9 ab 2d 00 00       	jmp    80104590 <release>
...
801017f0:	e8 eb 2c 00 00       	call   801044e0 <acquire>
    int r = ip->ref;
801017f5:	8b 5e 08             	mov    0x8(%esi),%ebx
    release(&icache.lock);
801017f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017ff:	e8 8c 2d 00 00       	call   80104590 <release>
    if(r == 1){
...
801019e8:	e8 a3 2c 00 00       	call   80104690 <memmove>
    brelse(bp);
...
80101ae4:	e8 a7 2b 00 00       	call   80104690 <memmove>
    log_write(bp);
...
80101b7e:	e8 8d 2b 00 00       	call   80104710 <strncmp>
}
80101b83:	c9                   	leave  
80101b84:	c3                   	ret    
...
80101be5:	e8 26 2b 00 00       	call   80104710 <strncmp>
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
    if(de.inum == 0)
...
80101c1d:	68 59 73 10 80       	push   $0x80107359
...
80101c2a:	68 47 73 10 80       	push   $0x80107347
...
80101c69:	e8 72 28 00 00       	call   801044e0 <acquire>
  ip->ref++;
80101c6e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c72:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c79:	e8 12 29 00 00       	call   80104590 <release>
...
80101cd5:	e8 b6 29 00 00       	call   80104690 <memmove>
    path++;
  if(*path == 0)
    return 0;
  s = path;
...
80101d64:	e8 27 29 00 00       	call   80104690 <memmove>
    name[len] = 0;
...
80101e4d:	e8 2e 29 00 00       	call   80104780 <strncpy>
  de.inum = inum;
...
80101e8b:	68 68 73 10 80       	push   $0x80107368
...
80101e98:	68 6a 79 10 80       	push   $0x8010796a
...
80101fa0:	68 d4 73 10 80       	push   $0x801073d4
...
80101fad:	68 cb 73 10 80       	push   $0x801073cb
...
80101fc6:	68 e6 73 10 80       	push   $0x801073e6
80101fcb:	68 80 a5 10 80       	push   $0x8010a580
80101fd0:	e8 ab 23 00 00       	call   80104380 <initlock>
...
8010204e:	e8 8d 24 00 00       	call   801044e0 <acquire>
...
8010209c:	e8 ef 24 00 00       	call   80104590 <release>
  // Start disk on next buf in queue.
  if(idequeue != 0)
    idestart(idequeue);
...
801020ee:	e8 3d 22 00 00       	call   80104330 <holdingsleep>
...
80102128:	e8 b3 23 00 00       	call   801044e0 <acquire>
...
80102179:	e8 62 1d 00 00       	call   80103ee0 <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102195:	c9                   	leave  
  ...
  release(&idelock);
80102196:	e9 f5 23 00 00       	jmp    80104590 <release>
...
8010222a:	68 34 74 10 80       	push   $0x80107434
...
80102302:	e8 d9 22 00 00       	call   801045e0 <memset>
...
8010233a:	c9                   	leave  
  ...
  if(kmem.use_lock)
    release(&kmem.lock);
8010233b:	e9 50 22 00 00       	jmp    80104590 <release>
...
80102355:	68 66 74 10 80       	push   $0x80107466
...
801023bb:	68 6c 74 10 80       	push   $0x8010746c
801023c0:	68 40 26 11 80       	push   $0x80112640
801023c5:	e8 b6 1f 00 00       	call   80104380 <initlock>
...
801024ae:	e8 dd 20 00 00       	call   80104590 <release>
...
801024c8:	e8 13 20 00 00       	call   801044e0 <acquire>
  r = kmem.freelist;
...
80102526:	0f b6 82 a0 75 10 80 	movzbl -0x7fef8a60(%edx),%eax
...
8010254e:	0f b6 82 a0 75 10 80 	movzbl -0x7fef8a60(%edx),%eax
80102555:	09 c1                	or     %eax,%ecx
80102557:	0f b6 82 a0 74 10 80 	movzbl -0x7fef8b60(%edx),%eax
...
8010256b:	83 e1 08             	and    $0x8,%ecx
  ...
  shift ^= togglecode[data];
  c = charcode[shift & (CTL | SHIFT)][data];
8010256e:	8b 04 85 80 74 10 80 	mov    -0x7fef8b80(,%eax,4),%eax
...
801028d4:	e8 57 1d 00 00       	call   80104630 <memcmp>
...
80102a04:	e8 87 1c 00 00       	call   80104690 <memmove>
...
80102aaa:	68 a0 76 10 80       	push   $0x801076a0
80102aaf:	68 80 26 11 80       	push   $0x80112680
80102ab4:	e8 c7 18 00 00       	call   80104380 <initlock>
  readsb(dev, &sb);
80102ab9:	58                   	pop    %eax
...
80102b4b:	e8 90 19 00 00       	call   801044e0 <acquire>
...
80102b65:	e8 76 13 00 00       	call   80103ee0 <sleep>
...
80102b9c:	e8 ef 19 00 00       	call   80104590 <release>
      break;
    }
  }
}
...
80102bbe:	e8 1d 19 00 00       	call   801044e0 <acquire>
  log.outstanding -= 1;
...
80102bfd:	e8 8e 19 00 00       	call   80104590 <release>
}
...
80102c5c:	e8 2f 1a 00 00       	call   80104690 <memmove>
...
80102ca5:	e8 36 18 00 00       	call   801044e0 <acquire>
    log.committing = 0;
    wakeup(&log);
...
80102cc7:	e8 c4 18 00 00       	call   80104590 <release>
...
80102cf4:	e8 97 18 00 00       	call   80104590 <release>
...
80102d07:	68 a4 76 10 80       	push   $0x801076a4
...
80102d5e:	e8 7d 17 00 00       	call   801044e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dad:	c9                   	leave  
  ...
  b->flags |= B_DIRTY; // prevent eviction
  release(&log.lock);
80102dae:	e9 dd 17 00 00       	jmp    80104590 <release>
80102db3:	90                   	nop
...
80102dd3:	68 b3 76 10 80       	push   $0x801076b3
80102dd8:	e8 93 d5 ff ff       	call   80100370 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102ddd:	83 ec 0c             	sub    $0xc,%esp
80102de0:	68 c9 76 10 80       	push   $0x801076c9
...
80102e08:	68 e4 76 10 80       	push   $0x801076e4
80102e0d:	e8 4e d8 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e12:	e8 49 2b 00 00       	call   80105960 <idtinit>
...
80102e2a:	e8 91 0c 00 00       	call   80103ac0 <scheduler>
80102e2f:	90                   	nop
...
80102e33:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e36:	e8 f5 3c 00 00       	call   80106b30 <switchkvm>
  seginit();
80102e3b:	e8 f0 3b 00 00       	call   80106a30 <seginit>
  lapicinit();
...
80102e99:	e8 62 2e 00 00       	call   80105d00 <uartinit>
  pinit();         // process table
80102e9e:	e8 3d 08 00 00       	call   801036e0 <pinit>
  tvinit();        // trap vectors
80102ea3:	e8 18 2a 00 00       	call   801058c0 <tvinit>
  binit();         // buffer cache
...
80102ec9:	e8 c2 17 00 00       	call   80104690 <memmove>
...
80102f98:	68 f8 76 10 80       	push   $0x801076f8
80102f9d:	56                   	push   %esi
80102f9e:	e8 8d 16 00 00       	call   80104630 <memcmp>
...
8010305c:	68 fd 76 10 80       	push   $0x801076fd
80103061:	56                   	push   %esi
80103062:	e8 c9 15 00 00       	call   80104630 <memcmp>
...
801030f0:	ff 24 95 3c 77 10 80 	jmp    *-0x7fef88c4(,%edx,4)
...
80103197:	68 02 77 10 80       	push   $0x80107702
...
801031a4:	68 1c 77 10 80       	push   $0x8010771c
...
80103250:	00 00 00 
  initlock(&p->lock, "pipe");
80103253:	68 50 77 10 80       	push   $0x80107750
80103258:	50                   	push   %eax
80103259:	e8 22 11 00 00       	call   80104380 <initlock>
  (*f0)->type = FD_PIPE;
...
801032ef:	e8 ec 11 00 00       	call   801044e0 <acquire>
  if(writable){
...
8010330f:	e8 8c 0d 00 00       	call   801040a0 <wakeup>
...
80103333:	5d                   	pop    %ebp
  ...
  if(p->readopen == 0 && p->writeopen == 0){
    ...
    release(&p->lock);
80103334:	e9 57 12 00 00       	jmp    80104590 <release>
...
80103354:	e8 47 0d 00 00       	call   801040a0 <wakeup>
...
80103364:	e8 27 12 00 00       	call   80104590 <release>
    kfree((char*)p);
...
8010338d:	e8 4e 11 00 00       	call   801044e0 <acquire>
  for(i = 0; i < n; i++){
...
801033e0:	e8 bb 0c 00 00       	call   801040a0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
801033e5:	58                   	pop    %eax
801033e6:	5a                   	pop    %edx
801033e7:	53                   	push   %ebx
801033e8:	56                   	push   %esi
801033e9:	e8 f2 0a 00 00       	call   80103ee0 <sleep>
{
  int i;
...
80103414:	e8 77 11 00 00       	call   80104590 <release>
        return -1;
...
80103463:	e8 38 0c 00 00       	call   801040a0 <wakeup>
  release(&p->lock);
80103468:	89 1c 24             	mov    %ebx,(%esp)
8010346b:	e8 20 11 00 00       	call   80104590 <release>
  return n;
...
80103490:	e8 4b 10 00 00       	call   801044e0 <acquire>
...
801034c5:	e8 16 0a 00 00       	call   80103ee0 <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
801034f9:	e8 92 10 00 00       	call   80104590 <release>
      return -1;
...
8010355e:	e8 3d 0b 00 00       	call   801040a0 <wakeup>
  release(&p->lock);
80103563:	89 1c 24             	mov    %ebx,(%esp)
80103566:	e8 25 10 00 00       	call   80104590 <release>
  return i;
...
801035b1:	e8 2a 0f 00 00       	call   801044e0 <acquire>
...
8010360e:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103614:	e8 77 0f 00 00       	call   80104590 <release>
...
80103636:	89 53 18             	mov    %edx,0x18(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103639:	c7 40 14 af 58 10 80 	movl   $0x801058af,0x14(%eax)
...
80103645:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103648:	e8 93 0f 00 00       	call   801045e0 <memset>
...
80103670:	e8 1b 0f 00 00       	call   80104590 <release>
  return 0;
...
801036e6:	68 55 77 10 80       	push   $0x80107755
801036eb:	68 20 2d 11 80       	push   $0x80112d20
801036f0:	e8 8b 0c 00 00       	call   80104380 <initlock>
}
...
8010375d:	68 5c 77 10 80       	push   $0x8010775c
...
8010376a:	68 38 78 10 80       	push   $0x80107838
...
801037a4:	83 ec 04             	sub    $0x4,%esp
  ...
  struct proc *p;
  pushcli();
801037a7:	e8 54 0c 00 00       	call   80104400 <pushcli>
  c = mycpu();
801037ac:	e8 4f ff ff ff       	call   80103700 <mycpu>
  p = c->proc;
801037b1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801037b7:	e8 84 0c 00 00       	call   80104440 <popcli>
  return p;
}
...
801037e3:	e8 68 37 00 00       	call   80106f50 <setupkvm>
...
80103801:	e8 5a 34 00 00       	call   80106c60 <inituvm>
  p->sz = PGSIZE;
...
8010386f:	68 85 77 10 80       	push   $0x80107785
80103874:	50                   	push   %eax
80103875:	e8 66 0f 00 00       	call   801047e0 <safestrcpy>
  p->cwd = namei("/");
8010387a:	c7 04 24 8e 77 10 80 	movl   $0x8010778e,(%esp)
...
80103890:	e8 4b 0c 00 00       	call   801044e0 <acquire>
...
801038a3:	e8 e8 0c 00 00       	call   80104590 <release>
}
...
801038b3:	68 6c 77 10 80       	push   $0x8010776c
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
801038c8:	e8 33 0b 00 00       	call   80104400 <pushcli>
  c = mycpu();
801038cd:	e8 2e fe ff ff       	call   80103700 <mycpu>
  p = c->proc;
801038d2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038d8:	e8 63 0b 00 00       	call   80104440 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
801038ee:	e8 ad 34 00 00       	call   80106da0 <allocuvm>
...
80103900:	e8 4b 32 00 00       	call   80106b50 <switchuvm>
  return 0;
...
80103924:	e8 77 35 00 00       	call   80106ea0 <deallocuvm>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103949:	e8 b2 0a 00 00       	call   80104400 <pushcli>
  c = mycpu();
8010394e:	e8 ad fd ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103953:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103959:	e8 e2 0a 00 00       	call   80104440 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
80103978:	e8 a3 36 00 00       	call   80107020 <copyuvm>
...
801039f1:	e8 ea 0d 00 00       	call   801047e0 <safestrcpy>
...
80103a00:	e8 db 0a 00 00       	call   801044e0 <acquire>
...
80103a13:	e8 78 0b 00 00       	call   80104590 <release>
...
80103a6b:	e8 70 0a 00 00       	call   801044e0 <acquire>
...
80103a99:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80103aa8:	e8 e3 0a 00 00       	call   80104590 <release>
}
...
80103ac6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *p;
  struct cpu *c = mycpu();
80103ac9:	e8 32 fc ff ff       	call   80103700 <mycpu>
...
80103aeb:	e8 f0 09 00 00       	call   801044e0 <acquire>
80103af0:	83 c4 10             	add    $0x10,%esp
    ...
    //초기값은 가장 높은 레벨의 큐(우선순위가 낮은)이다
    int selected_queue = MLFQ_K-1;
80103af3:	b9 04 00 00 00       	mov    $0x4,%ecx
    struct proc * p_in_selected_queue = 0;
...
80103aff:	90                   	nop
80103b00:	05 88 00 00 00       	add    $0x88,%eax
80103b05:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103b0a:	74 34                	je     80103b40 <scheduler+0x80>

      if(p->state != RUNNABLE || p->tickleft < 1) continue;
80103b0c:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103b10:	75 ee                	jne    80103b00 <scheduler+0x40>
80103b12:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80103b18:	85 d2                	test   %edx,%edx
80103b1a:	7e e4                	jle    80103b00 <scheduler+0x40>
      
      //큐레벨이 높은거 우선
      if(selected_queue >= p->queuelevel) {
80103b1c:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
80103b22:	39 ca                	cmp    %ecx,%edx
80103b24:	7f da                	jg     80103b00 <scheduler+0x40>
...
80103b2d:	89 d1                	mov    %edx,%ecx
    ...
    //프로세스 선정
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b2f:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103b34:	75 d6                	jne    80103b0c <scheduler+0x4c>
...
80103b40:	85 ff                	test   %edi,%edi
80103b42:	74 44                	je     80103b88 <scheduler+0xc8>
    {
      //기존 스케줄링했던게 있을 때
...
80103b4e:	e8 fd 2f 00 00       	call   80106b50 <switchuvm>
      p_in_selected_queue->state = RUNNING;      
80103b53:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), p_in_selected_queue->context);
80103b5a:	58                   	pop    %eax
80103b5b:	5a                   	pop    %edx
80103b5c:	ff 77 1c             	pushl  0x1c(%edi)
80103b5f:	56                   	push   %esi
80103b60:	e8 d6 0c 00 00       	call   8010483b <swtch>
      switchkvm();
80103b65:	e8 c6 2f 00 00       	call   80106b30 <switchkvm>
...
80103b7b:	e8 10 0a 00 00       	call   80104590 <release>
80103b80:	83 c4 10             	add    $0x10,%esp
80103b83:	e9 58 ff ff ff       	jmp    80103ae0 <scheduler+0x20>
    }
    else
    {
      release(&ptable.lock);
...
80103b90:	e8 fb 09 00 00       	call   80104590 <release>
      priority_boosting();
80103b95:	e8 c6 fe ff ff       	call   80103a60 <priority_boosting>
80103b9a:	83 c4 10             	add    $0x10,%esp
80103b9d:	e9 3e ff ff ff       	jmp    80103ae0 <scheduler+0x20>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103bb5:	e8 46 08 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103bba:	e8 41 fb ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103bbf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103bc5:	e8 76 08 00 00       	call   80104440 <popcli>
sched(void)
{
  int intena;
...
80103bd2:	e8 d9 08 00 00       	call   801044b0 <holding>
...
80103bf7:	75 41                	jne    80103c3a <sched+0x8a>
  ...
  intena = mycpu()->intena;
80103bf9:	e8 02 fb ff ff       	call   80103700 <mycpu>
...
80103c01:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c07:	e8 f4 fa ff ff       	call   80103700 <mycpu>
80103c0c:	83 ec 08             	sub    $0x8,%esp
80103c0f:	ff 70 04             	pushl  0x4(%eax)
80103c12:	53                   	push   %ebx
80103c13:	e8 23 0c 00 00       	call   8010483b <swtch>
  mycpu()->intena = intena;
80103c18:	e8 e3 fa ff ff       	call   80103700 <mycpu>
}
...
80103c30:	68 90 77 10 80       	push   $0x80107790
...
80103c3d:	68 bc 77 10 80       	push   $0x801077bc
...
80103c4a:	68 ae 77 10 80       	push   $0x801077ae
...
80103c57:	68 a2 77 10 80       	push   $0x801077a2
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103c79:	e8 82 07 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103c7e:	e8 7d fa ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103c83:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c89:	e8 b2 07 00 00       	call   80104440 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
80103ce2:	e8 f9 07 00 00       	call   801044e0 <acquire>
...
80103d87:	68 dd 77 10 80       	push   $0x801077dd
...
80103d94:	68 d0 77 10 80       	push   $0x801077d0
...
80103dac:	e8 2f 07 00 00       	call   801044e0 <acquire>
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103db1:	e8 4a 06 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103db6:	e8 45 f9 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103dbb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dc1:	e8 7a 06 00 00       	call   80104440 <popcli>
void
yield(void)
{
  acquire(&ptable.lock);  //DOC: yieldlock
...
80103dd9:	e8 b2 07 00 00       	call   80104590 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103df7:	e8 04 06 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103dfc:	e8 ff f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103e01:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e07:	e8 34 06 00 00       	call   80104440 <popcli>
}
...
80103e0c:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
}
80103e12:	83 c4 04             	add    $0x4,%esp
80103e15:	5b                   	pop    %ebx
80103e16:	5d                   	pop    %ebp
80103e17:	c3                   	ret    
80103e18:	90                   	nop
...
80103e29:	83 7d 0c 0a          	cmpl   $0xa,0xc(%ebp)
  return myproc()->queuelevel;
}
...
80103e2d:	8b 75 08             	mov    0x8(%ebp),%esi
  struct proc *child;
  if(priority<0 || priority>10) return -2;
80103e30:	0f 87 97 00 00 00    	ja     80103ecd <setpriority+0xad>
  //cli();
...
80103e39:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
  struct proc *child;
  if(priority<0 || priority>10) return -2;
  //cli();
 //struct proc *parent = mycpu()->proc;
...
80103e43:	e8 98 06 00 00       	call   801044e0 <acquire>
80103e48:	83 c4 10             	add    $0x10,%esp
80103e4b:	eb 11                	jmp    80103e5e <setpriority+0x3e>
80103e4d:	8d 76 00             	lea    0x0(%esi),%esi
  for(child = ptable.proc; child < &ptable.proc[NPROC]; child++){
80103e50:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103e56:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103e5c:	74 52                	je     80103eb0 <setpriority+0x90>
...
80103e61:	75 ed                	jne    80103e50 <setpriority+0x30>
80103e63:	8b 43 14             	mov    0x14(%ebx),%eax
80103e66:	8b 50 10             	mov    0x10(%eax),%edx
80103e69:	89 55 e4             	mov    %edx,-0x1c(%ebp)
// while reading proc from the cpu structure
struct proc*
myproc(void) {
  struct cpu *c;
  struct proc *p;
  pushcli();
80103e6c:	e8 8f 05 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103e71:	e8 8a f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
80103e76:	8b b8 ac 00 00 00    	mov    0xac(%eax),%edi
  popcli();
80103e7c:	e8 bf 05 00 00       	call   80104440 <popcli>
 //struct proc *parent = mycpu()->proc;
  //sti();
  acquire(&ptable.lock);
  for(child = ptable.proc; child < &ptable.proc[NPROC]; child++){
...
80103e84:	3b 57 10             	cmp    0x10(%edi),%edx
80103e87:	75 c7                	jne    80103e50 <setpriority+0x30>
			pid == myproc()->pid) )
    {
      child->priority=priority;
80103e89:	8b 45 0c             	mov    0xc(%ebp),%eax
      release(&ptable.lock);
80103e8c:	83 ec 0c             	sub    $0xc,%esp
80103e8f:	68 20 2d 11 80       	push   $0x80112d20
  for(child = ptable.proc; child < &ptable.proc[NPROC]; child++){
	  //cprintf("pid : %d ppid : %d 찾고있는 자식 pid : %d now pid : %d \n", child->pid, child->parent->pid, parent->pid ,pid);
    if((child->pid == pid) &&( child->parent->
			pid == myproc()->pid) )
    {
      child->priority=priority;
80103e94:	89 43 7c             	mov    %eax,0x7c(%ebx)
      release(&ptable.lock);
80103e97:	e8 f4 06 00 00       	call   80104590 <release>
...
80103e9f:	8d 65 f4             	lea    -0xc(%ebp),%esp
			pid == myproc()->pid) )
    {
      child->priority=priority;
      release(&ptable.lock);
...
80103eb3:	68 20 2d 11 80       	push   $0x80112d20
80103eb8:	e8 d3 06 00 00       	call   80104590 <release>
  return -1;
...
setpriority(int pid, int priority)
{
  struct proc *child;
  if(priority<0 || priority>10) return -2;
80103ecd:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
80103ed2:	eb f1                	jmp    80103ec5 <setpriority+0xa5>
...
80103eef:	e8 0c 05 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103ef4:	e8 07 f8 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
80103f30:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f37:	e8 74 fc ff ff       	call   80103bb0 <sched>
  // Tidy up.
  p->chan = 0;
...
80103f6b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f72:	e8 39 fc ff ff       	call   80103bb0 <sched>
  // Tidy up.
  p->chan = 0;
...
80103f89:	68 ef 77 10 80       	push   $0x801077ef
...
80103f96:	68 e9 77 10 80       	push   $0x801077e9
...
80103fa5:	e8 56 04 00 00       	call   80104400 <pushcli>
  c = mycpu();
80103faa:	e8 51 f7 ff ff       	call   80103700 <mycpu>
  p = c->proc;
...
80103fde:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103fe4:	74 22                	je     80104008 <wait+0x68>
      if(p->parent != curproc)
...
80103fef:	74 35                	je     80104026 <wait+0x86>
...
80103ff7:	b8 01 00 00 00       	mov    $0x1,%eax
  ...
  for(;;){
    ...
    havekids = 0;
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ffc:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
8010400a:	74 70                	je     8010407c <wait+0xdc>
8010400c:	8b 46 24             	mov    0x24(%esi),%eax
8010400f:	85 c0                	test   %eax,%eax
80104011:	75 69                	jne    8010407c <wait+0xdc>
      release(&ptable.lock);
      return -1;
    }
...
8010401c:	e8 bf fe ff ff       	call   80103ee0 <sleep>
  }
80104021:	83 c4 10             	add    $0x10,%esp
80104024:	eb a4                	jmp    80103fca <wait+0x2a>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
...
80104029:	ff 73 08             	pushl  0x8(%ebx)
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
8010402c:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
8010402f:	e8 9c e2 ff ff       	call   801022d0 <kfree>
        p->kstack = 0;
        freevm(p->pgdir);
80104034:	5a                   	pop    %edx
80104035:	ff 73 04             	pushl  0x4(%ebx)
      havekids = 1;
      if(p->state == ZOMBIE){
        // Found one.
        pid = p->pid;
        kfree(p->kstack);
        p->kstack = 0;
80104038:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
8010403f:	e8 8c 2e 00 00       	call   80106ed0 <freevm>
        p->pid = 0;
80104044:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010404b:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104052:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104056:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
8010405d:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104064:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010406b:	e8 20 05 00 00       	call   80104590 <release>
        return pid;
...
80104073:	8d 65 f8             	lea    -0x8(%ebp),%esp
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
        p->state = UNUSED;
...
80104084:	e8 07 05 00 00       	call   80104590 <release>
      return -1;
...
8010408c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    }
...
801040ca:	74 1e                	je     801040ea <wakeup+0x4a>
    if(p->state == SLEEPING && p->chan == chan)
...
801040e3:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
801040e8:	75 e2                	jne    801040cc <wakeup+0x2c>
void
wakeup(void *chan)
{
  acquire(&ptable.lock);
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
801040f5:	e9 96 04 00 00       	jmp    80104590 <release>
...
8010412a:	74 3c                	je     80104168 <kill+0x68>
    if(p->pid == pid){
...
80104135:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
8010413c:	74 1a                	je     80104158 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
8010413e:	83 ec 0c             	sub    $0xc,%esp
80104141:	68 20 2d 11 80       	push   $0x80112d20
80104146:	e8 45 04 00 00       	call   80104590 <release>
      return 0;
...
80104150:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104153:	c9                   	leave  
80104154:	c3                   	ret    
...
8010415f:	eb dd                	jmp    8010413e <kill+0x3e>
...
801041ab:	68 83 7b 10 80       	push   $0x80107b83
801041b0:	e8 ab c4 ff ff       	call   80100660 <cprintf>
801041b5:	83 c4 10             	add    $0x10,%esp
801041b8:	81 c3 88 00 00 00    	add    $0x88,%ebx
  int i;
  struct proc *p;
  char *state;
  uint pc[10];
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041be:	81 fb c0 4f 11 80    	cmp    $0x80114fc0,%ebx
801041c4:	0f 84 7e 00 00 00    	je     80104248 <procdump+0xb8>
    if(p->state == UNUSED)
801041ca:	8b 43 a0             	mov    -0x60(%ebx),%eax
...
801041d1:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
801041d4:	ba 00 78 10 80       	mov    $0x80107800,%edx
  uint pc[10];
...
801041db:	8b 14 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
801041e2:	b8 00 78 10 80       	mov    $0x80107800,%eax
...
801041f1:	68 04 78 10 80       	push   $0x80107804
...
8010422d:	68 41 72 10 80       	push   $0x80107241
...
8010425a:	68 78 78 10 80       	push   $0x80107878
...
80104409:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010440a:	e8 f1 f2 ff ff       	call   80103700 <mycpu>
...
8010441f:	e8 dc f2 ff ff       	call   80103700 <mycpu>
80104424:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
8010442a:	e8 d1 f2 ff ff       	call   80103700 <mycpu>
...
8010444b:	75 52                	jne    8010449f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
8010444d:	e8 ae f2 ff ff       	call   80103700 <mycpu>
...
80104465:	e8 96 f2 ff ff       	call   80103700 <mycpu>
...
80104479:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104480:	e8 7b f2 ff ff       	call   80103700 <mycpu>
...
80104495:	68 9a 78 10 80       	push   $0x8010789a
...
801044a2:	68 83 78 10 80       	push   $0x80107883
...
801044c8:	e8 33 f2 ff ff       	call   80103700 <mycpu>
...
801044e7:	e8 14 ff ff ff       	call   80104400 <pushcli>
  if(holding(lk))
801044ec:	8b 5d 08             	mov    0x8(%ebp),%ebx
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	53                   	push   %ebx
801044f3:	e8 b8 ff ff ff       	call   801044b0 <holding>
801044f8:	83 c4 10             	add    $0x10,%esp
801044fb:	85 c0                	test   %eax,%eax
801044fd:	0f 85 7d 00 00 00    	jne    80104580 <acquire+0xa0>
xchg(volatile uint *addr, uint newval)
{
  uint result;
...
80104524:	e8 d7 f1 ff ff       	call   80103700 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
8010452b:	8d 4b 0c             	lea    0xc(%ebx),%ecx
  // past this point, to ensure that the critical section's memory
  // references happen after the lock is acquired.
  __sync_synchronize();
  ...
  // Record info about lock acquisition for debugging.
  lk->cpu = mycpu();
8010452e:	89 43 08             	mov    %eax,0x8(%ebx)
{
  uint *ebp;
  int i;
...
80104534:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104538:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
8010453e:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80104544:	77 1a                	ja     80104560 <acquire+0x80>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104546:	8b 5a 04             	mov    0x4(%edx),%ebx
80104549:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
{
  uint *ebp;
  int i;
...
8010455c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(; i < 10; i++)
    pcs[i] = 0;
80104560:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104567:	83 c0 01             	add    $0x1,%eax
8010456a:	83 f8 0a             	cmp    $0xa,%eax
8010456d:	74 e7                	je     80104556 <acquire+0x76>
    pcs[i] = 0;
8010456f:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80104583:	68 a1 78 10 80       	push   $0x801078a1
...
801045cc:	68 a9 78 10 80       	push   $0x801078a9
...
80104857:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010485a:	e8 41 ef ff ff       	call   801037a0 <myproc>
...
801048f5:	e8 a6 ee ff ff       	call   801037a0 <myproc>
...
{
  struct proc *curproc = myproc();
80104906:	e8 95 ee ff ff       	call   801037a0 <myproc>
...
80104948:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010494b:	e8 50 ee ff ff       	call   801037a0 <myproc>
...
801049e4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
801049e5:	e8 b6 ed ff ff       	call   801037a0 <myproc>

  num = curproc->tf->eax;
801049ea:	8b 70 18             	mov    0x18(%eax),%esi
...
801049ed:	89 c3                	mov    %eax,%ebx
  ...
  num = curproc->tf->eax;
801049ef:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
801049f2:	8d 50 ff             	lea    -0x1(%eax),%edx
801049f5:	83 fa 17             	cmp    $0x17,%edx
801049f8:	77 1e                	ja     80104a18 <syscall+0x38>
801049fa:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
80104a01:	85 d2                	test   %edx,%edx
80104a03:	74 13                	je     80104a18 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104a05:	ff d2                	call   *%edx
80104a07:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104a20:	68 b1 78 10 80       	push   $0x801078b1
...
80104a57:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
80104a5a:	e8 71 d4 ff ff       	call   80101ed0 <nameiparent>
...
80104a70:	e8 eb cb ff ff       	call   80101660 <ilock>
...
80104a7c:	e8 0f d1 ff ff       	call   80101b90 <dirlookup>
80104a81:	83 c4 10             	add    $0x10,%esp
80104a84:	85 c0                	test   %eax,%eax
80104a86:	89 c3                	mov    %eax,%ebx
80104a88:	74 56                	je     80104ae0 <create+0xa0>
    iunlockput(dp);
80104a8a:	83 ec 0c             	sub    $0xc,%esp
80104a8d:	57                   	push   %edi
80104a8e:	e8 5d ce ff ff       	call   801018f0 <iunlockput>
    ilock(ip);
80104a93:	89 1c 24             	mov    %ebx,(%esp)
80104a96:	e8 c5 cb ff ff       	call   80101660 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80104a9b:	83 c4 10             	add    $0x10,%esp
80104a9e:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104aa3:	75 1b                	jne    80104ac0 <create+0x80>
80104aa5:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
80104aaa:	89 d8                	mov    %ebx,%eax
80104aac:	75 12                	jne    80104ac0 <create+0x80>
...
80104ac4:	e8 27 ce ff ff       	call   801018f0 <iunlockput>
    return 0;
...
80104aea:	e8 01 ca ff ff       	call   801014f0 <ialloc>
...
80104b00:	e8 5b cb ff ff       	call   80101660 <ilock>
  ip->major = major;
...
80104b21:	e8 8a ca ff ff       	call   801015b0 <iupdate>
...
80104b38:	e8 b3 d2 ff ff       	call   80101df0 <dirlink>
...
80104b48:	e8 a3 cd ff ff       	call   801018f0 <iunlockput>
...
80104b62:	e9 47 ff ff ff       	jmp    80104aae <create+0x6e>
...
80104b79:	e8 32 ca ff ff       	call   801015b0 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104b7e:	83 c4 0c             	add    $0xc,%esp
80104b81:	ff 73 04             	pushl  0x4(%ebx)
80104b84:	68 60 79 10 80       	push   $0x80107960
80104b89:	53                   	push   %ebx
80104b8a:	e8 61 d2 ff ff       	call   80101df0 <dirlink>
...
80104b9c:	68 5f 79 10 80       	push   $0x8010795f
80104ba1:	53                   	push   %ebx
80104ba2:	e8 49 d2 ff ff       	call   80101df0 <dirlink>
...
80104bb1:	68 53 79 10 80       	push   $0x80107953
...
80104bbe:	68 62 79 10 80       	push   $0x80107962
...
80104bcb:	68 44 79 10 80       	push   $0x80107944
...
80104c04:	e8 97 eb ff ff       	call   801037a0 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104c6b:	e8 30 eb ff ff       	call   801037a0 <myproc>
...
80104ccd:	e8 1e fc ff ff       	call   801048f0 <argint>
...
80104ce5:	e8 56 fc ff ff       	call   80104940 <argptr>
...
80104d3d:	e8 ae fb ff ff       	call   801048f0 <argint>
...
80104d55:	e8 e6 fb ff ff       	call   80104940 <argptr>
...
80104da3:	78 2b                	js     80104dd0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104da5:	e8 f6 e9 ff ff       	call   801037a0 <myproc>
...
80104dff:	e8 3c fb ff ff       	call   80104940 <argptr>
...
80104e3f:	e8 5c fb ff ff       	call   801049a0 <argstr>
...
80104e58:	e8 43 fb ff ff       	call   801049a0 <argstr>
...
80104e62:	0f 88 e2 00 00 00    	js     80104f4a <sys_link+0x11a>
  ...
  begin_op();
80104e68:	e8 d3 dc ff ff       	call   80102b40 <begin_op>
  if((ip = namei(old)) == 0){
80104e6d:	83 ec 0c             	sub    $0xc,%esp
80104e70:	ff 75 d4             	pushl  -0x2c(%ebp)
80104e73:	e8 38 d0 ff ff       	call   80101eb0 <namei>
...
80104e89:	e8 d2 c7 ff ff       	call   80101660 <ilock>
  if(ip->type == T_DIR){
...
80104ea8:	e8 03 c7 ff ff       	call   801015b0 <iupdate>
  iunlock(ip);
80104ead:	89 1c 24             	mov    %ebx,(%esp)
80104eb0:	e8 8b c8 ff ff       	call   80101740 <iunlock>
...
80104ebb:	e8 10 d0 ff ff       	call   80101ed0 <nameiparent>
...
80104ee3:	e8 08 cf ff ff       	call   80101df0 <dirlink>
...
80104ef3:	e8 f8 c9 ff ff       	call   801018f0 <iunlockput>
  iput(ip);
80104ef8:	89 1c 24             	mov    %ebx,(%esp)
80104efb:	e8 90 c8 ff ff       	call   80101790 <iput>

  end_op();
80104f00:	e8 ab dc ff ff       	call   80102bb0 <end_op>
...
80104f1c:	e8 cf c9 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
80104f35:	e8 76 c6 ff ff       	call   801015b0 <iupdate>
  iunlockput(ip);
80104f3a:	89 1c 24             	mov    %ebx,(%esp)
80104f3d:	e8 ae c9 ff ff       	call   801018f0 <iunlockput>
  end_op();
80104f42:	e8 69 dc ff ff       	call   80102bb0 <end_op>
  return -1;
...
80104f64:	e8 87 c9 ff ff       	call   801018f0 <iunlockput>
    end_op();
80104f69:	e8 42 dc ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104f76:	eb 92                	jmp    80104f0a <sys_link+0xda>
  ...
  if((ip = namei(old)) == 0){
    end_op();
80104f78:	e8 33 dc ff ff       	call   80102bb0 <end_op>
    return -1;
...
80104f9f:	e8 fc f9 ff ff       	call   801049a0 <argstr>
...
80104faf:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  ...
  begin_op();
80104fb2:	e8 89 db ff ff       	call   80102b40 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104fb7:	83 ec 08             	sub    $0x8,%esp
80104fba:	53                   	push   %ebx
80104fbb:	ff 75 c0             	pushl  -0x40(%ebp)
80104fbe:	e8 0d cf ff ff       	call   80101ed0 <nameiparent>
...
80104fd8:	e8 83 c6 ff ff       	call   80101660 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104fdd:	58                   	pop    %eax
80104fde:	5a                   	pop    %edx
80104fdf:	68 60 79 10 80       	push   $0x80107960
80104fe4:	53                   	push   %ebx
80104fe5:	e8 86 cb ff ff       	call   80101b70 <namecmp>
...
80104ff8:	68 5f 79 10 80       	push   $0x8010795f
80104ffd:	53                   	push   %ebx
80104ffe:	e8 6d cb ff ff       	call   80101b70 <namecmp>
...
80105017:	e8 74 cb ff ff       	call   80101b90 <dirlookup>
...
8010502d:	e8 2e c6 ff ff       	call   80101660 <ilock>
...
80105082:	e8 69 c8 ff ff       	call   801018f0 <iunlockput>

  ip->nlink--;
80105087:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010508c:	89 1c 24             	mov    %ebx,(%esp)
8010508f:	e8 1c c5 ff ff       	call   801015b0 <iupdate>
  iunlockput(ip);
80105094:	89 1c 24             	mov    %ebx,(%esp)
80105097:	e8 54 c8 ff ff       	call   801018f0 <iunlockput>

  end_op();
8010509c:	e8 0f db ff ff       	call   80102bb0 <end_op>
...
801050d1:	e8 6a c8 ff ff       	call   80101940 <readi>
...
801050e9:	e8 02 c8 ff ff       	call   801018f0 <iunlockput>
    goto bad;
...
801050f7:	e8 f4 c7 ff ff       	call   801018f0 <iunlockput>
  end_op();
801050fc:	e8 af da ff ff       	call   80102bb0 <end_op>
  return -1;
...
80105124:	e8 87 c4 ff ff       	call   801015b0 <iupdate>
...
80105136:	e9 6b ff ff ff       	jmp    801050a6 <sys_unlink+0x116>
  ...
  if((dp = nameiparent(path, name)) == 0){
    end_op();
8010513b:	e8 70 da ff ff       	call   80102bb0 <end_op>
    return -1;
...
8010514d:	68 84 79 10 80       	push   $0x80107984
...
8010515a:	68 96 79 10 80       	push   $0x80107996
...
80105167:	68 72 79 10 80       	push   $0x80107972
...
8010518f:	e8 0c f8 ff ff       	call   801049a0 <argstr>
...
801051a8:	e8 43 f7 ff ff       	call   801048f0 <argint>
...
801051b2:	0f 88 85 00 00 00    	js     8010523d <sys_open+0xbd>
  ...
  begin_op();
801051b8:	e8 83 d9 ff ff       	call   80102b40 <begin_op>
...
801051cd:	e8 de cc ff ff       	call   80101eb0 <namei>
...
801051e3:	e8 78 c4 ff ff       	call   80101660 <ilock>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105203:	e8 98 e5 ff ff       	call   801037a0 <myproc>
80105208:	90                   	nop
...
80105230:	e8 bb c6 ff ff       	call   801018f0 <iunlockput>
    end_op();
...
8010526b:	75 89                	jne    801051f6 <sys_open+0x76>
      end_op();
8010526d:	e8 3e d9 ff ff       	call   80102bb0 <end_op>
      return -1;
...
80105288:	e8 b3 c4 ff ff       	call   80101740 <iunlock>
  end_op();
8010528d:	e8 1e d9 ff ff       	call   80102bb0 <end_op>
...
8010531f:	e8 cc c5 ff ff       	call   801018f0 <iunlockput>
  end_op();
80105324:	e8 87 d8 ff ff       	call   80102bb0 <end_op>
  return 0;
...
80105369:	e8 82 f5 ff ff       	call   801048f0 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
8010537e:	e8 6d f5 ff ff       	call   801048f0 <argint>
  char *path;
  int major, minor;
...
801053ae:	e8 3d c5 ff ff       	call   801018f0 <iunlockput>
  end_op();
801053b3:	e8 f8 d7 ff ff       	call   80102bb0 <end_op>
  return 0;
...
801053ff:	e8 ac ca ff ff       	call   80101eb0 <namei>
...
80105411:	e8 4a c2 ff ff       	call   80101660 <ilock>
  if(ip->type != T_DIR){
...
80105424:	e8 17 c3 ff ff       	call   80101740 <iunlock>
  iput(curproc->cwd);
80105429:	58                   	pop    %eax
8010542a:	ff 76 68             	pushl  0x68(%esi)
8010542d:	e8 5e c3 ff ff       	call   80101790 <iput>
  end_op();
80105432:	e8 79 d7 ff ff       	call   80102bb0 <end_op>
  curproc->cwd = ip;
...
80105454:	e8 97 c4 ff ff       	call   801018f0 <iunlockput>
    end_op();
80105459:	e8 52 d7 ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105469:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(argstr(0, &path) < 0 || (ip = namei(path)) == 0){
    end_op();
80105470:	e8 3b d7 ff ff       	call   80102bb0 <end_op>
    return -1;
...
80105495:	e8 06 f5 ff ff       	call   801049a0 <argstr>
...
801054ad:	e8 3e f4 ff ff       	call   801048f0 <argint>
...
801054d8:	e8 03 f1 ff ff       	call   801045e0 <memset>
...
801054ee:	e8 5d f3 ff ff       	call   80104850 <fetchint>
...
80105509:	e8 82 f3 ff ff       	call   80104890 <fetchstr>
...
80105571:	e8 ca f3 ff ff       	call   80104940 <argptr>
...
80105588:	e8 53 dc ff ff       	call   801031e0 <pipealloc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801055e2:	e8 b9 e1 ff ff       	call   801037a0 <myproc>
...
801055fe:	75 f0                	jne    801055f0 <sys_pipe+0x90>
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
80105600:	e8 9b e1 ff ff       	call   801037a0 <myproc>
...
{
  return fork();
80105634:	e9 07 e3 ff ff       	jmp    80103940 <fork>
...
80105643:	83 ec 08             	sub    $0x8,%esp
  exit();
80105646:	e8 25 e6 ff ff       	call   80103c70 <exit>
...
{
  return wait();
80105654:	e9 47 e9 ff ff       	jmp    80103fa0 <wait>
...
8010566c:	e8 7f f2 ff ff       	call   801048f0 <argint>
...
801056a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801056a6:	e8 f5 e0 ff ff       	call   801037a0 <myproc>
...
801056d6:	e8 e5 e1 ff ff       	call   801038c0 <growproc>
...
8010570c:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80105713:	00 00 00 
 // myproc()->priority = 0;
  myproc()->tickleft = 4;
80105716:	e8 85 e0 ff ff       	call   801037a0 <myproc>
8010571b:	c7 80 84 00 00 00 04 	movl   $0x4,0x84(%eax)
80105722:	00 00 00 
  //////////////////////////////////////////
...
8010572e:	e8 bd f1 ff ff       	call   801048f0 <argint>
80105733:	83 c4 10             	add    $0x10,%esp
80105736:	85 c0                	test   %eax,%eax
80105738:	0f 88 89 00 00 00    	js     801057c7 <sys_sleep+0xc7>
    return -1;
  acquire(&tickslock);
8010573e:	83 ec 0c             	sub    $0xc,%esp
80105741:	68 60 4f 11 80       	push   $0x80114f60
80105746:	e8 95 ed ff ff       	call   801044e0 <acquire>
  ticks0 = ticks;
...
8010574e:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
80105751:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
80105757:	85 d2                	test   %edx,%edx
80105759:	75 26                	jne    80105781 <sys_sleep+0x81>
8010575b:	eb 53                	jmp    801057b0 <sys_sleep+0xb0>
...
8010576d:	e8 6e e7 ff ff       	call   80103ee0 <sleep>
...
801057b8:	e8 d3 ed ff ff       	call   80104590 <release>
  return 0;
...
801057cc:	eb d4                	jmp    801057a2 <sys_sleep+0xa2>
...
801057ee:	e8 9d ed ff ff       	call   80104590 <release>
  return xticks;
}
...
80105803:	83 ec 08             	sub    $0x8,%esp
  myproc()->queuelevel = 0;
80105806:	e8 95 df ff ff       	call   801037a0 <myproc>
8010580b:	c7 80 80 00 00 00 00 	movl   $0x0,0x80(%eax)
80105812:	00 00 00 
  //myproc()->priority = 0;
  myproc()->tickleft = 4;
80105815:	e8 86 df ff ff       	call   801037a0 <myproc>
8010581a:	c7 80 84 00 00 00 04 	movl   $0x4,0x84(%eax)
80105821:	00 00 00 
  yield();
}
80105824:	c9                   	leave  
sys_yield()
{
  ...
  myproc()->tickleft = 4;
  yield();
80105825:	e9 76 e5 ff ff       	jmp    80103da0 <yield>
...
{
  return getlev();
80105834:	e9 b7 e5 ff ff       	jmp    80103df0 <getlev>
80105839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80105840 <sys_setpriority>:
}
...
80105856:	78 28                	js     80105880 <sys_setpriority+0x40>
...
sys_setpriority(void)
{
	...
	if(argint(0,&pid)<0) return -1;
	if(argint(1,&priority)<0) return -2;
80105890:	b8 fe ff ff ff       	mov    $0xfffffffe,%eax
	return setpriority(pid,priority);
}
80105895:	c9                   	leave  
80105896:	c3                   	ret    
...
80105898:	06                   	push   %es
  pushl %fs
80105899:	0f a0                	push   %fs
  pushl %gs
8010589b:	0f a8                	push   %gs
  pushal
8010589d:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
8010589e:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058a2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058a4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058a6:	54                   	push   %esp
  call trap
801058a7:	e8 e4 00 00 00       	call   80105990 <trap>
  addl $4, %esp
801058ac:	83 c4 04             	add    $0x4,%esp
...
801058af:	61                   	popa   
  popl %gs
801058b0:	0f a9                	pop    %gs
  popl %fs
801058b2:	0f a1                	pop    %fs
  popl %es
801058b4:	07                   	pop    %es
  popl %ds
801058b5:	1f                   	pop    %ds
...
801058c8:	8b 14 85 08 a0 10 80 	mov    -0x7fef5ff8(,%eax,4),%edx
801058cf:	b9 08 00 00 00       	mov    $0x8,%ecx
801058d4:	c6 04 c5 a4 4f 11 80 	movb   $0x0,-0x7feeb05c(,%eax,8)
801058db:	00 
801058dc:	66 89 0c c5 a2 4f 11 	mov    %cx,-0x7feeb05e(,%eax,8)
801058e3:	80 
801058e4:	c6 04 c5 a5 4f 11 80 	movb   $0x8e,-0x7feeb05b(,%eax,8)
801058eb:	8e 
801058ec:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
801058f3:	80 
801058f4:	c1 ea 10             	shr    $0x10,%edx
801058f7:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
801058fe:	80 
void
tvinit(void)
{
...
80105911:	83 ec 10             	sub    $0x10,%esp
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105914:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  initlock(&tickslock, "time");
80105919:	68 a5 79 10 80       	push   $0x801079a5
8010591e:	68 60 4f 11 80       	push   $0x80114f60
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105923:	66 89 15 a2 51 11 80 	mov    %dx,0x801151a2
8010592a:	c6 05 a4 51 11 80 00 	movb   $0x0,0x801151a4
80105931:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
80105937:	c1 e8 10             	shr    $0x10,%eax
8010593a:	c6 05 a5 51 11 80 ef 	movb   $0xef,0x801151a5
80105941:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6

  initlock(&tickslock, "time");
80105947:	e8 34 ea ff ff       	call   80104380 <initlock>
}
...
8010596b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010596f:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
801059a2:	0f 84 c8 01 00 00    	je     80105b70 <trap+0x1e0>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059b0:	ff 24 85 4c 7a 10 80 	jmp    *-0x7fef85b4(,%eax,4)
...
801059c0:	e8 db dd ff ff       	call   801037a0 <myproc>
801059c5:	85 c0                	test   %eax,%eax
801059c7:	0f 84 7d 02 00 00    	je     80105c4a <trap+0x2ba>
801059cd:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801059d1:	0f 84 73 02 00 00    	je     80105c4a <trap+0x2ba>
...
80105a15:	68 08 7a 10 80       	push   $0x80107a08
...
80105a22:	e8 79 dd ff ff       	call   801037a0 <myproc>
...
80105a30:	e8 6b dd ff ff       	call   801037a0 <myproc>
...
80105a43:	75 63                	jne    80105aa8 <trap+0x118>
    exit();
...
80105a45:	e8 56 dd ff ff       	call   801037a0 <myproc>
80105a4a:	85 c0                	test   %eax,%eax
80105a4c:	74 0f                	je     80105a5d <trap+0xcd>
80105a4e:	e8 4d dd ff ff       	call   801037a0 <myproc>
80105a53:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a57:	0f 84 53 01 00 00    	je     80105bb0 <trap+0x220>
...
80105a5d:	8b 0d a0 57 11 80    	mov    0x801157a0,%ecx
80105a63:	ba 1f 85 eb 51       	mov    $0x51eb851f,%edx
80105a68:	89 c8                	mov    %ecx,%eax
80105a6a:	f7 e2                	mul    %edx
80105a6c:	c1 ea 05             	shr    $0x5,%edx
80105a6f:	6b d2 64             	imul   $0x64,%edx,%edx
80105a72:	39 d1                	cmp    %edx,%ecx
80105a74:	74 4a                	je     80105ac0 <trap+0x130>
  if(myproc() && myproc()->state == RUNNING &&
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a76:	e8 25 dd ff ff       	call   801037a0 <myproc>
80105a7b:	85 c0                	test   %eax,%eax
80105a7d:	74 1d                	je     80105a9c <trap+0x10c>
80105a7f:	e8 1c dd ff ff       	call   801037a0 <myproc>
80105a84:	8b 40 24             	mov    0x24(%eax),%eax
80105a87:	85 c0                	test   %eax,%eax
80105a89:	74 11                	je     80105a9c <trap+0x10c>
80105a8b:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105a8f:	83 e0 03             	and    $0x3,%eax
80105a92:	66 83 f8 03          	cmp    $0x3,%ax
80105a96:	0f 84 01 01 00 00    	je     80105b9d <trap+0x20d>
    exit();
}
...
80105aa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aa8:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105aac:	83 e0 03             	and    $0x3,%eax
80105aaf:	66 83 f8 03          	cmp    $0x3,%ax
80105ab3:	75 90                	jne    80105a45 <trap+0xb5>
    exit();
80105ab5:	e8 b6 e1 ff ff       	call   80103c70 <exit>
80105aba:	eb 89                	jmp    80105a45 <trap+0xb5>
80105abc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if(ticks%100 == 0) priority_boosting();
80105ac0:	e8 9b df ff ff       	call   80103a60 <priority_boosting>
80105ac5:	eb af                	jmp    80105a76 <trap+0xe6>
...
80105ac9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ad0:	e8 6b c5 ff ff       	call   80102040 <ideintr>
    lapiceoi();
80105ad5:	e8 26 cc ff ff       	call   80102700 <lapiceoi>
    break;
...
80105adf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80105ae0:	e8 9b dc ff ff       	call   80103780 <cpuid>
80105ae5:	85 c0                	test   %eax,%eax
80105ae7:	75 ec                	jne    80105ad5 <trap+0x145>
      acquire(&tickslock);
80105ae9:	83 ec 0c             	sub    $0xc,%esp
80105aec:	68 60 4f 11 80       	push   $0x80114f60
80105af1:	e8 ea e9 ff ff       	call   801044e0 <acquire>
      ticks++;
      wakeup(&ticks);
80105af6:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105afd:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105b04:	e8 97 e5 ff ff       	call   801040a0 <wakeup>
      release(&tickslock);
80105b09:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105b10:	e8 7b ea ff ff       	call   80104590 <release>
80105b15:	83 c4 10             	add    $0x10,%esp
80105b18:	eb bb                	jmp    80105ad5 <trap+0x145>
80105b1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80105b20:	e8 9b ca ff ff       	call   801025c0 <kbdintr>
    lapiceoi();
80105b25:	e8 d6 cb ff ff       	call   80102700 <lapiceoi>
    break;
80105b2a:	e9 01 ff ff ff       	jmp    80105a30 <trap+0xa0>
80105b2f:	90                   	nop
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80105b30:	e8 bb 02 00 00       	call   80105df0 <uartintr>
    lapiceoi();
80105b35:	e8 c6 cb ff ff       	call   80102700 <lapiceoi>
    break;
80105b3a:	e9 f1 fe ff ff       	jmp    80105a30 <trap+0xa0>
80105b3f:	90                   	nop
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b40:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105b44:	8b 77 38             	mov    0x38(%edi),%esi
80105b47:	e8 34 dc ff ff       	call   80103780 <cpuid>
80105b4c:	56                   	push   %esi
80105b4d:	53                   	push   %ebx
80105b4e:	50                   	push   %eax
80105b4f:	68 b0 79 10 80       	push   $0x801079b0
80105b54:	e8 07 ab ff ff       	call   80100660 <cprintf>
            cpuid(), tf->cs, tf->eip);
    lapiceoi();
80105b59:	e8 a2 cb ff ff       	call   80102700 <lapiceoi>
    break;
80105b5e:	83 c4 10             	add    $0x10,%esp
80105b61:	e9 ca fe ff ff       	jmp    80105a30 <trap+0xa0>
...
80105b75:	8b 40 24             	mov    0x24(%eax),%eax
80105b78:	85 c0                	test   %eax,%eax
80105b7a:	0f 85 c0 00 00 00    	jne    80105c40 <trap+0x2b0>
      exit();
    myproc()->tf = tf;
80105b80:	e8 1b dc ff ff       	call   801037a0 <myproc>
80105b85:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b88:	e8 53 ee ff ff       	call   801049e0 <syscall>
    if(myproc()->killed)
80105b8d:	e8 0e dc ff ff       	call   801037a0 <myproc>
80105b92:	8b 78 24             	mov    0x24(%eax),%edi
80105b95:	85 ff                	test   %edi,%edi
80105b97:	0f 84 ff fe ff ff    	je     80105a9c <trap+0x10c>
    yield();
  #endif
  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105ba3:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
80105ba4:	e9 c7 e0 ff ff       	jmp    80103c70 <exit>
...
80105bb0:	e8 eb db ff ff       	call   801037a0 <myproc>
80105bb5:	8b 98 84 00 00 00    	mov    0x84(%eax),%ebx
80105bbb:	85 db                	test   %ebx,%ebx
80105bbd:	78 0c                	js     80105bcb <trap+0x23b>
80105bbf:	e8 dc db ff ff       	call   801037a0 <myproc>
80105bc4:	83 a8 84 00 00 00 01 	subl   $0x1,0x84(%eax)
      //큐 레벨이 올라가야할때
      if(myproc()->queuelevel < MLFQ_K -1  &&  myproc()->tickleft == 0 ){
80105bcb:	e8 d0 db ff ff       	call   801037a0 <myproc>
80105bd0:	83 b8 80 00 00 00 03 	cmpl   $0x3,0x80(%eax)
80105bd7:	7f 47                	jg     80105c20 <trap+0x290>
80105bd9:	e8 c2 db ff ff       	call   801037a0 <myproc>
80105bde:	8b 88 84 00 00 00    	mov    0x84(%eax),%ecx
80105be4:	85 c9                	test   %ecx,%ecx
80105be6:	75 38                	jne    80105c20 <trap+0x290>
        myproc()->queuelevel++;
80105be8:	e8 b3 db ff ff       	call   801037a0 <myproc>
80105bed:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
        myproc()->tickleft = 2 * myproc()->queuelevel + 4;
80105bf4:	e8 a7 db ff ff       	call   801037a0 <myproc>
80105bf9:	89 c3                	mov    %eax,%ebx
80105bfb:	e8 a0 db ff ff       	call   801037a0 <myproc>
80105c00:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80105c06:	8d 44 00 04          	lea    0x4(%eax,%eax,1),%eax
80105c0a:	89 83 84 00 00 00    	mov    %eax,0x84(%ebx)
        yield();
80105c10:	e8 8b e1 ff ff       	call   80103da0 <yield>
80105c15:	e9 43 fe ff ff       	jmp    80105a5d <trap+0xcd>
80105c1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      }
      else if(myproc()->tickleft <= 0 ){
80105c20:	e8 7b db ff ff       	call   801037a0 <myproc>
80105c25:	8b 90 84 00 00 00    	mov    0x84(%eax),%edx
80105c2b:	85 d2                	test   %edx,%edx
80105c2d:	0f 8f 2a fe ff ff    	jg     80105a5d <trap+0xcd>
         yield();
80105c33:	e8 68 e1 ff ff       	call   80103da0 <yield>
80105c38:	e9 20 fe ff ff       	jmp    80105a5d <trap+0xcd>
...
trap(struct trapframe *tf)
{
  if(tf->trapno == T_SYSCALL){
    if(myproc()->killed)
      exit();
80105c40:	e8 2b e0 ff ff       	call   80103c70 <exit>
80105c45:	e9 36 ff ff ff       	jmp    80105b80 <trap+0x1f0>
80105c4a:	0f 20 d6             	mov    %cr2,%esi
  //PAGEBREAK: 13
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      //cprintf("에러탐지용 :  %d\n",myproc());
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105c4d:	8b 5f 38             	mov    0x38(%edi),%ebx
80105c50:	e8 2b db ff ff       	call   80103780 <cpuid>
80105c55:	83 ec 0c             	sub    $0xc,%esp
80105c58:	56                   	push   %esi
80105c59:	53                   	push   %ebx
80105c5a:	50                   	push   %eax
80105c5b:	ff 77 30             	pushl  0x30(%edi)
80105c5e:	68 d4 79 10 80       	push   $0x801079d4
80105c63:	e8 f8 a9 ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105c68:	83 c4 14             	add    $0x14,%esp
80105c6b:	68 aa 79 10 80       	push   $0x801079aa
80105c70:	e8 fb a6 ff ff       	call   80100370 <panic>
80105c75:	66 90                	xchg   %ax,%ax
80105c77:	66 90                	xchg   %ax,%ax
...
80105cd5:	e8 46 ca ff ff       	call   80102720 <microdelay>
{
  int i;
...
80105d57:	74 5a                	je     80105db3 <uartinit+0xb3>
    return;
  uart = 1;
80105d59:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105d60:	00 00 00 
...
80105d6f:	bb cc 7a 10 80       	mov    $0x80107acc,%ebx
80105d74:	6a 00                	push   $0x0
80105d76:	6a 04                	push   $0x4
80105d78:	e8 13 c5 ff ff       	call   80102290 <ioapicenable>
...
uartputc(int c)
{
  ...
  if(!uart)
80105d9a:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
...
uartputc(int c)
{
  ...
  if(!uart)
80105dc0:	8b 15 bc a5 10 80    	mov    0x8010a5bc,%edx
    uartputc(*p);
}
...
80105dfb:	e8 f0 a9 ff ff       	call   801007f0 <consoleintr>
}
...
80105e07:	6a 00                	push   $0x0
  jmp alltraps
80105e09:	e9 89 fa ff ff       	jmp    80105897 <alltraps>
...
80105e10:	6a 01                	push   $0x1
  jmp alltraps
80105e12:	e9 80 fa ff ff       	jmp    80105897 <alltraps>
...
80105e19:	6a 02                	push   $0x2
  jmp alltraps
80105e1b:	e9 77 fa ff ff       	jmp    80105897 <alltraps>
...
80105e22:	6a 03                	push   $0x3
  jmp alltraps
80105e24:	e9 6e fa ff ff       	jmp    80105897 <alltraps>
...
80105e2b:	6a 04                	push   $0x4
  jmp alltraps
80105e2d:	e9 65 fa ff ff       	jmp    80105897 <alltraps>
...
80105e34:	6a 05                	push   $0x5
  jmp alltraps
80105e36:	e9 5c fa ff ff       	jmp    80105897 <alltraps>
...
80105e3d:	6a 06                	push   $0x6
  jmp alltraps
80105e3f:	e9 53 fa ff ff       	jmp    80105897 <alltraps>
...
80105e46:	6a 07                	push   $0x7
  jmp alltraps
80105e48:	e9 4a fa ff ff       	jmp    80105897 <alltraps>
...
80105e4d:	6a 08                	push   $0x8
  jmp alltraps
80105e4f:	e9 43 fa ff ff       	jmp    80105897 <alltraps>
...
80105e56:	6a 09                	push   $0x9
  jmp alltraps
80105e58:	e9 3a fa ff ff       	jmp    80105897 <alltraps>
...
80105e5d:	6a 0a                	push   $0xa
  jmp alltraps
80105e5f:	e9 33 fa ff ff       	jmp    80105897 <alltraps>
...
80105e64:	6a 0b                	push   $0xb
  jmp alltraps
80105e66:	e9 2c fa ff ff       	jmp    80105897 <alltraps>
...
80105e6b:	6a 0c                	push   $0xc
  jmp alltraps
80105e6d:	e9 25 fa ff ff       	jmp    80105897 <alltraps>
...
80105e72:	6a 0d                	push   $0xd
  jmp alltraps
80105e74:	e9 1e fa ff ff       	jmp    80105897 <alltraps>
...
80105e79:	6a 0e                	push   $0xe
  jmp alltraps
80105e7b:	e9 17 fa ff ff       	jmp    80105897 <alltraps>
...
80105e82:	6a 0f                	push   $0xf
  jmp alltraps
80105e84:	e9 0e fa ff ff       	jmp    80105897 <alltraps>
...
80105e8b:	6a 10                	push   $0x10
  jmp alltraps
80105e8d:	e9 05 fa ff ff       	jmp    80105897 <alltraps>
...
80105e92:	6a 11                	push   $0x11
  jmp alltraps
80105e94:	e9 fe f9 ff ff       	jmp    80105897 <alltraps>
...
80105e9b:	6a 12                	push   $0x12
  jmp alltraps
80105e9d:	e9 f5 f9 ff ff       	jmp    80105897 <alltraps>
...
80105ea4:	6a 13                	push   $0x13
  jmp alltraps
80105ea6:	e9 ec f9 ff ff       	jmp    80105897 <alltraps>
...
80105ead:	6a 14                	push   $0x14
  jmp alltraps
80105eaf:	e9 e3 f9 ff ff       	jmp    80105897 <alltraps>
...
80105eb6:	6a 15                	push   $0x15
  jmp alltraps
80105eb8:	e9 da f9 ff ff       	jmp    80105897 <alltraps>
...
80105ebf:	6a 16                	push   $0x16
  jmp alltraps
80105ec1:	e9 d1 f9 ff ff       	jmp    80105897 <alltraps>
...
80105ec8:	6a 17                	push   $0x17
  jmp alltraps
80105eca:	e9 c8 f9 ff ff       	jmp    80105897 <alltraps>
...
80105ed1:	6a 18                	push   $0x18
  jmp alltraps
80105ed3:	e9 bf f9 ff ff       	jmp    80105897 <alltraps>
...
80105eda:	6a 19                	push   $0x19
  jmp alltraps
80105edc:	e9 b6 f9 ff ff       	jmp    80105897 <alltraps>
...
80105ee3:	6a 1a                	push   $0x1a
  jmp alltraps
80105ee5:	e9 ad f9 ff ff       	jmp    80105897 <alltraps>
...
80105eec:	6a 1b                	push   $0x1b
  jmp alltraps
80105eee:	e9 a4 f9 ff ff       	jmp    80105897 <alltraps>
...
80105ef5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ef7:	e9 9b f9 ff ff       	jmp    80105897 <alltraps>
...
80105efe:	6a 1d                	push   $0x1d
  jmp alltraps
80105f00:	e9 92 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f07:	6a 1e                	push   $0x1e
  jmp alltraps
80105f09:	e9 89 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f10:	6a 1f                	push   $0x1f
  jmp alltraps
80105f12:	e9 80 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f19:	6a 20                	push   $0x20
  jmp alltraps
80105f1b:	e9 77 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f22:	6a 21                	push   $0x21
  jmp alltraps
80105f24:	e9 6e f9 ff ff       	jmp    80105897 <alltraps>
...
80105f2b:	6a 22                	push   $0x22
  jmp alltraps
80105f2d:	e9 65 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f34:	6a 23                	push   $0x23
  jmp alltraps
80105f36:	e9 5c f9 ff ff       	jmp    80105897 <alltraps>
...
80105f3d:	6a 24                	push   $0x24
  jmp alltraps
80105f3f:	e9 53 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f46:	6a 25                	push   $0x25
  jmp alltraps
80105f48:	e9 4a f9 ff ff       	jmp    80105897 <alltraps>
...
80105f4f:	6a 26                	push   $0x26
  jmp alltraps
80105f51:	e9 41 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f58:	6a 27                	push   $0x27
  jmp alltraps
80105f5a:	e9 38 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f61:	6a 28                	push   $0x28
  jmp alltraps
80105f63:	e9 2f f9 ff ff       	jmp    80105897 <alltraps>
...
80105f6a:	6a 29                	push   $0x29
  jmp alltraps
80105f6c:	e9 26 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f73:	6a 2a                	push   $0x2a
  jmp alltraps
80105f75:	e9 1d f9 ff ff       	jmp    80105897 <alltraps>
...
80105f7c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f7e:	e9 14 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f85:	6a 2c                	push   $0x2c
  jmp alltraps
80105f87:	e9 0b f9 ff ff       	jmp    80105897 <alltraps>
...
80105f8e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f90:	e9 02 f9 ff ff       	jmp    80105897 <alltraps>
...
80105f97:	6a 2e                	push   $0x2e
  jmp alltraps
80105f99:	e9 f9 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fa0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fa2:	e9 f0 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fa9:	6a 30                	push   $0x30
  jmp alltraps
80105fab:	e9 e7 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fb2:	6a 31                	push   $0x31
  jmp alltraps
80105fb4:	e9 de f8 ff ff       	jmp    80105897 <alltraps>
...
80105fbb:	6a 32                	push   $0x32
  jmp alltraps
80105fbd:	e9 d5 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fc4:	6a 33                	push   $0x33
  jmp alltraps
80105fc6:	e9 cc f8 ff ff       	jmp    80105897 <alltraps>
...
80105fcd:	6a 34                	push   $0x34
  jmp alltraps
80105fcf:	e9 c3 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fd6:	6a 35                	push   $0x35
  jmp alltraps
80105fd8:	e9 ba f8 ff ff       	jmp    80105897 <alltraps>
...
80105fdf:	6a 36                	push   $0x36
  jmp alltraps
80105fe1:	e9 b1 f8 ff ff       	jmp    80105897 <alltraps>
...
80105fe8:	6a 37                	push   $0x37
  jmp alltraps
80105fea:	e9 a8 f8 ff ff       	jmp    80105897 <alltraps>
...
80105ff1:	6a 38                	push   $0x38
  jmp alltraps
80105ff3:	e9 9f f8 ff ff       	jmp    80105897 <alltraps>
...
80105ffa:	6a 39                	push   $0x39
  jmp alltraps
80105ffc:	e9 96 f8 ff ff       	jmp    80105897 <alltraps>
...
80106003:	6a 3a                	push   $0x3a
  jmp alltraps
80106005:	e9 8d f8 ff ff       	jmp    80105897 <alltraps>
...
8010600c:	6a 3b                	push   $0x3b
  jmp alltraps
8010600e:	e9 84 f8 ff ff       	jmp    80105897 <alltraps>
...
80106015:	6a 3c                	push   $0x3c
  jmp alltraps
80106017:	e9 7b f8 ff ff       	jmp    80105897 <alltraps>
...
8010601e:	6a 3d                	push   $0x3d
  jmp alltraps
80106020:	e9 72 f8 ff ff       	jmp    80105897 <alltraps>
...
80106027:	6a 3e                	push   $0x3e
  jmp alltraps
80106029:	e9 69 f8 ff ff       	jmp    80105897 <alltraps>
...
80106030:	6a 3f                	push   $0x3f
  jmp alltraps
80106032:	e9 60 f8 ff ff       	jmp    80105897 <alltraps>
...
80106039:	6a 40                	push   $0x40
  jmp alltraps
8010603b:	e9 57 f8 ff ff       	jmp    80105897 <alltraps>
...
80106042:	6a 41                	push   $0x41
  jmp alltraps
80106044:	e9 4e f8 ff ff       	jmp    80105897 <alltraps>
...
8010604b:	6a 42                	push   $0x42
  jmp alltraps
8010604d:	e9 45 f8 ff ff       	jmp    80105897 <alltraps>
...
80106054:	6a 43                	push   $0x43
  jmp alltraps
80106056:	e9 3c f8 ff ff       	jmp    80105897 <alltraps>
...
8010605d:	6a 44                	push   $0x44
  jmp alltraps
8010605f:	e9 33 f8 ff ff       	jmp    80105897 <alltraps>
...
80106066:	6a 45                	push   $0x45
  jmp alltraps
80106068:	e9 2a f8 ff ff       	jmp    80105897 <alltraps>
...
8010606f:	6a 46                	push   $0x46
  jmp alltraps
80106071:	e9 21 f8 ff ff       	jmp    80105897 <alltraps>
...
80106078:	6a 47                	push   $0x47
  jmp alltraps
8010607a:	e9 18 f8 ff ff       	jmp    80105897 <alltraps>
...
80106081:	6a 48                	push   $0x48
  jmp alltraps
80106083:	e9 0f f8 ff ff       	jmp    80105897 <alltraps>
...
8010608a:	6a 49                	push   $0x49
  jmp alltraps
8010608c:	e9 06 f8 ff ff       	jmp    80105897 <alltraps>
...
80106093:	6a 4a                	push   $0x4a
  jmp alltraps
80106095:	e9 fd f7 ff ff       	jmp    80105897 <alltraps>
...
8010609c:	6a 4b                	push   $0x4b
  jmp alltraps
8010609e:	e9 f4 f7 ff ff       	jmp    80105897 <alltraps>
...
801060a5:	6a 4c                	push   $0x4c
  jmp alltraps
801060a7:	e9 eb f7 ff ff       	jmp    80105897 <alltraps>
...
801060ae:	6a 4d                	push   $0x4d
  jmp alltraps
801060b0:	e9 e2 f7 ff ff       	jmp    80105897 <alltraps>
...
801060b7:	6a 4e                	push   $0x4e
  jmp alltraps
801060b9:	e9 d9 f7 ff ff       	jmp    80105897 <alltraps>
...
801060c0:	6a 4f                	push   $0x4f
  jmp alltraps
801060c2:	e9 d0 f7 ff ff       	jmp    80105897 <alltraps>
...
801060c9:	6a 50                	push   $0x50
  jmp alltraps
801060cb:	e9 c7 f7 ff ff       	jmp    80105897 <alltraps>
...
801060d2:	6a 51                	push   $0x51
  jmp alltraps
801060d4:	e9 be f7 ff ff       	jmp    80105897 <alltraps>
...
801060db:	6a 52                	push   $0x52
  jmp alltraps
801060dd:	e9 b5 f7 ff ff       	jmp    80105897 <alltraps>
...
801060e4:	6a 53                	push   $0x53
  jmp alltraps
801060e6:	e9 ac f7 ff ff       	jmp    80105897 <alltraps>
...
801060ed:	6a 54                	push   $0x54
  jmp alltraps
801060ef:	e9 a3 f7 ff ff       	jmp    80105897 <alltraps>
...
801060f6:	6a 55                	push   $0x55
  jmp alltraps
801060f8:	e9 9a f7 ff ff       	jmp    80105897 <alltraps>
...
801060ff:	6a 56                	push   $0x56
  jmp alltraps
80106101:	e9 91 f7 ff ff       	jmp    80105897 <alltraps>
...
80106108:	6a 57                	push   $0x57
  jmp alltraps
8010610a:	e9 88 f7 ff ff       	jmp    80105897 <alltraps>
...
80106111:	6a 58                	push   $0x58
  jmp alltraps
80106113:	e9 7f f7 ff ff       	jmp    80105897 <alltraps>
...
8010611a:	6a 59                	push   $0x59
  jmp alltraps
8010611c:	e9 76 f7 ff ff       	jmp    80105897 <alltraps>
...
80106123:	6a 5a                	push   $0x5a
  jmp alltraps
80106125:	e9 6d f7 ff ff       	jmp    80105897 <alltraps>
...
8010612c:	6a 5b                	push   $0x5b
  jmp alltraps
8010612e:	e9 64 f7 ff ff       	jmp    80105897 <alltraps>
...
80106135:	6a 5c                	push   $0x5c
  jmp alltraps
80106137:	e9 5b f7 ff ff       	jmp    80105897 <alltraps>
...
8010613e:	6a 5d                	push   $0x5d
  jmp alltraps
80106140:	e9 52 f7 ff ff       	jmp    80105897 <alltraps>
...
80106147:	6a 5e                	push   $0x5e
  jmp alltraps
80106149:	e9 49 f7 ff ff       	jmp    80105897 <alltraps>
...
80106150:	6a 5f                	push   $0x5f
  jmp alltraps
80106152:	e9 40 f7 ff ff       	jmp    80105897 <alltraps>
...
80106159:	6a 60                	push   $0x60
  jmp alltraps
8010615b:	e9 37 f7 ff ff       	jmp    80105897 <alltraps>
...
80106162:	6a 61                	push   $0x61
  jmp alltraps
80106164:	e9 2e f7 ff ff       	jmp    80105897 <alltraps>
...
8010616b:	6a 62                	push   $0x62
  jmp alltraps
8010616d:	e9 25 f7 ff ff       	jmp    80105897 <alltraps>
...
80106174:	6a 63                	push   $0x63
  jmp alltraps
80106176:	e9 1c f7 ff ff       	jmp    80105897 <alltraps>
...
8010617d:	6a 64                	push   $0x64
  jmp alltraps
8010617f:	e9 13 f7 ff ff       	jmp    80105897 <alltraps>
...
80106186:	6a 65                	push   $0x65
  jmp alltraps
80106188:	e9 0a f7 ff ff       	jmp    80105897 <alltraps>
...
8010618f:	6a 66                	push   $0x66
  jmp alltraps
80106191:	e9 01 f7 ff ff       	jmp    80105897 <alltraps>
...
80106198:	6a 67                	push   $0x67
  jmp alltraps
8010619a:	e9 f8 f6 ff ff       	jmp    80105897 <alltraps>
...
801061a1:	6a 68                	push   $0x68
  jmp alltraps
801061a3:	e9 ef f6 ff ff       	jmp    80105897 <alltraps>
...
801061aa:	6a 69                	push   $0x69
  jmp alltraps
801061ac:	e9 e6 f6 ff ff       	jmp    80105897 <alltraps>
...
801061b3:	6a 6a                	push   $0x6a
  jmp alltraps
801061b5:	e9 dd f6 ff ff       	jmp    80105897 <alltraps>
...
801061bc:	6a 6b                	push   $0x6b
  jmp alltraps
801061be:	e9 d4 f6 ff ff       	jmp    80105897 <alltraps>
...
801061c5:	6a 6c                	push   $0x6c
  jmp alltraps
801061c7:	e9 cb f6 ff ff       	jmp    80105897 <alltraps>
...
801061ce:	6a 6d                	push   $0x6d
  jmp alltraps
801061d0:	e9 c2 f6 ff ff       	jmp    80105897 <alltraps>
...
801061d7:	6a 6e                	push   $0x6e
  jmp alltraps
801061d9:	e9 b9 f6 ff ff       	jmp    80105897 <alltraps>
...
801061e0:	6a 6f                	push   $0x6f
  jmp alltraps
801061e2:	e9 b0 f6 ff ff       	jmp    80105897 <alltraps>
...
801061e9:	6a 70                	push   $0x70
  jmp alltraps
801061eb:	e9 a7 f6 ff ff       	jmp    80105897 <alltraps>
...
801061f2:	6a 71                	push   $0x71
  jmp alltraps
801061f4:	e9 9e f6 ff ff       	jmp    80105897 <alltraps>
...
801061fb:	6a 72                	push   $0x72
  jmp alltraps
801061fd:	e9 95 f6 ff ff       	jmp    80105897 <alltraps>
...
80106204:	6a 73                	push   $0x73
  jmp alltraps
80106206:	e9 8c f6 ff ff       	jmp    80105897 <alltraps>
...
8010620d:	6a 74                	push   $0x74
  jmp alltraps
8010620f:	e9 83 f6 ff ff       	jmp    80105897 <alltraps>
...
80106216:	6a 75                	push   $0x75
  jmp alltraps
80106218:	e9 7a f6 ff ff       	jmp    80105897 <alltraps>
...
8010621f:	6a 76                	push   $0x76
  jmp alltraps
80106221:	e9 71 f6 ff ff       	jmp    80105897 <alltraps>
...
80106228:	6a 77                	push   $0x77
  jmp alltraps
8010622a:	e9 68 f6 ff ff       	jmp    80105897 <alltraps>
...
80106231:	6a 78                	push   $0x78
  jmp alltraps
80106233:	e9 5f f6 ff ff       	jmp    80105897 <alltraps>
...
8010623a:	6a 79                	push   $0x79
  jmp alltraps
8010623c:	e9 56 f6 ff ff       	jmp    80105897 <alltraps>
...
80106243:	6a 7a                	push   $0x7a
  jmp alltraps
80106245:	e9 4d f6 ff ff       	jmp    80105897 <alltraps>
...
8010624c:	6a 7b                	push   $0x7b
  jmp alltraps
8010624e:	e9 44 f6 ff ff       	jmp    80105897 <alltraps>
...
80106255:	6a 7c                	push   $0x7c
  jmp alltraps
80106257:	e9 3b f6 ff ff       	jmp    80105897 <alltraps>
...
8010625e:	6a 7d                	push   $0x7d
  jmp alltraps
80106260:	e9 32 f6 ff ff       	jmp    80105897 <alltraps>
...
80106267:	6a 7e                	push   $0x7e
  jmp alltraps
80106269:	e9 29 f6 ff ff       	jmp    80105897 <alltraps>
...
80106270:	6a 7f                	push   $0x7f
  jmp alltraps
80106272:	e9 20 f6 ff ff       	jmp    80105897 <alltraps>
...
80106279:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010627e:	e9 14 f6 ff ff       	jmp    80105897 <alltraps>
...
80106285:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010628a:	e9 08 f6 ff ff       	jmp    80105897 <alltraps>
...
80106291:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106296:	e9 fc f5 ff ff       	jmp    80105897 <alltraps>
...
8010629d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801062a2:	e9 f0 f5 ff ff       	jmp    80105897 <alltraps>
...
801062a9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801062ae:	e9 e4 f5 ff ff       	jmp    80105897 <alltraps>
...
801062b5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801062ba:	e9 d8 f5 ff ff       	jmp    80105897 <alltraps>
...
801062c1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801062c6:	e9 cc f5 ff ff       	jmp    80105897 <alltraps>
...
801062cd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062d2:	e9 c0 f5 ff ff       	jmp    80105897 <alltraps>
...
801062d9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062de:	e9 b4 f5 ff ff       	jmp    80105897 <alltraps>
...
801062e5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062ea:	e9 a8 f5 ff ff       	jmp    80105897 <alltraps>
...
801062f1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062f6:	e9 9c f5 ff ff       	jmp    80105897 <alltraps>
...
801062fd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106302:	e9 90 f5 ff ff       	jmp    80105897 <alltraps>
...
80106309:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010630e:	e9 84 f5 ff ff       	jmp    80105897 <alltraps>
...
80106315:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010631a:	e9 78 f5 ff ff       	jmp    80105897 <alltraps>
...
80106321:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106326:	e9 6c f5 ff ff       	jmp    80105897 <alltraps>
...
8010632d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106332:	e9 60 f5 ff ff       	jmp    80105897 <alltraps>
...
80106339:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010633e:	e9 54 f5 ff ff       	jmp    80105897 <alltraps>
...
80106345:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010634a:	e9 48 f5 ff ff       	jmp    80105897 <alltraps>
...
80106351:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106356:	e9 3c f5 ff ff       	jmp    80105897 <alltraps>
...
8010635d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106362:	e9 30 f5 ff ff       	jmp    80105897 <alltraps>
...
80106369:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010636e:	e9 24 f5 ff ff       	jmp    80105897 <alltraps>
...
80106375:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010637a:	e9 18 f5 ff ff       	jmp    80105897 <alltraps>
...
80106381:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106386:	e9 0c f5 ff ff       	jmp    80105897 <alltraps>
...
8010638d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106392:	e9 00 f5 ff ff       	jmp    80105897 <alltraps>
...
80106399:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010639e:	e9 f4 f4 ff ff       	jmp    80105897 <alltraps>
...
801063a5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801063aa:	e9 e8 f4 ff ff       	jmp    80105897 <alltraps>
...
801063b1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801063b6:	e9 dc f4 ff ff       	jmp    80105897 <alltraps>
...
801063bd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801063c2:	e9 d0 f4 ff ff       	jmp    80105897 <alltraps>
...
801063c9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801063ce:	e9 c4 f4 ff ff       	jmp    80105897 <alltraps>
...
801063d5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063da:	e9 b8 f4 ff ff       	jmp    80105897 <alltraps>
...
801063e1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063e6:	e9 ac f4 ff ff       	jmp    80105897 <alltraps>
...
801063ed:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063f2:	e9 a0 f4 ff ff       	jmp    80105897 <alltraps>
...
801063f9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063fe:	e9 94 f4 ff ff       	jmp    80105897 <alltraps>
...
80106405:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010640a:	e9 88 f4 ff ff       	jmp    80105897 <alltraps>
...
80106411:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106416:	e9 7c f4 ff ff       	jmp    80105897 <alltraps>
...
8010641d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106422:	e9 70 f4 ff ff       	jmp    80105897 <alltraps>
...
80106429:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010642e:	e9 64 f4 ff ff       	jmp    80105897 <alltraps>
...
80106435:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010643a:	e9 58 f4 ff ff       	jmp    80105897 <alltraps>
...
80106441:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106446:	e9 4c f4 ff ff       	jmp    80105897 <alltraps>
...
8010644d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106452:	e9 40 f4 ff ff       	jmp    80105897 <alltraps>
...
80106459:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010645e:	e9 34 f4 ff ff       	jmp    80105897 <alltraps>
...
80106465:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010646a:	e9 28 f4 ff ff       	jmp    80105897 <alltraps>
...
80106471:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106476:	e9 1c f4 ff ff       	jmp    80105897 <alltraps>
...
8010647d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106482:	e9 10 f4 ff ff       	jmp    80105897 <alltraps>
...
80106489:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010648e:	e9 04 f4 ff ff       	jmp    80105897 <alltraps>
...
80106495:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010649a:	e9 f8 f3 ff ff       	jmp    80105897 <alltraps>
...
801064a1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801064a6:	e9 ec f3 ff ff       	jmp    80105897 <alltraps>
...
801064ad:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801064b2:	e9 e0 f3 ff ff       	jmp    80105897 <alltraps>
...
801064b9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801064be:	e9 d4 f3 ff ff       	jmp    80105897 <alltraps>
...
801064c5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801064ca:	e9 c8 f3 ff ff       	jmp    80105897 <alltraps>
...
801064d1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064d6:	e9 bc f3 ff ff       	jmp    80105897 <alltraps>
...
801064dd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064e2:	e9 b0 f3 ff ff       	jmp    80105897 <alltraps>
...
801064e9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064ee:	e9 a4 f3 ff ff       	jmp    80105897 <alltraps>
...
801064f5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064fa:	e9 98 f3 ff ff       	jmp    80105897 <alltraps>
...
80106501:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106506:	e9 8c f3 ff ff       	jmp    80105897 <alltraps>
...
8010650d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106512:	e9 80 f3 ff ff       	jmp    80105897 <alltraps>
...
80106519:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010651e:	e9 74 f3 ff ff       	jmp    80105897 <alltraps>
...
80106525:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010652a:	e9 68 f3 ff ff       	jmp    80105897 <alltraps>
...
80106531:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106536:	e9 5c f3 ff ff       	jmp    80105897 <alltraps>
...
8010653d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106542:	e9 50 f3 ff ff       	jmp    80105897 <alltraps>
...
80106549:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010654e:	e9 44 f3 ff ff       	jmp    80105897 <alltraps>
...
80106555:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010655a:	e9 38 f3 ff ff       	jmp    80105897 <alltraps>
...
80106561:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106566:	e9 2c f3 ff ff       	jmp    80105897 <alltraps>
...
8010656d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106572:	e9 20 f3 ff ff       	jmp    80105897 <alltraps>
...
80106579:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010657e:	e9 14 f3 ff ff       	jmp    80105897 <alltraps>
...
80106585:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010658a:	e9 08 f3 ff ff       	jmp    80105897 <alltraps>
...
80106591:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106596:	e9 fc f2 ff ff       	jmp    80105897 <alltraps>
...
8010659d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801065a2:	e9 f0 f2 ff ff       	jmp    80105897 <alltraps>
...
801065a9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801065ae:	e9 e4 f2 ff ff       	jmp    80105897 <alltraps>
...
801065b5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801065ba:	e9 d8 f2 ff ff       	jmp    80105897 <alltraps>
...
801065c1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801065c6:	e9 cc f2 ff ff       	jmp    80105897 <alltraps>
...
801065cd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065d2:	e9 c0 f2 ff ff       	jmp    80105897 <alltraps>
...
801065d9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065de:	e9 b4 f2 ff ff       	jmp    80105897 <alltraps>
...
801065e5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065ea:	e9 a8 f2 ff ff       	jmp    80105897 <alltraps>
...
801065f1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065f6:	e9 9c f2 ff ff       	jmp    80105897 <alltraps>
...
801065fd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106602:	e9 90 f2 ff ff       	jmp    80105897 <alltraps>
...
80106609:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010660e:	e9 84 f2 ff ff       	jmp    80105897 <alltraps>
...
80106615:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010661a:	e9 78 f2 ff ff       	jmp    80105897 <alltraps>
...
80106621:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106626:	e9 6c f2 ff ff       	jmp    80105897 <alltraps>
...
8010662d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106632:	e9 60 f2 ff ff       	jmp    80105897 <alltraps>
...
80106639:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010663e:	e9 54 f2 ff ff       	jmp    80105897 <alltraps>
...
80106645:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010664a:	e9 48 f2 ff ff       	jmp    80105897 <alltraps>
...
80106651:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106656:	e9 3c f2 ff ff       	jmp    80105897 <alltraps>
...
8010665d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106662:	e9 30 f2 ff ff       	jmp    80105897 <alltraps>
...
80106669:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010666e:	e9 24 f2 ff ff       	jmp    80105897 <alltraps>
...
80106675:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010667a:	e9 18 f2 ff ff       	jmp    80105897 <alltraps>
...
80106681:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106686:	e9 0c f2 ff ff       	jmp    80105897 <alltraps>
...
8010668d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106692:	e9 00 f2 ff ff       	jmp    80105897 <alltraps>
...
80106699:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010669e:	e9 f4 f1 ff ff       	jmp    80105897 <alltraps>
...
801066a5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801066aa:	e9 e8 f1 ff ff       	jmp    80105897 <alltraps>
...
801066b1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801066b6:	e9 dc f1 ff ff       	jmp    80105897 <alltraps>
...
801066bd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801066c2:	e9 d0 f1 ff ff       	jmp    80105897 <alltraps>
...
801066c9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801066ce:	e9 c4 f1 ff ff       	jmp    80105897 <alltraps>
...
801066d5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066da:	e9 b8 f1 ff ff       	jmp    80105897 <alltraps>
...
801066e1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066e6:	e9 ac f1 ff ff       	jmp    80105897 <alltraps>
...
801066ed:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066f2:	e9 a0 f1 ff ff       	jmp    80105897 <alltraps>
...
801066f9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066fe:	e9 94 f1 ff ff       	jmp    80105897 <alltraps>
...
80106705:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010670a:	e9 88 f1 ff ff       	jmp    80105897 <alltraps>
...
80106711:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106716:	e9 7c f1 ff ff       	jmp    80105897 <alltraps>
...
8010671d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106722:	e9 70 f1 ff ff       	jmp    80105897 <alltraps>
...
80106729:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010672e:	e9 64 f1 ff ff       	jmp    80105897 <alltraps>
...
80106735:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010673a:	e9 58 f1 ff ff       	jmp    80105897 <alltraps>
...
80106741:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106746:	e9 4c f1 ff ff       	jmp    80105897 <alltraps>
...
8010674d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106752:	e9 40 f1 ff ff       	jmp    80105897 <alltraps>
...
80106759:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010675e:	e9 34 f1 ff ff       	jmp    80105897 <alltraps>
...
80106765:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010676a:	e9 28 f1 ff ff       	jmp    80105897 <alltraps>
...
80106771:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106776:	e9 1c f1 ff ff       	jmp    80105897 <alltraps>
...
8010677d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106782:	e9 10 f1 ff ff       	jmp    80105897 <alltraps>
...
80106789:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010678e:	e9 04 f1 ff ff       	jmp    80105897 <alltraps>
...
80106795:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010679a:	e9 f8 f0 ff ff       	jmp    80105897 <alltraps>
...
801067a1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801067a6:	e9 ec f0 ff ff       	jmp    80105897 <alltraps>
...
801067ad:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801067b2:	e9 e0 f0 ff ff       	jmp    80105897 <alltraps>
...
801067b9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801067be:	e9 d4 f0 ff ff       	jmp    80105897 <alltraps>
...
801067c5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801067ca:	e9 c8 f0 ff ff       	jmp    80105897 <alltraps>
...
801067d1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067d6:	e9 bc f0 ff ff       	jmp    80105897 <alltraps>
...
801067dd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067e2:	e9 b0 f0 ff ff       	jmp    80105897 <alltraps>
...
801067e9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067ee:	e9 a4 f0 ff ff       	jmp    80105897 <alltraps>
...
801067f5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067fa:	e9 98 f0 ff ff       	jmp    80105897 <alltraps>
...
80106801:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106806:	e9 8c f0 ff ff       	jmp    80105897 <alltraps>
...
8010680d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106812:	e9 80 f0 ff ff       	jmp    80105897 <alltraps>
...
80106819:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010681e:	e9 74 f0 ff ff       	jmp    80105897 <alltraps>
...
80106825:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010682a:	e9 68 f0 ff ff       	jmp    80105897 <alltraps>
...
80106831:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106836:	e9 5c f0 ff ff       	jmp    80105897 <alltraps>
...
8010683d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106842:	e9 50 f0 ff ff       	jmp    80105897 <alltraps>
...
80106849:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010684e:	e9 44 f0 ff ff       	jmp    80105897 <alltraps>
...
80106855:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010685a:	e9 38 f0 ff ff       	jmp    80105897 <alltraps>
...
80106861:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106866:	e9 2c f0 ff ff       	jmp    80105897 <alltraps>
...
8010686d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106872:	e9 20 f0 ff ff       	jmp    80105897 <alltraps>
...
801068c4:	e8 b7 bb ff ff       	call   80102480 <kalloc>
...
801068da:	e8 01 dd ff ff       	call   801045e0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010697d:	68 d4 7a 10 80       	push   $0x80107ad4
...
801069d4:	e8 f7 b8 ff ff       	call   801022d0 <kfree>
      *pte = 0;
...
80106a33:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
80106a36:	e8 45 cd ff ff       	call   80103780 <cpuid>
...
80106a48:	66 89 90 f8 27 11 80 	mov    %dx,-0x7feed808(%eax)
80106a4f:	66 89 88 fa 27 11 80 	mov    %cx,-0x7feed806(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a56:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106a5b:	31 c9                	xor    %ecx,%ecx
80106a5d:	66 89 90 00 28 11 80 	mov    %dx,-0x7feed800(%eax)
...
80106a64:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  ...
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106a69:	66 89 88 02 28 11 80 	mov    %cx,-0x7feed7fe(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a70:	31 c9                	xor    %ecx,%ecx
80106a72:	66 89 90 08 28 11 80 	mov    %dx,-0x7feed7f8(%eax)
80106a79:	66 89 88 0a 28 11 80 	mov    %cx,-0x7feed7f6(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a80:	ba ff ff ff ff       	mov    $0xffffffff,%edx
80106a85:	31 c9                	xor    %ecx,%ecx
80106a87:	66 89 90 10 28 11 80 	mov    %dx,-0x7feed7f0(%eax)
  // Map "logical" addresses to virtual addresses using identity map.
  // Cannot share a CODE descriptor for both kernel and user
  // because it would have to have DPL_USR, but the CPU forbids
  // an interrupt from CPL=0 to DPL=3.
  c = &cpus[cpuid()];
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106a8e:	c6 80 fc 27 11 80 00 	movb   $0x0,-0x7feed804(%eax)
static inline void
...
80106a9a:	c6 80 fd 27 11 80 9a 	movb   $0x9a,-0x7feed803(%eax)
80106aa1:	c6 80 fe 27 11 80 cf 	movb   $0xcf,-0x7feed802(%eax)
80106aa8:	c6 80 ff 27 11 80 00 	movb   $0x0,-0x7feed801(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106aaf:	c6 80 04 28 11 80 00 	movb   $0x0,-0x7feed7fc(%eax)
80106ab6:	c6 80 05 28 11 80 92 	movb   $0x92,-0x7feed7fb(%eax)
80106abd:	c6 80 06 28 11 80 cf 	movb   $0xcf,-0x7feed7fa(%eax)
80106ac4:	c6 80 07 28 11 80 00 	movb   $0x0,-0x7feed7f9(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106acb:	c6 80 0c 28 11 80 00 	movb   $0x0,-0x7feed7f4(%eax)
80106ad2:	c6 80 0d 28 11 80 fa 	movb   $0xfa,-0x7feed7f3(%eax)
80106ad9:	c6 80 0e 28 11 80 cf 	movb   $0xcf,-0x7feed7f2(%eax)
80106ae0:	c6 80 0f 28 11 80 00 	movb   $0x0,-0x7feed7f1(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ae7:	66 89 88 12 28 11 80 	mov    %cx,-0x7feed7ee(%eax)
80106aee:	c6 80 14 28 11 80 00 	movb   $0x0,-0x7feed7ec(%eax)
80106af5:	c6 80 15 28 11 80 f2 	movb   $0xf2,-0x7feed7eb(%eax)
80106afc:	c6 80 16 28 11 80 cf 	movb   $0xcf,-0x7feed7ea(%eax)
80106b03:	c6 80 17 28 11 80 00 	movb   $0x0,-0x7feed7e9(%eax)
...
80106b30:	a1 a4 57 11 80       	mov    0x801157a4,%eax
...
80106b74:	0f 84 c4 00 00 00    	je     80106c3e <switchuvm+0xee>
  ...
  pushcli();
80106b7a:	e8 81 d8 ff ff       	call   80104400 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b7f:	e8 7c cb ff ff       	call   80103700 <mycpu>
80106b84:	89 c3                	mov    %eax,%ebx
80106b86:	e8 75 cb ff ff       	call   80103700 <mycpu>
80106b8b:	89 c7                	mov    %eax,%edi
80106b8d:	e8 6e cb ff ff       	call   80103700 <mycpu>
80106b92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b95:	83 c7 08             	add    $0x8,%edi
80106b98:	e8 63 cb ff ff       	call   80103700 <mycpu>
...
80106bd9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106bde:	e8 1d cb ff ff       	call   80103700 <mycpu>
80106be3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106bea:	e8 11 cb ff ff       	call   80103700 <mycpu>
80106bef:	b9 10 00 00 00       	mov    $0x10,%ecx
80106bf4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106bf8:	e8 03 cb ff ff       	call   80103700 <mycpu>
...
80106c06:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106c09:	e8 f2 ca ff ff       	call   80103700 <mycpu>
...
80106c2b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
80106c2c:	e9 0f d8 ff ff       	jmp    80104440 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
80106c34:	68 da 7a 10 80       	push   $0x80107ada
...
80106c41:	68 05 7b 10 80       	push   $0x80107b05
...
80106c4e:	68 f0 7a 10 80       	push   $0x80107af0
...
80106c7b:	77 49                	ja     80106cc6 <inituvm+0x66>
  ...
  mem = kalloc();
80106c7d:	e8 fe b7 ff ff       	call   80102480 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c8f:	e8 4c d9 ff ff       	call   801045e0 <memset>
...
80106cc0:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106cc1:	e9 ca d9 ff ff       	jmp    80104690 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106cc9:	68 19 7b 10 80       	push   $0x80107b19
...
80106d7d:	68 33 7b 10 80       	push   $0x80107b33
...
80106d8a:	68 d4 7b 10 80       	push   $0x80107bd4
...
80106de3:	e8 f8 d7 ff ff       	call   801045e0 <memset>
...
80106e11:	76 7d                	jbe    80106e90 <allocuvm+0xf0>
    mem = kalloc();
80106e13:	e8 68 b6 ff ff       	call   80102480 <kalloc>
    if(mem == 0){
...
80106e21:	68 51 7b 10 80       	push   $0x80107b51
...
80106e53:	68 69 7b 10 80       	push   $0x80107b69
...
80106e76:	e8 55 b4 ff ff       	call   801022d0 <kfree>
      return 0;
...
80106f1e:	e8 ad b3 ff ff       	call   801022d0 <kfree>
...
80106f33:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106f34:	e9 97 b3 ff ff       	jmp    801022d0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
...
80106f3c:	68 85 7b 10 80       	push   $0x80107b85
...
80106f55:	e8 26 b5 ff ff       	call   80102480 <kalloc>
...
80106fdb:	a3 a4 57 11 80       	mov    %eax,0x801157a4
...
8010700f:	68 96 7b 10 80       	push   $0x80107b96
...
80107033:	0f 84 c5 00 00 00    	je     801070fe <copyuvm+0xde>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80107085:	78 69                	js     801070f0 <copyuvm+0xd0>
  uint pa, i, flags;
  char *mem;
...
801070a0:	74 6d                	je     8010710f <copyuvm+0xef>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801070a2:	8b 00                	mov    (%eax),%eax
801070a4:	a8 01                	test   $0x1,%al
801070a6:	74 5a                	je     80107102 <copyuvm+0xe2>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
801070b5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801070b8:	e8 c3 b3 ff ff       	call   80102480 <kalloc>
...
801070f4:	e8 d7 b1 ff ff       	call   801022d0 <kfree>
      goto bad;
801070f9:	83 c4 10             	add    $0x10,%esp
801070fc:	eb c5                	jmp    801070c3 <copyuvm+0xa3>
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
801070fe:	31 c0                	xor    %eax,%eax
80107100:	eb d1                	jmp    801070d3 <copyuvm+0xb3>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80107105:	68 ba 7b 10 80       	push   $0x80107bba
8010710a:	e8 61 92 ff ff       	call   80100370 <panic>
...
80107112:	68 a0 7b 10 80       	push   $0x80107ba0
...
8010712e:	e8 4d f7 ff ff       	call   80106880 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
8010719f:	e8 ec d4 ff ff       	call   80104690 <memmove>
    len -= n;
    buf += n;
