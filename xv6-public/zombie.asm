...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 a4 02 00 00       	call   2ba <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 2e 03 00 00       	call   352 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 96 02 00 00       	call   2c2 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
...
strcmp(const char *p, const char *q)
{
  ...
  69:	8b 5d 08             	mov    0x8(%ebp),%ebx
  6c:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(*p && *p == *q){
  6f:	0f be 03             	movsbl (%ebx),%eax
  72:	0f be 16             	movsbl (%esi),%edx
  75:	84 c0                	test   %al,%al
  77:	74 76                	je     ef <strcmp+0x8f>
  79:	38 c2                	cmp    %al,%dl
  7b:	89 f7                	mov    %esi,%edi
  7d:	74 0f                	je     8e <strcmp+0x2e>
  7f:	eb 38                	jmp    b9 <strcmp+0x59>
  81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  88:	38 d0                	cmp    %dl,%al
  8a:	89 fe                	mov    %edi,%esi
  8c:	75 2b                	jne    b9 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
  8e:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
  ...
  95:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
  98:	50                   	push   %eax
  99:	0f be 03             	movsbl (%ebx),%eax
  9c:	50                   	push   %eax
  9d:	68 60 07 00 00       	push   $0x760
  a2:	6a 02                	push   $0x2
...
{
  while(*p && *p == *q){
  a9:	0f be 03             	movsbl (%ebx),%eax
  ac:	83 c4 10             	add    $0x10,%esp
  af:	0f be 56 01          	movsbl 0x1(%esi),%edx
  b3:	84 c0                	test   %al,%al
  b5:	75 d1                	jne    88 <strcmp+0x28>
  ...
  b9:	52                   	push   %edx
  ba:	50                   	push   %eax
  bb:	68 67 07 00 00       	push   $0x767
  c0:	6a 02                	push   $0x2
  c2:	e8 79 03 00 00       	call   440 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
  c7:	0f b6 17             	movzbl (%edi),%edx
  ca:	0f b6 03             	movzbl (%ebx),%eax
  cd:	83 c4 0c             	add    $0xc,%esp
  d0:	29 d0                	sub    %edx,%eax
  d2:	50                   	push   %eax
  d3:	68 6a 07 00 00       	push   $0x76a
  d8:	6a 02                	push   $0x2
  da:	e8 61 03 00 00       	call   440 <printf>
  return (uchar)*p - (uchar)*q;
  df:	0f b6 03             	movzbl (%ebx),%eax
  e2:	0f b6 17             	movzbl (%edi),%edx
}
  e5:	8d 65 f4             	lea    -0xc(%ebp),%esp
  e8:	5b                   	pop    %ebx
  e9:	5e                   	pop    %esi
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
...
{
  while(*p && *p == *q){
  ef:	89 f7                	mov    %esi,%edi
  f1:	31 c0                	xor    %eax,%eax
  f3:	eb c4                	jmp    b9 <strcmp+0x59>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 78 07 00 00 	movzbl 0x778(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 6e 07 00 00       	mov    $0x76e,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 0c 0a 00 00       	mov    0xa0c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 0c 0a 00 00    	cmp    %eax,0xa0c
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 73d:	0a 00 00 
 740:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 10 0a 00 00       	mov    $0xa10,%eax
 74f:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 756:	00 00 00 
