...
putc(int fd, char c)
{
 ...
 4b8:	e8 b5 fe ff ff       	call   372 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 528:	50                   	push   %eax
 529:	57                   	push   %edi
 52a:	e8 43 fe ff ff       	call   372 <write>
...
putc(int fd, char c)
{
 ...
 5a1:	e8 cc fd ff ff       	call   372 <write>
  int c, i, state;
  uint *ap;
...
putc(int fd, char c)
{
 ...
 66f:	50                   	push   %eax
 670:	57                   	push   %edi
 671:	e8 fc fc ff ff       	call   372 <write>
