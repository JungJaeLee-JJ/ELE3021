...
main(void)
{
  ...
  19:	e8 a4 03 00 00       	call   3c2 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 c7 03 00 00       	call   3fa <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 bb 03 00 00       	call   3fa <dup>
  ...
  52:	e8 a9 04 00 00       	call   500 <printf>
    pid = fork();
  57:	e8 1e 03 00 00       	call   37a <fork>
    if(pid < 0){
  ...
  70:	e8 15 03 00 00       	call   38a <wait>
  ...
  9a:	e8 61 04 00 00       	call   500 <printf>
      exit();
  9f:	e8 de 02 00 00       	call   382 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 20 0b 00 00       	push   $0xb20
  ab:	68 4e 08 00 00       	push   $0x84e
  b0:	e8 05 03 00 00       	call   3ba <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 3d 04 00 00       	call   500 <printf>
      exit();
  c3:	e8 ba 02 00 00       	call   382 <exit>
main(void)
{
  int pid, wpid;
  ...
  d2:	e8 f3 02 00 00       	call   3ca <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 20 08 00 00       	push   $0x820
  e0:	e8 dd 02 00 00       	call   3c2 <open>
...
strcmp(const char *p, const char *q)
{
 ...
 12c:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(*p && *p == *q){
 12f:	0f be 03             	movsbl (%ebx),%eax
 132:	0f be 16             	movsbl (%esi),%edx
 135:	84 c0                	test   %al,%al
 137:	74 76                	je     1af <strcmp+0x8f>
 139:	38 c2                	cmp    %al,%dl
 13b:	89 f7                	mov    %esi,%edi
 13d:	74 0f                	je     14e <strcmp+0x2e>
 13f:	eb 38                	jmp    179 <strcmp+0x59>
 141:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 148:	38 d0                	cmp    %dl,%al
 14a:	89 fe                	mov    %edi,%esi
 14c:	75 2b                	jne    179 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
 14e:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
 ...
 155:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
 158:	50                   	push   %eax
 159:	0f be 03             	movsbl (%ebx),%eax
 15c:	50                   	push   %eax
 15d:	68 70 08 00 00       	push   $0x870
 162:	6a 02                	push   $0x2
...
{
  while(*p && *p == *q){
 169:	0f be 03             	movsbl (%ebx),%eax
 16c:	83 c4 10             	add    $0x10,%esp
 16f:	0f be 56 01          	movsbl 0x1(%esi),%edx
 173:	84 c0                	test   %al,%al
 175:	75 d1                	jne    148 <strcmp+0x28>
 ...
 179:	52                   	push   %edx
 17a:	50                   	push   %eax
 17b:	68 77 08 00 00       	push   $0x877
 180:	6a 02                	push   $0x2
 182:	e8 79 03 00 00       	call   500 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
 187:	0f b6 17             	movzbl (%edi),%edx
 18a:	0f b6 03             	movzbl (%ebx),%eax
 18d:	83 c4 0c             	add    $0xc,%esp
 190:	29 d0                	sub    %edx,%eax
 192:	50                   	push   %eax
 193:	68 7a 08 00 00       	push   $0x87a
 198:	6a 02                	push   $0x2
 19a:	e8 61 03 00 00       	call   500 <printf>
  return (uchar)*p - (uchar)*q;
 19f:	0f b6 03             	movzbl (%ebx),%eax
 1a2:	0f b6 17             	movzbl (%edi),%edx
}
...
{
  while(*p && *p == *q){
 1af:	89 f7                	mov    %esi,%edi
 1b1:	31 c0                	xor    %eax,%eax
 1b3:	eb c4                	jmp    179 <strcmp+0x59>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49f:	f7 f6                	div    %esi
 4a1:	0f b6 92 88 08 00 00 	movzbl 0x888(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 618:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 61b:	b8 7e 08 00 00       	mov    $0x87e,%eax
...
free(void *ap)
{
 ...
 6a1:	a1 28 0b 00 00       	mov    0xb28,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6f9:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 6fe:	5b                   	pop    %ebx
 6ff:	5e                   	pop    %esi
 700:	5f                   	pop    %edi
 ...
 71a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 71d:	a3 28 0b 00 00       	mov    %eax,0xb28
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 28 0b 00 00    	mov    0xb28,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 78f:	76 3f                	jbe    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	39 05 28 0b 00 00    	cmp    %eax,0xb28
 ...
 7b6:	e8 e5 fe ff ff       	call   6a0 <free>
  return freep;
 7bb:	8b 15 28 0b 00 00    	mov    0xb28,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7df:	89 15 28 0b 00 00    	mov    %edx,0xb28
      return (void*)(p + 1);
 ...
 7f4:	eb e9                	jmp    7df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7f6:	c7 05 28 0b 00 00 2c 	movl   $0xb2c,0xb28
 7fd:	0b 00 00 
 800:	c7 05 2c 0b 00 00 2c 	movl   $0xb2c,0xb2c
 807:	0b 00 00 
    base.s.size = 0;
 80a:	b8 2c 0b 00 00       	mov    $0xb2c,%eax
 80f:	c7 05 30 0b 00 00 00 	movl   $0x0,0xb30
 816:	00 00 00 
