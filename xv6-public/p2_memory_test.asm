...
int main(int argc, char *argv[])
{
  ...
  33:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    printf(1, "Memory allocated: %d bytes\n", total);
  39:	53                   	push   %ebx
  3a:	68 a3 07 00 00       	push   $0x7a3
  3f:	6a 01                	push   $0x1
  41:	e8 0a 04 00 00       	call   450 <printf>
    sleep(300);
  ...
  5d:	e8 1e 06 00 00       	call   680 <malloc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 c8 07 00 00 	movzbl 0x7c8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 bf 07 00 00       	mov    $0x7bf,%eax
...
free(void *ap)
{
 ...
 647:	89 08                	mov    %ecx,(%eax)
  freep = p;
 649:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 64e:	5b                   	pop    %ebx
 64f:	5e                   	pop    %esi
 650:	5f                   	pop    %edi
 ...
 66a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 66d:	a3 64 0a 00 00       	mov    %eax,0xa64
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6df:	76 3f                	jbe    720 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	39 05 64 0a 00 00    	cmp    %eax,0xa64
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 64 0a 00 00    	mov    0xa64,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 64 0a 00 00    	mov    %edx,0xa64
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 64 0a 00 00 68 	movl   $0xa68,0xa64
 74d:	0a 00 00 
 750:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 757:	0a 00 00 
    base.s.size = 0;
 75a:	b8 68 0a 00 00       	mov    $0xa68,%eax
