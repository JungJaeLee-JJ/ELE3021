...
_p2_memory_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  30:	83 ec 04             	sub    $0x4,%esp
    ...
    total += N;
  33:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    printf(1, "Memory allocated: %d bytes\n", total);
  39:	53                   	push   %ebx
  3a:	68 93 07 00 00       	push   $0x793
  3f:	6a 01                	push   $0x1
  41:	e8 fa 03 00 00       	call   440 <printf>
    sleep(300);
  46:	c7 04 24 2c 01 00 00 	movl   $0x12c,(%esp)
  4d:	e8 00 03 00 00       	call   352 <sleep>
  }
  ...
  5d:	e8 0e 06 00 00       	call   670 <malloc>
  62:	83 c4 10             	add    $0x10,%esp
  65:	85 c0                	test   %eax,%eax
  67:	75 c7                	jne    30 <main+0x30>
    {
      printf(1, "Memory allocation failed.\n");
  69:	83 ec 08             	sub    $0x8,%esp
  6c:	68 78 07 00 00       	push   $0x778
  71:	6a 01                	push   $0x1
  73:	e8 c8 03 00 00       	call   440 <printf>
      exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 b8 07 00 00 	movzbl 0x7b8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 af 07 00 00       	mov    $0x7af,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 54 0a 00 00       	mov    0xa54,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 54 0a 00 00       	mov    %eax,0xa54
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 54 0a 00 00    	mov    0xa54,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 54 0a 00 00    	cmp    %eax,0xa54
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 54 0a 00 00    	mov    0xa54,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 54 0a 00 00    	mov    %edx,0xa54
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 73d:	0a 00 00 
 740:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 747:	0a 00 00 
    base.s.size = 0;
 74a:	b8 58 0a 00 00       	mov    $0xa58,%eax
