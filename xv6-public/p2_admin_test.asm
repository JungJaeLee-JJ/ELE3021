...
int main(int argc, char *argv[])
{
  ...
  int ret;
  char *argv2[10] = {"zombie", 0};
  29:	c7 45 c0 b0 07 00 00 	movl   $0x7b0,-0x40(%ebp)
  printf(1, "Input password: ");
  ...
  37:	6a 0f                	push   $0xf
  39:	53                   	push   %ebx
  3a:	e8 91 01 00 00       	call   1d0 <gets>
  password[strlen(password) - 1] = 0;
  3f:	89 1c 24             	mov    %ebx,(%esp)
  42:	e8 f9 00 00 00       	call   140 <strlen>
  ...
  9c:	6a 0a                	push   $0xa
  9e:	50                   	push   %eax
  9f:	68 b0 07 00 00       	push   $0x7b0
  a4:	e8 19 03 00 00       	call   3c2 <exec2>
  printf(1, "exec2 returned %d\n", ret);
  a9:	83 c4 0c             	add    $0xc,%esp
  ac:	50                   	push   %eax
  ad:	68 15 08 00 00       	push   $0x815
  b2:	6a 01                	push   $0x1
  b4:	e8 d7 03 00 00       	call   490 <printf>
  exit();
  b9:	e8 44 02 00 00       	call   302 <exit>
  be:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 30 08 00 00 	movzbl 0x830(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 28 08 00 00       	mov    $0x828,%eax
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 d0 0a 00 00       	mov    %eax,0xad0
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 d0 0a 00 00       	mov    %eax,0xad0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 d0 0a 00 00    	mov    %edx,0xad0
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 d0 0a 00 00 d4 	movl   $0xad4,0xad0
 78d:	0a 00 00 
 790:	c7 05 d4 0a 00 00 d4 	movl   $0xad4,0xad4
 797:	0a 00 00 
    base.s.size = 0;
 79a:	b8 d4 0a 00 00       	mov    $0xad4,%eax
 79f:	c7 05 d8 0a 00 00 00 	movl   $0x0,0xad8
 7a6:	00 00 00 
