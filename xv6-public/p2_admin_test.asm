...
int main(int argc, char *argv[])
{
  ...
  int ret;
  char *argv2[10] = {"zombie", 0};
  29:	c7 45 c0 a0 07 00 00 	movl   $0x7a0,-0x40(%ebp)
  printf(1, "Input password: ");
  30:	e8 4b 04 00 00       	call   480 <printf>
  gets(password, 15);
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	6a 0f                	push   $0xf
  ...
  67:	50                   	push   %eax
  68:	68 d3 07 00 00       	push   $0x7d3
  6d:	6a 01                	push   $0x1
  6f:	e8 0c 04 00 00       	call   480 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41f:	f7 f6                	div    %esi
 421:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 18 08 00 00       	mov    $0x818,%eax
