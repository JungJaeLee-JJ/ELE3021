...
int main(int argc, char *argv[])
{
  ...
  int ret;
  char *argv2[10] = {"zombie", 0};
  12:	8d 7d c0             	lea    -0x40(%ebp),%edi
  15:	b9 0a 00 00 00       	mov    $0xa,%ecx
  printf(1, "Input password: ");
  gets(password, 15);
  1a:	8d 5d b1             	lea    -0x4f(%ebp),%ebx
#include "types.h"
#include "stat.h"
#include "user.h"
...
int main(int argc, char *argv[])
{
  1d:	83 ec 54             	sub    $0x54,%esp
  char password[15];
  int ret;
  char *argv2[10] = {"zombie", 0};
  20:	f3 ab                	rep stos %eax,%es:(%edi)
  printf(1, "Input password: ");
  22:	68 f7 07 00 00       	push   $0x7f7
  27:	6a 01                	push   $0x1
...
int main(int argc, char *argv[])
{
  ...
  int ret;
  char *argv2[10] = {"zombie", 0};
  29:	c7 45 c0 f0 07 00 00 	movl   $0x7f0,-0x40(%ebp)
  printf(1, "Input password: ");
  30:	e8 9b 04 00 00       	call   4d0 <printf>
  gets(password, 15);
  35:	58                   	pop    %eax
  36:	5a                   	pop    %edx
  37:	6a 0f                	push   $0xf
  39:	53                   	push   %ebx
  3a:	e8 e1 01 00 00       	call   220 <gets>
  password[strlen(password) - 1] = 0;
  3f:	89 1c 24             	mov    %ebx,(%esp)
  42:	e8 49 01 00 00       	call   190 <strlen>
  ...
  gets(password, 15);
  password[strlen(password) - 1] = 0;
  4a:	c6 44 05 b0 00       	movb   $0x0,-0x50(%ebp,%eax,1)
  printf(1, "getadmin with password %s\n", password);
  4f:	53                   	push   %ebx
  ...
  5f:	e8 a6 03 00 00       	call   40a <getadmin>
  printf(1, "getadmin returned %d\n", ret);
  64:	83 c4 0c             	add    $0xc,%esp
  67:	50                   	push   %eax
  68:	68 23 08 00 00       	push   $0x823
  6d:	6a 01                	push   $0x1
  6f:	e8 5c 04 00 00       	call   4d0 <printf>
  ret = setmemorylimit(getpid(), 1000000);
  74:	e8 59 03 00 00       	call   3d2 <getpid>
  79:	59                   	pop    %ecx
  7a:	5b                   	pop    %ebx
  7b:	68 40 42 0f 00       	push   $0xf4240
  80:	50                   	push   %eax
  81:	e8 94 03 00 00       	call   41a <setmemorylimit>
  printf(1, "setmemorylimit returned %d\n", ret);
  86:	83 c4 0c             	add    $0xc,%esp
  89:	50                   	push   %eax
  8a:	68 39 08 00 00       	push   $0x839
  8f:	6a 01                	push   $0x1
  91:	e8 3a 04 00 00       	call   4d0 <printf>
  ret = exec2("zombie", argv2, 10);
  96:	8d 45 c0             	lea    -0x40(%ebp),%eax
  99:	83 c4 0c             	add    $0xc,%esp
  9c:	6a 0a                	push   $0xa
  9e:	50                   	push   %eax
  9f:	68 f0 07 00 00       	push   $0x7f0
  a4:	e8 69 03 00 00       	call   412 <exec2>
  printf(1, "exec2 returned %d\n", ret);
  a9:	83 c4 0c             	add    $0xc,%esp
  ac:	50                   	push   %eax
  ad:	68 55 08 00 00       	push   $0x855
  b2:	6a 01                	push   $0x1
  b4:	e8 17 04 00 00       	call   4d0 <printf>
  exit();
  b9:	e8 94 02 00 00       	call   352 <exit>
  be:	66 90                	xchg   %ax,%ax
...
strcmp(const char *p, const char *q)
{
  ...
  f9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  fc:	8b 75 0c             	mov    0xc(%ebp),%esi
  while(*p && *p == *q){
  ff:	0f be 03             	movsbl (%ebx),%eax
 102:	0f be 16             	movsbl (%esi),%edx
 105:	84 c0                	test   %al,%al
 107:	74 76                	je     17f <strcmp+0x8f>
 109:	38 c2                	cmp    %al,%dl
 10b:	89 f7                	mov    %esi,%edi
 10d:	74 0f                	je     11e <strcmp+0x2e>
 10f:	eb 38                	jmp    149 <strcmp+0x59>
 111:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 118:	38 d0                	cmp    %dl,%al
 11a:	89 fe                	mov    %edi,%esi
 11c:	75 2b                	jne    149 <strcmp+0x59>
    p++, q++;
	printf(2,"%c %c\n",*p,*q );
 11e:	0f be 46 01          	movsbl 0x1(%esi),%eax
...
strcmp(const char *p, const char *q)
{
 ...
 125:	8d 7e 01             	lea    0x1(%esi),%edi
	printf(2,"%c %c\n",*p,*q );
 128:	50                   	push   %eax
 129:	0f be 03             	movsbl (%ebx),%eax
 12c:	50                   	push   %eax
 12d:	68 68 08 00 00       	push   $0x868
 132:	6a 02                	push   $0x2
 134:	e8 97 03 00 00       	call   4d0 <printf>
}
...
{
  while(*p && *p == *q){
 139:	0f be 03             	movsbl (%ebx),%eax
 13c:	83 c4 10             	add    $0x10,%esp
 13f:	0f be 56 01          	movsbl 0x1(%esi),%edx
 143:	84 c0                	test   %al,%al
 145:	75 d1                	jne    118 <strcmp+0x28>
 ...
 149:	52                   	push   %edx
 14a:	50                   	push   %eax
 14b:	68 6f 08 00 00       	push   $0x86f
 150:	6a 02                	push   $0x2
 152:	e8 79 03 00 00       	call   4d0 <printf>
  printf(2,"%d\n",(uchar)*p - (uchar)*q);
 157:	0f b6 17             	movzbl (%edi),%edx
 15a:	0f b6 03             	movzbl (%ebx),%eax
 15d:	83 c4 0c             	add    $0xc,%esp
 160:	29 d0                	sub    %edx,%eax
 162:	50                   	push   %eax
 163:	68 72 08 00 00       	push   $0x872
 168:	6a 02                	push   $0x2
 16a:	e8 61 03 00 00       	call   4d0 <printf>
  return (uchar)*p - (uchar)*q;
 16f:	0f b6 03             	movzbl (%ebx),%eax
 172:	0f b6 17             	movzbl (%edi),%edx
}
...
{
  while(*p && *p == *q){
 17f:	89 f7                	mov    %esi,%edi
 181:	31 c0                	xor    %eax,%eax
 183:	eb c4                	jmp    149 <strcmp+0x59>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46f:	f7 f6                	div    %esi
 471:	0f b6 92 80 08 00 00 	movzbl 0x880(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5eb:	b8 76 08 00 00       	mov    $0x876,%eax
...
free(void *ap)
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 75f:	76 3f                	jbe    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	39 05 1c 0b 00 00    	cmp    %eax,0xb1c
 ...
 786:	e8 e5 fe ff ff       	call   670 <free>
  return freep;
 78b:	8b 15 1c 0b 00 00    	mov    0xb1c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7af:	89 15 1c 0b 00 00    	mov    %edx,0xb1c
      return (void*)(p + 1);
 ...
 7c4:	eb e9                	jmp    7af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 7cd:	0b 00 00 
 7d0:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 20 0b 00 00       	mov    $0xb20,%eax
 7df:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7e6:	00 00 00 
