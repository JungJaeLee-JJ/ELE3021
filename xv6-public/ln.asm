...
main(int argc, char *argv[])
{
  ...
  21:	e8 4a 04 00 00       	call   470 <printf>
    exit();
  26:	e8 c7 02 00 00       	call   2f2 <exit>
  }
  ...
  33:	e8 1a 03 00 00       	call   352 <link>
  38:	83 c4 10             	add    $0x10,%esp
  3b:	85 c0                	test   %eax,%eax
  3d:	78 05                	js     44 <main+0x44>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3f:	e8 ae 02 00 00       	call   2f2 <exit>
  if(argc != 3){
    printf(2, "Usage: ln old new\n");
    exit();
  }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40f:	f7 f6                	div    %esi
 411:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 588:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 58b:	b8 c5 07 00 00       	mov    $0x7c5,%eax
...
free(void *ap)
{
 ...
 68a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 68d:	a3 64 0a 00 00       	mov    %eax,0xa64
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 64 0a 00 00    	mov    0xa64,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 764:	eb e9                	jmp    74f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	c7 05 64 0a 00 00 68 	movl   $0xa68,0xa64
 76d:	0a 00 00 
 770:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 777:	0a 00 00 
    base.s.size = 0;
 77a:	b8 68 0a 00 00       	mov    $0xa68,%eax
 77f:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 786:	00 00 00 
