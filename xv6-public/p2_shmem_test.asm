...
_p2_shmem_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  char *shmem;
  parent = getpid();
   f:	e8 6e 03 00 00       	call   382 <getpid>
  14:	89 c3                	mov    %eax,%ebx
  
  if ((pid = fork()) < 0)
  16:	e8 df 02 00 00       	call   2fa <fork>
  1b:	85 c0                	test   %eax,%eax
  1d:	0f 88 86 00 00 00    	js     a9 <main+0xa9>
  {
    printf(1, "fork failed!\n");
    exit();
  }
  if (pid == 0)
  23:	74 40                	je     65 <main+0x65>
  ...
  28:	53                   	push   %ebx
  29:	e8 ac 03 00 00       	call   3da <getshmem>
  2e:	89 c3                	mov    %eax,%ebx
    strcpy(shmem, "This is a message from the parent process");
  30:	58                   	pop    %eax
  31:	5a                   	pop    %edx
  32:	68 64 08 00 00       	push   $0x864
  37:	53                   	push   %ebx
  38:	e8 83 00 00 00       	call   c0 <strcpy>
    wait();
  3d:	e8 c8 02 00 00       	call   30a <wait>
    printf(1, "The parent process should still be able to write.\n");
  42:	59                   	pop    %ecx
  43:	58                   	pop    %eax
  44:	68 90 08 00 00       	push   $0x890
  49:	6a 01                	push   $0x1
  4b:	e8 40 04 00 00       	call   490 <printf>
    strcpy(shmem, "Another message from the parent process");
  50:	58                   	pop    %eax
  51:	5a                   	pop    %edx
  52:	68 c4 08 00 00       	push   $0x8c4
  57:	53                   	push   %ebx
  58:	e8 63 00 00 00       	call   c0 <strcpy>
  5d:	83 c4 10             	add    $0x10,%esp
  }

  exit();
  60:	e8 9d 02 00 00       	call   302 <exit>
    printf(1, "fork failed!\n");
    exit();
  }
  if (pid == 0)
  ...
  68:	6a 64                	push   $0x64
  6a:	e8 23 03 00 00       	call   392 <sleep>
    shmem = getshmem(parent);
  6f:	89 1c 24             	mov    %ebx,(%esp)
  72:	e8 63 03 00 00       	call   3da <getshmem>
  ...
  7a:	89 c3                	mov    %eax,%ebx
    printf(1, "A message from the parent process: %s\n", shmem);
  7c:	50                   	push   %eax
  7d:	68 c0 07 00 00       	push   $0x7c0
  82:	6a 01                	push   $0x1
  84:	e8 07 04 00 00       	call   490 <printf>
    printf(1, "Now this should trigger page fault for the child process.\n");
  89:	59                   	pop    %ecx
  8a:	58                   	pop    %eax
  8b:	68 e8 07 00 00       	push   $0x7e8
  90:	6a 01                	push   $0x1
  92:	e8 f9 03 00 00       	call   490 <printf>
    strcpy(shmem, "The child process is not allowed to write in the shared memory!");
  97:	58                   	pop    %eax
  98:	5a                   	pop    %edx
  99:	68 24 08 00 00       	push   $0x824
  9e:	53                   	push   %ebx
  9f:	e8 1c 00 00 00       	call   c0 <strcpy>
  a4:	83 c4 10             	add    $0x10,%esp
  a7:	eb b7                	jmp    60 <main+0x60>
  char *shmem;
  parent = getpid();
  ...
  a9:	51                   	push   %ecx
  aa:	51                   	push   %ecx
  ab:	68 b0 07 00 00       	push   $0x7b0
  b0:	6a 01                	push   $0x1
  b2:	e8 d9 03 00 00       	call   490 <printf>
    exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42f:	f7 f6                	div    %esi
 431:	0f b6 92 f4 08 00 00 	movzbl 0x8f4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 468:	e8 b5 fe ff ff       	call   322 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
 ...
 53a:	50                   	push   %eax
 53b:	57                   	push   %edi
 53c:	e8 e1 fd ff ff       	call   322 <write>
...
putc(int fd, char c)
{
 ...
 5a8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5ab:	b8 ec 08 00 00       	mov    $0x8ec,%eax
...
putc(int fd, char c)
{
 ...
 61f:	50                   	push   %eax
 620:	57                   	push   %edi
 621:	e8 fc fc ff ff       	call   322 <write>
...
free(void *ap)
{
 ...
 631:	a1 90 0b 00 00       	mov    0xb90,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 687:	89 08                	mov    %ecx,(%eax)
  freep = p;
 689:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 68e:	5b                   	pop    %ebx
 68f:	5e                   	pop    %esi
 690:	5f                   	pop    %edi
 ...
 6aa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ad:	a3 90 0b 00 00       	mov    %eax,0xb90
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 90 0b 00 00    	mov    0xb90,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 71f:	76 3f                	jbe    760 <malloc+0xa0>
    ...
    if(p == freep)
 721:	39 05 90 0b 00 00    	cmp    %eax,0xb90
 ...
 746:	e8 e5 fe ff ff       	call   630 <free>
  return freep;
 74b:	8b 15 90 0b 00 00    	mov    0xb90,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 76c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 76f:	89 15 90 0b 00 00    	mov    %edx,0xb90
      return (void*)(p + 1);
 ...
 784:	eb e9                	jmp    76f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 786:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 78d:	0b 00 00 
 790:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 94 0b 00 00       	mov    $0xb94,%eax
 79f:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 7a6:	00 00 00 
