...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    if(fd >= 3){
      ...
      1b:	0f 8f eb 00 00 00    	jg     10c <main+0x10c>
{
  static char buf[100];
  int fd;
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    if(fork1() == 0)
      ...
      5c:	0f 84 d3 00 00 00    	je     135 <main+0x135>
      runcmd(parsecmd(buf));
    wait();
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      71:	e8 da 00 00 00       	call   150 <getcmd>
      76:	83 c4 10             	add    $0x10,%esp
      79:	85 c0                	test   %eax,%eax
      7b:	0f 88 9c 00 00 00    	js     11d <main+0x11d>
    if(!strcmp("logout\n",buf)){
      81:	83 ec 08             	sub    $0x8,%esp
      84:	68 a0 18 00 00       	push   $0x18a0
      89:	68 79 12 00 00       	push   $0x1279
      8e:	e8 bd 0a 00 00       	call   b50 <strcmp>
      93:	83 c4 10             	add    $0x10,%esp
      96:	85 c0                	test   %eax,%eax
      98:	0f 84 84 00 00 00    	je     122 <main+0x122>
		printf(1,"Goodbye\n\n");
		exit();
	}
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      9e:	80 3d a0 18 00 00 63 	cmpb   $0x63,0x18a0
      a5:	75 a9                	jne    50 <main+0x50>
      a7:	80 3d a1 18 00 00 64 	cmpb   $0x64,0x18a1
      ae:	74 90                	je     40 <main+0x40>
int
fork1(void)
{
  int pid;
  ...
  pid = fork();
      b0:	e8 a5 0c 00 00       	call   d5a <fork>
  if(pid == -1)
      b5:	83 f8 ff             	cmp    $0xffffffff,%eax
      b8:	75 a0                	jne    5a <main+0x5a>
    panic("fork");
      ba:	83 ec 0c             	sub    $0xc,%esp
      bd:	68 fa 11 00 00       	push   $0x11fa
      c2:	e8 d9 00 00 00       	call   1a0 <panic>
		printf(1,"Goodbye\n\n");
		exit();
	}
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      ca:	68 a0 18 00 00       	push   $0x18a0
      cf:	e8 cc 0a 00 00       	call   ba0 <strlen>
      if(chdir(buf+3) < 0)
      d4:	c7 04 24 a3 18 00 00 	movl   $0x18a3,(%esp)
		printf(1,"Goodbye\n\n");
		exit();
	}
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
      db:	c6 80 9f 18 00 00 00 	movb   $0x0,0x189f(%eax)
      if(chdir(buf+3) < 0)
      e2:	e8 eb 0c 00 00       	call   dd2 <chdir>
      e7:	83 c4 10             	add    $0x10,%esp
      ea:	85 c0                	test   %eax,%eax
      ec:	0f 89 75 ff ff ff    	jns    67 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
      f2:	50                   	push   %eax
      f3:	68 a3 18 00 00       	push   $0x18a3
      f8:	68 8b 12 00 00       	push   $0x128b
      fd:	6a 02                	push   $0x2
      ff:	e8 ac 0d 00 00       	call   eb0 <printf>
     104:	83 c4 10             	add    $0x10,%esp
     107:	e9 5b ff ff ff       	jmp    67 <main+0x67>
  int fd;
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    if(fd >= 3){
     ...
     10f:	50                   	push   %eax
     110:	e8 75 0c 00 00       	call   d8a <close>
      break;
     115:	83 c4 10             	add    $0x10,%esp
     118:	e9 4a ff ff ff       	jmp    67 <main+0x67>
    }
    if(fork1() == 0)
      runcmd(parsecmd(buf));
    wait();
  ...
  exit();
     11d:	e8 40 0c 00 00       	call   d62 <exit>
  }
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(!strcmp("logout\n",buf)){
     ...
     122:	52                   	push   %edx
     123:	52                   	push   %edx
     124:	68 81 12 00 00       	push   $0x1281
     129:	6a 01                	push   $0x1
     12b:	e8 80 0d 00 00       	call   eb0 <printf>
		exit();
     130:	e8 2d 0c 00 00       	call   d62 <exit>
      if(chdir(buf+3) < 0)
        printf(2, "cannot cd %s\n", buf+3);
      continue;
    }
    if(fork1() == 0)
     ...
     138:	68 a0 18 00 00       	push   $0x18a0
     13d:	e8 6e 09 00 00       	call   ab0 <parsecmd>
     142:	89 04 24             	mov    %eax,(%esp)
     145:	e8 76 00 00 00       	call   1c0 <runcmd>
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     15e:	68 d0 11 00 00       	push   $0x11d0
     163:	6a 02                	push   $0x2
     165:	e8 46 0d 00 00       	call   eb0 <printf>
  memset(buf, 0, nbuf);
     16a:	83 c4 0c             	add    $0xc,%esp
     16d:	56                   	push   %esi
     16e:	6a 00                	push   $0x0
     170:	53                   	push   %ebx
     171:	e8 5a 0a 00 00       	call   bd0 <memset>
  gets(buf, nbuf);
     176:	58                   	pop    %eax
     177:	5a                   	pop    %edx
     178:	56                   	push   %esi
     179:	53                   	push   %ebx
     17a:	e8 b1 0a 00 00       	call   c30 <gets>
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     1a9:	68 6d 12 00 00       	push   $0x126d
     1ae:	6a 02                	push   $0x2
     1b0:	e8 fb 0c 00 00       	call   eb0 <printf>
  exit();
     1b5:	e8 a8 0b 00 00       	call   d62 <exit>
...
runcmd(struct cmd *cmd)
{
  ...
  if(cmd == 0)
     ...
     1cc:	74 76                	je     244 <runcmd+0x84>
    exit();

  switch(cmd->type){
     1ce:	83 3b 05             	cmpl   $0x5,(%ebx)
     1d1:	0f 87 f8 00 00 00    	ja     2cf <runcmd+0x10f>
     1d7:	8b 03                	mov    (%ebx),%eax
     1d9:	ff 24 85 9c 12 00 00 	jmp    *0x129c(,%eax,4)
    runcmd(lcmd->right);
    break;
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     1e6:	50                   	push   %eax
     1e7:	e8 86 0b 00 00       	call   d72 <pipe>
     1ec:	83 c4 10             	add    $0x10,%esp
     1ef:	85 c0                	test   %eax,%eax
     1f1:	0f 88 07 01 00 00    	js     2fe <runcmd+0x13e>
int
fork1(void)
{
  int pid;
  ...
  pid = fork();
     1f7:	e8 5e 0b 00 00       	call   d5a <fork>
  if(pid == -1)
     1fc:	83 f8 ff             	cmp    $0xffffffff,%eax
     1ff:	0f 84 d7 00 00 00    	je     2dc <runcmd+0x11c>
  ...
  case PIPE:
    ...
    if(fork1() == 0){
     ...
     207:	0f 84 fe 00 00 00    	je     30b <runcmd+0x14b>
int
fork1(void)
{
  int pid;
  ...
  pid = fork();
     20d:	e8 48 0b 00 00       	call   d5a <fork>
  if(pid == -1)
     212:	83 f8 ff             	cmp    $0xffffffff,%eax
     215:	0f 84 c1 00 00 00    	je     2dc <runcmd+0x11c>
      dup(p[1]);
      close(p[0]);
      close(p[1]);
      runcmd(pcmd->left);
    ...
    if(fork1() == 0){
     ...
     21d:	0f 84 16 01 00 00    	je     339 <runcmd+0x179>
      dup(p[0]);
      close(p[0]);
      close(p[1]);
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     229:	e8 5c 0b 00 00       	call   d8a <close>
    close(p[1]);
     22e:	58                   	pop    %eax
     22f:	ff 75 f4             	pushl  -0xc(%ebp)
     232:	e8 53 0b 00 00       	call   d8a <close>
    wait();
     237:	e8 2e 0b 00 00       	call   d6a <wait>
    wait();
     23c:	e8 29 0b 00 00       	call   d6a <wait>
    break;
  ...
  if(cmd == 0)
    exit();
     244:	e8 19 0b 00 00       	call   d62 <exit>
int
fork1(void)
{
  int pid;
  ...
  pid = fork();
     249:	e8 0c 0b 00 00       	call   d5a <fork>
  if(pid == -1)
     24e:	83 f8 ff             	cmp    $0xffffffff,%eax
     251:	0f 84 85 00 00 00    	je     2dc <runcmd+0x11c>
    wait();
    break;
  ...
  case BACK:
    ...
    if(fork1() == 0)
     ...
     259:	75 e9                	jne    244 <runcmd+0x84>
     25b:	eb 49                	jmp    2a6 <runcmd+0xe6>
  default:
    panic("runcmd");
  ...
  case EXEC:
    ...
    if(ecmd->argv[0] == 0)
     ...
     262:	74 e0                	je     244 <runcmd+0x84>
      exit();
    exec(ecmd->argv[0], ecmd->argv);
     264:	52                   	push   %edx
     265:	52                   	push   %edx
     266:	8d 53 04             	lea    0x4(%ebx),%edx
     269:	52                   	push   %edx
     26a:	50                   	push   %eax
     26b:	e8 2a 0b 00 00       	call   d9a <exec>
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     270:	83 c4 0c             	add    $0xc,%esp
     273:	ff 73 04             	pushl  0x4(%ebx)
     276:	68 da 11 00 00       	push   $0x11da
     27b:	6a 02                	push   $0x2
     27d:	e8 2e 0c 00 00       	call   eb0 <printf>
    break;
     282:	83 c4 10             	add    $0x10,%esp
     285:	eb bd                	jmp    244 <runcmd+0x84>

  case REDIR:
    rcmd = (struct redircmd*)cmd;
    close(rcmd->fd);
     287:	83 ec 0c             	sub    $0xc,%esp
     28a:	ff 73 14             	pushl  0x14(%ebx)
     28d:	e8 f8 0a 00 00       	call   d8a <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     292:	59                   	pop    %ecx
     293:	58                   	pop    %eax
     294:	ff 73 10             	pushl  0x10(%ebx)
     297:	ff 73 08             	pushl  0x8(%ebx)
     29a:	e8 03 0b 00 00       	call   da2 <open>
     29f:	83 c4 10             	add    $0x10,%esp
     2a2:	85 c0                	test   %eax,%eax
     2a4:	78 43                	js     2e9 <runcmd+0x129>
    break;
  ...
  case BACK:
    ...
    if(fork1() == 0)
     ...
     2a9:	ff 73 04             	pushl  0x4(%ebx)
     2ac:	e8 0f ff ff ff       	call   1c0 <runcmd>
int
fork1(void)
{
  int pid;
  ...
  pid = fork();
     2b1:	e8 a4 0a 00 00       	call   d5a <fork>
  if(pid == -1)
     2b6:	83 f8 ff             	cmp    $0xffffffff,%eax
     2b9:	74 21                	je     2dc <runcmd+0x11c>
    runcmd(rcmd->cmd);
    break;
  ...
  case LIST:
    ...
    if(fork1() == 0)
     ...
     2bd:	74 e7                	je     2a6 <runcmd+0xe6>
      runcmd(lcmd->left);
    wait();
     2bf:	e8 a6 0a 00 00       	call   d6a <wait>
    runcmd(lcmd->right);
     2c4:	83 ec 0c             	sub    $0xc,%esp
     2c7:	ff 73 08             	pushl  0x8(%ebx)
     2ca:	e8 f1 fe ff ff       	call   1c0 <runcmd>
  if(cmd == 0)
    exit();
  ...
  default:
    panic("runcmd");
     ...
     2d2:	68 d3 11 00 00       	push   $0x11d3
     2d7:	e8 c4 fe ff ff       	call   1a0 <panic>
{
  int pid;
  ...
  if(pid == -1)
    panic("fork");
     ...
     2df:	68 fa 11 00 00       	push   $0x11fa
     2e4:	e8 b7 fe ff ff       	call   1a0 <panic>
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ed:	68 ea 11 00 00       	push   $0x11ea
     2f2:	6a 02                	push   $0x2
     2f4:	e8 b7 0b 00 00       	call   eb0 <printf>
      exit();
     2f9:	e8 64 0a 00 00       	call   d62 <exit>
    break;
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     301:	68 ff 11 00 00       	push   $0x11ff
     306:	e8 95 fe ff ff       	call   1a0 <panic>
    if(fork1() == 0){
      close(1);
     30b:	83 ec 0c             	sub    $0xc,%esp
     30e:	6a 01                	push   $0x1
     310:	e8 75 0a 00 00       	call   d8a <close>
      dup(p[1]);
     315:	58                   	pop    %eax
     316:	ff 75 f4             	pushl  -0xc(%ebp)
     319:	e8 bc 0a 00 00       	call   dda <dup>
      close(p[0]);
     31e:	58                   	pop    %eax
     31f:	ff 75 f0             	pushl  -0x10(%ebp)
     322:	e8 63 0a 00 00       	call   d8a <close>
      close(p[1]);
     327:	58                   	pop    %eax
     328:	ff 75 f4             	pushl  -0xc(%ebp)
     32b:	e8 5a 0a 00 00       	call   d8a <close>
      runcmd(pcmd->left);
     330:	58                   	pop    %eax
     331:	ff 73 04             	pushl  0x4(%ebx)
     334:	e8 87 fe ff ff       	call   1c0 <runcmd>
    }
    if(fork1() == 0){
      close(0);
     339:	83 ec 0c             	sub    $0xc,%esp
     33c:	6a 00                	push   $0x0
     33e:	e8 47 0a 00 00       	call   d8a <close>
      dup(p[0]);
     343:	5a                   	pop    %edx
     344:	ff 75 f0             	pushl  -0x10(%ebp)
     347:	e8 8e 0a 00 00       	call   dda <dup>
      close(p[0]);
     34c:	59                   	pop    %ecx
     34d:	ff 75 f0             	pushl  -0x10(%ebp)
     350:	e8 35 0a 00 00       	call   d8a <close>
      close(p[1]);
     355:	58                   	pop    %eax
     356:	ff 75 f4             	pushl  -0xc(%ebp)
     359:	e8 2c 0a 00 00       	call   d8a <close>
      runcmd(pcmd->right);
     35e:	58                   	pop    %eax
     35f:	ff 73 08             	pushl  0x8(%ebx)
     362:	e8 59 fe ff ff       	call   1c0 <runcmd>
     ...
     381:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     385:	68 fa 11 00 00       	push   $0x11fa
     38a:	e8 11 fe ff ff       	call   1a0 <panic>
     38f:	90                   	nop
     ...
     4e0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4f1:	50                   	push   %eax
     4f2:	68 8c 18 00 00       	push   $0x188c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     545:	50                   	push   %eax
     546:	68 8c 18 00 00       	push   $0x188c
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     596:	50                   	push   %eax
     597:	68 84 18 00 00       	push   $0x1884
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     5b5:	50                   	push   %eax
     5b6:	68 8c 18 00 00       	push   $0x188c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     65d:	50                   	push   %eax
     65e:	68 8c 18 00 00       	push   $0x188c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     6b3:	68 21 12 00 00       	push   $0x1221
     6b8:	53                   	push   %ebx
     6b9:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     73e:	68 04 12 00 00       	push   $0x1204
     743:	e8 58 fa ff ff       	call   1a0 <panic>
     748:	90                   	nop
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     75f:	68 24 12 00 00       	push   $0x1224
     764:	57                   	push   %edi
     765:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7b6:	68 3b 12 00 00       	push   $0x123b
     7bb:	57                   	push   %edi
     7bc:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     802:	68 2d 12 00 00       	push   $0x122d
     807:	e8 94 f9 ff ff       	call   1a0 <panic>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     84d:	68 26 12 00 00       	push   $0x1226
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     87b:	68 40 12 00 00       	push   $0x1240
     880:	56                   	push   %esi
     881:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     90b:	68 42 12 00 00       	push   $0x1242
     910:	56                   	push   %esi
     911:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     921:	68 3e 12 00 00       	push   $0x123e
     926:	56                   	push   %esi
     927:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     97f:	68 24 12 00 00       	push   $0x1224
     984:	56                   	push   %esi
     985:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     9ab:	68 60 12 00 00       	push   $0x1260
     9b0:	56                   	push   %esi
     9b1:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     9df:	68 44 12 00 00       	push   $0x1244
     9e4:	e8 b7 f7 ff ff       	call   1a0 <panic>
  gettoken(ps, es, 0, 0);
  cmd = parseline(ps, es);
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     9e9:	83 ec 0c             	sub    $0xc,%esp
     9ec:	68 4f 12 00 00       	push   $0x124f
     9f1:	e8 aa f7 ff ff       	call   1a0 <panic>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a19:	ff 24 85 b4 12 00 00 	jmp    *0x12b4(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     ad7:	68 8a 12 00 00       	push   $0x128a
     adc:	53                   	push   %ebx
     add:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     aff:	52                   	push   %edx
     b00:	50                   	push   %eax
     b01:	68 62 12 00 00       	push   $0x1262
     b06:	6a 02                	push   $0x2
     b08:	e8 a3 03 00 00       	call   eb0 <printf>
    panic("syntax");
     b0d:	c7 04 24 26 12 00 00 	movl   $0x1226,(%esp)
     b14:	e8 87 f6 ff ff       	call   1a0 <panic>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e4f:	f7 f6                	div    %esi
     e51:	0f b6 92 d4 12 00 00 	movzbl 0x12d4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fc8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     fcb:	b8 cc 12 00 00       	mov    $0x12cc,%eax
