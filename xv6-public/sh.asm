      ...
      1b:	0f 8f eb 00 00 00    	jg     10c <main+0x10c>
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d c2 18 00 00 20 	cmpb   $0x20,0x18c2
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(!strcmp("logout\n",buf)){
      ...
      84:	68 c0 18 00 00       	push   $0x18c0
      89:	68 89 12 00 00       	push   $0x1289
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      9e:	80 3d c0 18 00 00 63 	cmpb   $0x63,0x18c0
      a5:	75 a9                	jne    50 <main+0x50>
      a7:	80 3d c1 18 00 00 64 	cmpb   $0x64,0x18c1
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      ca:	68 c0 18 00 00       	push   $0x18c0
      cf:	e8 cc 0a 00 00       	call   ba0 <strlen>
      if(chdir(buf+3) < 0)
      d4:	c7 04 24 c3 18 00 00 	movl   $0x18c3,(%esp)
		printf(1,"Goodbye\n\n");
		exit();
	}
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
      db:	c6 80 bf 18 00 00 00 	movb   $0x0,0x18bf(%eax)
      if(chdir(buf+3) < 0)
      ...
      ec:	0f 89 75 ff ff ff    	jns    67 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
      f2:	50                   	push   %eax
      f3:	68 c3 18 00 00       	push   $0x18c3
      f8:	68 9b 12 00 00       	push   $0x129b
      fd:	6a 02                	push   $0x2
      ff:	e8 bc 0d 00 00       	call   ec0 <printf>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(!strcmp("logout\n",buf)){
     ...
     122:	52                   	push   %edx
     123:	52                   	push   %edx
     124:	68 91 12 00 00       	push   $0x1291
     129:	6a 01                	push   $0x1
     12b:	e8 90 0d 00 00       	call   ec0 <printf>
		exit();
    ...
    if(fork1() == 0)
     ...
     138:	68 c0 18 00 00       	push   $0x18c0
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     15e:	68 e0 11 00 00       	push   $0x11e0
     163:	6a 02                	push   $0x2
     165:	e8 56 0d 00 00       	call   ec0 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     1a9:	68 7d 12 00 00       	push   $0x127d
     1ae:	6a 02                	push   $0x2
     1b0:	e8 0b 0d 00 00       	call   ec0 <printf>
  exit();
...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     1d9:	ff 24 85 ac 12 00 00 	jmp    *0x12ac(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     276:	68 ea 11 00 00       	push   $0x11ea
     27b:	6a 02                	push   $0x2
     27d:	e8 3e 0c 00 00       	call   ec0 <printf>
    break;
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     2d2:	68 e3 11 00 00       	push   $0x11e3
     2d7:	e8 c4 fe ff ff       	call   1a0 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     2df:	68 0a 12 00 00       	push   $0x120a
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ed:	68 fa 11 00 00       	push   $0x11fa
     2f2:	6a 02                	push   $0x2
     2f4:	e8 c7 0b 00 00       	call   ec0 <printf>
      exit();
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     301:	68 0f 12 00 00       	push   $0x120f
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a19:	ff 24 85 c4 12 00 00 	jmp    *0x12c4(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     ad7:	68 9a 12 00 00       	push   $0x129a
     adc:	53                   	push   %ebx
     add:	50                   	push   %eax
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e5f:	f7 f6                	div    %esi
     e61:	0f b6 92 e4 12 00 00 	movzbl 0x12e4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fd8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     fdb:	b8 dc 12 00 00       	mov    $0x12dc,%eax
...
free(void *ap)
{
  ...
  freep = p;
    10b9:	a3 24 19 00 00       	mov    %eax,0x1924
}
    10be:	5b                   	pop    %ebx
    10bf:	5e                   	pop    %esi
    10c0:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    10dd:	a3 24 19 00 00       	mov    %eax,0x1924
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    119c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    119f:	89 15 24 19 00 00    	mov    %edx,0x1924
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    11b6:	c7 05 24 19 00 00 28 	movl   $0x1928,0x1924
    11bd:	19 00 00 
    11c0:	c7 05 28 19 00 00 28 	movl   $0x1928,0x1928
    11c7:	19 00 00 
    base.s.size = 0;
    11ca:	b8 28 19 00 00       	mov    $0x1928,%eax
    11cf:	c7 05 2c 19 00 00 00 	movl   $0x0,0x192c
    11d6:	00 00 00 
