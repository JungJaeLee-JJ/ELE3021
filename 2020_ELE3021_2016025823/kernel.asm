...
80101e98:	68 06 77 10 80       	push   $0x80107706
...
801036b6:	68 d5 74 10 80       	push   $0x801074d5
...
8010372d:	68 dc 74 10 80       	push   $0x801074dc
...
8010373a:	68 b8 75 10 80       	push   $0x801075b8
...
801037b3:	e8 18 35 00 00       	call   80106cd0 <setupkvm>
...
801037d1:	e8 0a 32 00 00       	call   801069e0 <inituvm>
  p->sz = PGSIZE;
...
8010383f:	68 05 75 10 80       	push   $0x80107505
80103844:	50                   	push   %eax
80103845:	e8 c6 0d 00 00       	call   80104610 <safestrcpy>
  p->cwd = namei("/");
8010384a:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
...
80103883:	68 ec 74 10 80       	push   $0x801074ec
...
801038be:	e8 5d 32 00 00       	call   80106b20 <allocuvm>
...
801038d0:	e8 fb 2f 00 00       	call   801068d0 <switchuvm>
  return 0;
...
801038f4:	e8 27 33 00 00       	call   80106c20 <deallocuvm>
...
80103948:	e8 53 34 00 00       	call   80106da0 <copyuvm>
...
80103a8b:	83 c3 7c             	add    $0x7c,%ebx
      ...
      c->proc = p;
      switchuvm(p);
80103a8e:	e8 3d 2e 00 00       	call   801068d0 <switchuvm>
      p->state = RUNNING;
...
80103aa0:	e8 c6 0b 00 00       	call   8010466b <swtch>
      switchkvm();
80103aa5:	e8 06 2e 00 00       	call   801068b0 <switchkvm>
...
80103b60:	68 10 75 10 80       	push   $0x80107510
...
80103b6d:	68 3c 75 10 80       	push   $0x8010753c
...
80103b7a:	68 2e 75 10 80       	push   $0x8010752e
...
80103b87:	68 22 75 10 80       	push   $0x80107522
...
80103cad:	68 5d 75 10 80       	push   $0x8010755d
...
80103cba:	68 50 75 10 80       	push   $0x80107550
...
80103dc9:	68 6f 75 10 80       	push   $0x8010756f
...
80103dd6:	68 69 75 10 80       	push   $0x80107569
...
80103e70:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e77:	e8 d4 2d 00 00       	call   80106c50 <freevm>
        p->pid = 0;
...
80103fdb:	68 1f 79 10 80       	push   $0x8010791f
...
80103ffe:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80104001:	ba 80 75 10 80       	mov    $0x80107580,%edx
  uint pc[10];
...
80104008:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
8010400f:	b8 80 75 10 80       	mov    $0x80107580,%eax
...
8010401e:	68 84 75 10 80       	push   $0x80107584
...
8010405d:	68 c1 6f 10 80       	push   $0x80106fc1
...
8010408a:	68 f8 75 10 80       	push   $0x801075f8
...
801042c5:	68 1a 76 10 80       	push   $0x8010761a
...
801042d2:	68 03 76 10 80       	push   $0x80107603
...
801043b3:	68 21 76 10 80       	push   $0x80107621
...
801043fc:	68 29 76 10 80       	push   $0x80107629
...
8010481d:	89 c3                	mov    %eax,%ebx
  ...
  if(curproc->tf->trapno==128) 
8010481f:	81 7e 30 80 00 00 00 	cmpl   $0x80,0x30(%esi)
80104826:	74 58                	je     80104880 <syscall+0x70>
  ...
  num = curproc->tf->eax;
80104828:	8b 46 1c             	mov    0x1c(%esi),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010482b:	8d 50 ff             	lea    -0x1(%eax),%edx
8010482e:	83 fa 16             	cmp    $0x16,%edx
80104831:	77 1d                	ja     80104850 <syscall+0x40>
80104833:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
8010483a:	85 d2                	test   %edx,%edx
8010483c:	74 12                	je     80104850 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
8010483e:	ff d2                	call   *%edx
80104840:	89 46 1c             	mov    %eax,0x1c(%esi)
  } else {
...
80104850:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104851:	8d 43 6c             	lea    0x6c(%ebx),%eax
...
80104855:	ff 73 10             	pushl  0x10(%ebx)
80104858:	68 4f 76 10 80       	push   $0x8010764f
8010485d:	e8 fe bd ff ff       	call   80100660 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
80104862:	8b 43 18             	mov    0x18(%ebx),%eax
...
80104883:	68 31 76 10 80       	push   $0x80107631
80104888:	e8 d3 bd ff ff       	call   80100660 <cprintf>
	  exit();
8010488d:	e8 0e f3 ff ff       	call   80103ba0 <exit>
	  curproc->tf->eax=syscalls[5]();
80104892:	8b 73 18             	mov    0x18(%ebx),%esi
80104895:	e8 86 02 00 00       	call   80104b20 <sys_read>
8010489a:	83 c4 10             	add    $0x10,%esp
8010489d:	89 46 1c             	mov    %eax,0x1c(%esi)
801048a0:	8b 73 18             	mov    0x18(%ebx),%esi
801048a3:	eb 83                	jmp    80104828 <syscall+0x18>
...
801049f4:	68 fc 76 10 80       	push   $0x801076fc
...
80104a0c:	68 fb 76 10 80       	push   $0x801076fb
...
80104a21:	68 ef 76 10 80       	push   $0x801076ef
...
80104a2e:	68 fe 76 10 80       	push   $0x801076fe
...
80104a3b:	68 e0 76 10 80       	push   $0x801076e0
...
80104a62:	e8 b9 fc ff ff       	call   80104720 <argint>
...
80104b3d:	e8 de fb ff ff       	call   80104720 <argint>
...
80104b55:	e8 16 fc ff ff       	call   80104770 <argptr>
...
80104bad:	e8 6e fb ff ff       	call   80104720 <argint>
...
80104bc5:	e8 a6 fb ff ff       	call   80104770 <argptr>
...
80104c6f:	e8 fc fa ff ff       	call   80104770 <argptr>
...
80104caf:	e8 1c fb ff ff       	call   801047d0 <argstr>
...
80104cc8:	e8 03 fb ff ff       	call   801047d0 <argstr>
...
80104e0f:	e8 bc f9 ff ff       	call   801047d0 <argstr>
...
80104e4d:	58                   	pop    %eax
80104e4e:	5a                   	pop    %edx
80104e4f:	68 fc 76 10 80       	push   $0x801076fc
...
80104e68:	68 fb 76 10 80       	push   $0x801076fb
...
80104ec2:	e8 49 f5 ff ff       	call   80104410 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104fbd:	68 20 77 10 80       	push   $0x80107720
...
80104fca:	68 32 77 10 80       	push   $0x80107732
...
80104fd7:	68 0e 77 10 80       	push   $0x8010770e
...
80104fff:	e8 cc f7 ff ff       	call   801047d0 <argstr>
...
80105018:	e8 03 f7 ff ff       	call   80104720 <argint>
...
80105164:	e8 67 f6 ff ff       	call   801047d0 <argstr>
...
801051c4:	e8 07 f6 ff ff       	call   801047d0 <argstr>
...
801051d9:	e8 42 f5 ff ff       	call   80104720 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
801051ee:	e8 2d f5 ff ff       	call   80104720 <argint>
  char *path;
  int major, minor;
...
8010525d:	e8 6e f5 ff ff       	call   801047d0 <argstr>
...
80105305:	e8 c6 f4 ff ff       	call   801047d0 <argstr>
...
8010531d:	e8 fe f3 ff ff       	call   80104720 <argint>
...
80105348:	e8 c3 f0 ff ff       	call   80104410 <memset>
...
8010535e:	e8 1d f3 ff ff       	call   80104680 <fetchint>
...
80105379:	e8 42 f3 ff ff       	call   801046c0 <fetchstr>
...
801053e1:	e8 8a f3 ff ff       	call   80104770 <argptr>
...
801054dc:	e8 3f f2 ff ff       	call   80104720 <argint>
...
8010557d:	e8 9e f1 ff ff       	call   80104720 <argint>
...
80105595:	e8 76 ed ff ff       	call   80104310 <acquire>
  ticks0 = ticks;
...
801055e5:	e8 d6 ed ff ff       	call   801043c0 <release>
      return -1;
...
80105608:	e8 b3 ed ff ff       	call   801043c0 <release>
  return 0;
...
80105656:	e8 15 e1 ff ff       	call   80103770 <myproc>
8010565b:	8b 40 14             	mov    0x14(%eax),%eax
8010565e:	8b 40 10             	mov    0x10(%eax),%eax
}
80105661:	c9                   	leave  
80105662:	c3                   	ret    
...
{
	return yield();
80105674:	e9 57 e6 ff ff       	jmp    80103cd0 <yield>
...
80105688:	54                   	push   %esp
  call trap
80105689:	e8 02 01 00 00       	call   80105790 <trap>
  addl $4, %esp
...
801056b4:	c6 04 c5 a4 4c 11 80 	movb   $0x0,-0x7feeb35c(,%eax,8)
801056bb:	00 
801056bc:	66 89 0c c5 a2 4c 11 	mov    %cx,-0x7feeb35e(,%eax,8)
801056c3:	80 
801056c4:	c6 04 c5 a5 4c 11 80 	movb   $0x8e,-0x7feeb35b(,%eax,8)
801056cb:	8e 
801056cc:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
801056d3:	80 
801056d4:	c1 ea 10             	shr    $0x10,%edx
801056d7:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
801056de:	80 
void
tvinit(void)
{
...
801056f6:	83 ec 10             	sub    $0x10,%esp
  ...
  //64th user Interrupt
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056f9:	a1 08 a1 10 80       	mov    0x8010a108,%eax

  //128th costom Interrupt
  SETGATE(idt[128],1,SEG_KCODE<<3,vectors[128],DPL_USER);

  initlock(&tickslock, "time");
801056fe:	68 41 77 10 80       	push   $0x80107741
...
80105726:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  ...
  //128th costom Interrupt
  SETGATE(idt[128],1,SEG_KCODE<<3,vectors[128],DPL_USER);
8010572c:	a1 08 a2 10 80       	mov    0x8010a208,%eax
80105731:	66 89 0d a2 50 11 80 	mov    %cx,0x801150a2
80105738:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
8010573f:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
80105746:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
8010574c:	c1 e8 10             	shr    $0x10,%eax
8010574f:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6

  initlock(&tickslock, "time");
80105755:	e8 56 ea ff ff       	call   801041b0 <initlock>
}
...
8010579f:	8d 50 c0             	lea    -0x40(%eax),%edx
801057a2:	83 e2 bf             	and    $0xffffffbf,%edx
801057a5:	0f 84 ed 00 00 00    	je     80105898 <trap+0x108>
  ...
  switch(tf->trapno){
801057ab:	83 e8 20             	sub    $0x20,%eax
801057ae:	83 f8 1f             	cmp    $0x1f,%eax
801057b1:	77 0d                	ja     801057c0 <trap+0x30>
801057b3:	ff 24 85 e8 77 10 80 	jmp    *-0x7fef8818(,%eax,4)
...
801057c7:	0f 84 05 02 00 00    	je     801059d2 <trap+0x242>
801057cd:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801057d1:	0f 84 fb 01 00 00    	je     801059d2 <trap+0x242>
...
80105815:	68 a4 77 10 80       	push   $0x801077a4
...
80105837:	e8 34 df ff ff       	call   80103770 <myproc>
...
8010584e:	0f 84 74 01 00 00    	je     801059c8 <trap+0x238>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105854:	e8 17 df ff ff       	call   80103770 <myproc>
80105859:	85 c0                	test   %eax,%eax
8010585b:	74 0b                	je     80105868 <trap+0xd8>
8010585d:	e8 0e df ff ff       	call   80103770 <myproc>
...
80105866:	74 68                	je     801058d0 <trap+0x140>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105868:	e8 03 df ff ff       	call   80103770 <myproc>
8010586d:	85 c0                	test   %eax,%eax
8010586f:	74 19                	je     8010588a <trap+0xfa>
80105871:	e8 fa de ff ff       	call   80103770 <myproc>
...
trap(struct trapframe *tf)
{
  ...
  if(tf->trapno == T_SYSCALL|| tf->trapno == T_MYINT){
    if(myproc()->killed)
80105898:	e8 d3 de ff ff       	call   80103770 <myproc>
8010589d:	8b 58 24             	mov    0x24(%eax),%ebx
801058a0:	85 db                	test   %ebx,%ebx
801058a2:	0f 85 10 01 00 00    	jne    801059b8 <trap+0x228>
      exit();
    myproc()->tf = tf;
801058a8:	e8 c3 de ff ff       	call   80103770 <myproc>
801058ad:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058b0:	e8 5b ef ff ff       	call   80104810 <syscall>
    if(myproc()->killed)
...
801058c7:	5d                   	pop    %ebp
    ...
    if(myproc()->killed)
      exit();
801058c8:	e9 d3 e2 ff ff       	jmp    80103ba0 <exit>
...
801058d4:	75 92                	jne    80105868 <trap+0xd8>
     tf->trapno == T_IRQ0+IRQ_TIMER)
	{
		...
		yield();
801058d6:	e8 f5 e3 ff ff       	call   80103cd0 <yield>
...
801058e5:	e8 16 ce ff ff       	call   80102700 <lapiceoi>
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ea:	e8 81 de ff ff       	call   80103770 <myproc>
801058ef:	85 c0                	test   %eax,%eax
801058f1:	0f 85 40 ff ff ff    	jne    80105837 <trap+0xa7>
801058f7:	e9 58 ff ff ff       	jmp    80105854 <trap+0xc4>
801058fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_COM1: //32+4
    uartintr();
80105900:	e8 6b 02 00 00       	call   80105b70 <uartintr>
    lapiceoi();
80105905:	e8 f6 cd ff ff       	call   80102700 <lapiceoi>
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010590a:	e8 61 de ff ff       	call   80103770 <myproc>
8010590f:	85 c0                	test   %eax,%eax
80105911:	0f 85 20 ff ff ff    	jne    80105837 <trap+0xa7>
80105917:	e9 38 ff ff ff       	jmp    80105854 <trap+0xc4>
...
80105927:	e8 24 de ff ff       	call   80103750 <cpuid>
8010592c:	56                   	push   %esi
8010592d:	53                   	push   %ebx
8010592e:	50                   	push   %eax
8010592f:	68 4c 77 10 80       	push   $0x8010774c
...
8010593e:	83 c4 10             	add    $0x10,%esp
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105941:	e8 2a de ff ff       	call   80103770 <myproc>
80105946:	85 c0                	test   %eax,%eax
80105948:	0f 85 e9 fe ff ff    	jne    80105837 <trap+0xa7>
8010594e:	e9 01 ff ff ff       	jmp    80105854 <trap+0xc4>
80105953:	90                   	nop
80105954:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE: // 32+14
    ideintr();
80105958:	e8 e3 c6 ff ff       	call   80102040 <ideintr>
    lapiceoi();
8010595d:	e8 9e cd ff ff       	call   80102700 <lapiceoi>
  }
  ...
  // until it gets to the regular system call return.)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105962:	e8 09 de ff ff       	call   80103770 <myproc>
80105967:	85 c0                	test   %eax,%eax
80105969:	0f 85 c8 fe ff ff    	jne    80105837 <trap+0xa7>
8010596f:	e9 e0 fe ff ff       	jmp    80105854 <trap+0xc4>
...
8010597f:	75 dc                	jne    8010595d <trap+0x1cd>
      acquire(&tickslock);
80105981:	83 ec 0c             	sub    $0xc,%esp
80105984:	68 60 4c 11 80       	push   $0x80114c60
80105989:	e8 82 e9 ff ff       	call   80104310 <acquire>
      ticks++;
      wakeup(&ticks);
8010598e:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER: //32 + 0
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105995:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
8010599c:	e8 2f e5 ff ff       	call   80103ed0 <wakeup>
      release(&tickslock);
801059a1:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
801059a8:	e8 13 ea ff ff       	call   801043c0 <release>
801059ad:	83 c4 10             	add    $0x10,%esp
801059b0:	eb ab                	jmp    8010595d <trap+0x1cd>
...
801059bd:	e9 e6 fe ff ff       	jmp    801058a8 <trap+0x118>
...
801059cd:	e9 82 fe ff ff       	jmp    80105854 <trap+0xc4>
801059d2:	0f 20 d6             	mov    %cr2,%esi
  ...
  default:
    if(myproc() == 0 || (tf->cs&3) == 0){
      ...
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801059d5:	8b 5f 38             	mov    0x38(%edi),%ebx
801059d8:	e8 73 dd ff ff       	call   80103750 <cpuid>
801059dd:	83 ec 0c             	sub    $0xc,%esp
801059e0:	56                   	push   %esi
801059e1:	53                   	push   %ebx
801059e2:	50                   	push   %eax
801059e3:	ff 77 30             	pushl  0x30(%edi)
801059e6:	68 70 77 10 80       	push   $0x80107770
801059eb:	e8 70 ac ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801059f0:	83 c4 14             	add    $0x14,%esp
801059f3:	68 46 77 10 80       	push   $0x80107746
801059f8:	e8 73 a9 ff ff       	call   80100370 <panic>
...
80105aef:	bb 68 78 10 80       	mov    $0x80107868,%ebx
...
80105b87:	6a 00                	push   $0x0
  jmp alltraps
80105b89:	e9 eb fa ff ff       	jmp    80105679 <alltraps>
...
80105b90:	6a 01                	push   $0x1
  jmp alltraps
80105b92:	e9 e2 fa ff ff       	jmp    80105679 <alltraps>
...
80105b99:	6a 02                	push   $0x2
  jmp alltraps
80105b9b:	e9 d9 fa ff ff       	jmp    80105679 <alltraps>
...
80105bab:	6a 04                	push   $0x4
  jmp alltraps
80105bad:	e9 c7 fa ff ff       	jmp    80105679 <alltraps>
...
80105bb4:	6a 05                	push   $0x5
  jmp alltraps
80105bb6:	e9 be fa ff ff       	jmp    80105679 <alltraps>
...
80105bbd:	6a 06                	push   $0x6
  jmp alltraps
80105bbf:	e9 b5 fa ff ff       	jmp    80105679 <alltraps>
...
80105bc6:	6a 07                	push   $0x7
  jmp alltraps
80105bc8:	e9 ac fa ff ff       	jmp    80105679 <alltraps>
...
80105bcd:	6a 08                	push   $0x8
  jmp alltraps
80105bcf:	e9 a5 fa ff ff       	jmp    80105679 <alltraps>
...
80105bd6:	6a 09                	push   $0x9
  jmp alltraps
80105bd8:	e9 9c fa ff ff       	jmp    80105679 <alltraps>
...
80105be4:	6a 0b                	push   $0xb
  jmp alltraps
80105be6:	e9 8e fa ff ff       	jmp    80105679 <alltraps>
...
80105beb:	6a 0c                	push   $0xc
  jmp alltraps
80105bed:	e9 87 fa ff ff       	jmp    80105679 <alltraps>
...
80105bf2:	6a 0d                	push   $0xd
  jmp alltraps
80105bf4:	e9 80 fa ff ff       	jmp    80105679 <alltraps>
...
80105bf9:	6a 0e                	push   $0xe
  jmp alltraps
80105bfb:	e9 79 fa ff ff       	jmp    80105679 <alltraps>
...
80105c02:	6a 0f                	push   $0xf
  jmp alltraps
80105c04:	e9 70 fa ff ff       	jmp    80105679 <alltraps>
...
80105c0b:	6a 10                	push   $0x10
  jmp alltraps
80105c0d:	e9 67 fa ff ff       	jmp    80105679 <alltraps>
...
80105c12:	6a 11                	push   $0x11
  jmp alltraps
80105c14:	e9 60 fa ff ff       	jmp    80105679 <alltraps>
...
80105c1b:	6a 12                	push   $0x12
  jmp alltraps
80105c1d:	e9 57 fa ff ff       	jmp    80105679 <alltraps>
...
80105c24:	6a 13                	push   $0x13
  jmp alltraps
80105c26:	e9 4e fa ff ff       	jmp    80105679 <alltraps>
...
80105c2d:	6a 14                	push   $0x14
  jmp alltraps
80105c2f:	e9 45 fa ff ff       	jmp    80105679 <alltraps>
...
80105c36:	6a 15                	push   $0x15
  jmp alltraps
80105c38:	e9 3c fa ff ff       	jmp    80105679 <alltraps>
...
80105c3f:	6a 16                	push   $0x16
  jmp alltraps
80105c41:	e9 33 fa ff ff       	jmp    80105679 <alltraps>
...
80105c48:	6a 17                	push   $0x17
  jmp alltraps
80105c4a:	e9 2a fa ff ff       	jmp    80105679 <alltraps>
...
80105c51:	6a 18                	push   $0x18
  jmp alltraps
80105c53:	e9 21 fa ff ff       	jmp    80105679 <alltraps>
...
80105c5a:	6a 19                	push   $0x19
  jmp alltraps
80105c5c:	e9 18 fa ff ff       	jmp    80105679 <alltraps>
...
80105c63:	6a 1a                	push   $0x1a
  jmp alltraps
80105c65:	e9 0f fa ff ff       	jmp    80105679 <alltraps>
...
80105c6c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c6e:	e9 06 fa ff ff       	jmp    80105679 <alltraps>
...
80105c75:	6a 1c                	push   $0x1c
  jmp alltraps
80105c77:	e9 fd f9 ff ff       	jmp    80105679 <alltraps>
...
80105c7e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c80:	e9 f4 f9 ff ff       	jmp    80105679 <alltraps>
...
80105c87:	6a 1e                	push   $0x1e
  jmp alltraps
80105c89:	e9 eb f9 ff ff       	jmp    80105679 <alltraps>
...
80105c90:	6a 1f                	push   $0x1f
  jmp alltraps
80105c92:	e9 e2 f9 ff ff       	jmp    80105679 <alltraps>
...
80105c99:	6a 20                	push   $0x20
  jmp alltraps
80105c9b:	e9 d9 f9 ff ff       	jmp    80105679 <alltraps>
...
80105ca2:	6a 21                	push   $0x21
  jmp alltraps
80105ca4:	e9 d0 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cab:	6a 22                	push   $0x22
  jmp alltraps
80105cad:	e9 c7 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cb4:	6a 23                	push   $0x23
  jmp alltraps
80105cb6:	e9 be f9 ff ff       	jmp    80105679 <alltraps>
...
80105cbd:	6a 24                	push   $0x24
  jmp alltraps
80105cbf:	e9 b5 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cc6:	6a 25                	push   $0x25
  jmp alltraps
80105cc8:	e9 ac f9 ff ff       	jmp    80105679 <alltraps>
...
80105ccf:	6a 26                	push   $0x26
  jmp alltraps
80105cd1:	e9 a3 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cd8:	6a 27                	push   $0x27
  jmp alltraps
80105cda:	e9 9a f9 ff ff       	jmp    80105679 <alltraps>
...
80105ce1:	6a 28                	push   $0x28
  jmp alltraps
80105ce3:	e9 91 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cea:	6a 29                	push   $0x29
  jmp alltraps
80105cec:	e9 88 f9 ff ff       	jmp    80105679 <alltraps>
...
80105cf3:	6a 2a                	push   $0x2a
  jmp alltraps
80105cf5:	e9 7f f9 ff ff       	jmp    80105679 <alltraps>
...
80105cfc:	6a 2b                	push   $0x2b
  jmp alltraps
80105cfe:	e9 76 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d05:	6a 2c                	push   $0x2c
  jmp alltraps
80105d07:	e9 6d f9 ff ff       	jmp    80105679 <alltraps>
...
80105d0e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d10:	e9 64 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d17:	6a 2e                	push   $0x2e
  jmp alltraps
80105d19:	e9 5b f9 ff ff       	jmp    80105679 <alltraps>
...
80105d20:	6a 2f                	push   $0x2f
  jmp alltraps
80105d22:	e9 52 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d29:	6a 30                	push   $0x30
  jmp alltraps
80105d2b:	e9 49 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d32:	6a 31                	push   $0x31
  jmp alltraps
80105d34:	e9 40 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d3b:	6a 32                	push   $0x32
  jmp alltraps
80105d3d:	e9 37 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d44:	6a 33                	push   $0x33
  jmp alltraps
80105d46:	e9 2e f9 ff ff       	jmp    80105679 <alltraps>
...
80105d4d:	6a 34                	push   $0x34
  jmp alltraps
80105d4f:	e9 25 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d56:	6a 35                	push   $0x35
  jmp alltraps
80105d58:	e9 1c f9 ff ff       	jmp    80105679 <alltraps>
...
80105d5f:	6a 36                	push   $0x36
  jmp alltraps
80105d61:	e9 13 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d68:	6a 37                	push   $0x37
  jmp alltraps
80105d6a:	e9 0a f9 ff ff       	jmp    80105679 <alltraps>
...
80105d71:	6a 38                	push   $0x38
  jmp alltraps
80105d73:	e9 01 f9 ff ff       	jmp    80105679 <alltraps>
...
80105d7a:	6a 39                	push   $0x39
  jmp alltraps
80105d7c:	e9 f8 f8 ff ff       	jmp    80105679 <alltraps>
...
80105d83:	6a 3a                	push   $0x3a
  jmp alltraps
80105d85:	e9 ef f8 ff ff       	jmp    80105679 <alltraps>
...
80105d8c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d8e:	e9 e6 f8 ff ff       	jmp    80105679 <alltraps>
...
80105d95:	6a 3c                	push   $0x3c
  jmp alltraps
80105d97:	e9 dd f8 ff ff       	jmp    80105679 <alltraps>
...
80105d9e:	6a 3d                	push   $0x3d
  jmp alltraps
80105da0:	e9 d4 f8 ff ff       	jmp    80105679 <alltraps>
...
80105da7:	6a 3e                	push   $0x3e
  jmp alltraps
80105da9:	e9 cb f8 ff ff       	jmp    80105679 <alltraps>
...
80105db0:	6a 3f                	push   $0x3f
  jmp alltraps
80105db2:	e9 c2 f8 ff ff       	jmp    80105679 <alltraps>
...
80105db9:	6a 40                	push   $0x40
  jmp alltraps
80105dbb:	e9 b9 f8 ff ff       	jmp    80105679 <alltraps>
...
80105dc2:	6a 41                	push   $0x41
  jmp alltraps
80105dc4:	e9 b0 f8 ff ff       	jmp    80105679 <alltraps>
...
80105dcb:	6a 42                	push   $0x42
  jmp alltraps
80105dcd:	e9 a7 f8 ff ff       	jmp    80105679 <alltraps>
...
80105dd4:	6a 43                	push   $0x43
  jmp alltraps
80105dd6:	e9 9e f8 ff ff       	jmp    80105679 <alltraps>
...
80105ddd:	6a 44                	push   $0x44
  jmp alltraps
80105ddf:	e9 95 f8 ff ff       	jmp    80105679 <alltraps>
...
80105de6:	6a 45                	push   $0x45
  jmp alltraps
80105de8:	e9 8c f8 ff ff       	jmp    80105679 <alltraps>
...
80105def:	6a 46                	push   $0x46
  jmp alltraps
80105df1:	e9 83 f8 ff ff       	jmp    80105679 <alltraps>
...
80105df8:	6a 47                	push   $0x47
  jmp alltraps
80105dfa:	e9 7a f8 ff ff       	jmp    80105679 <alltraps>
...
80105e01:	6a 48                	push   $0x48
  jmp alltraps
80105e03:	e9 71 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e0a:	6a 49                	push   $0x49
  jmp alltraps
80105e0c:	e9 68 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e13:	6a 4a                	push   $0x4a
  jmp alltraps
80105e15:	e9 5f f8 ff ff       	jmp    80105679 <alltraps>
...
80105e1c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e1e:	e9 56 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e25:	6a 4c                	push   $0x4c
  jmp alltraps
80105e27:	e9 4d f8 ff ff       	jmp    80105679 <alltraps>
...
80105e2e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e30:	e9 44 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e37:	6a 4e                	push   $0x4e
  jmp alltraps
80105e39:	e9 3b f8 ff ff       	jmp    80105679 <alltraps>
...
80105e40:	6a 4f                	push   $0x4f
  jmp alltraps
80105e42:	e9 32 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e49:	6a 50                	push   $0x50
  jmp alltraps
80105e4b:	e9 29 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e52:	6a 51                	push   $0x51
  jmp alltraps
80105e54:	e9 20 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e5b:	6a 52                	push   $0x52
  jmp alltraps
80105e5d:	e9 17 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e64:	6a 53                	push   $0x53
  jmp alltraps
80105e66:	e9 0e f8 ff ff       	jmp    80105679 <alltraps>
...
80105e6d:	6a 54                	push   $0x54
  jmp alltraps
80105e6f:	e9 05 f8 ff ff       	jmp    80105679 <alltraps>
...
80105e76:	6a 55                	push   $0x55
  jmp alltraps
80105e78:	e9 fc f7 ff ff       	jmp    80105679 <alltraps>
...
80105e7f:	6a 56                	push   $0x56
  jmp alltraps
80105e81:	e9 f3 f7 ff ff       	jmp    80105679 <alltraps>
...
80105e88:	6a 57                	push   $0x57
  jmp alltraps
80105e8a:	e9 ea f7 ff ff       	jmp    80105679 <alltraps>
...
80105e91:	6a 58                	push   $0x58
  jmp alltraps
80105e93:	e9 e1 f7 ff ff       	jmp    80105679 <alltraps>
...
80105e9a:	6a 59                	push   $0x59
  jmp alltraps
80105e9c:	e9 d8 f7 ff ff       	jmp    80105679 <alltraps>
...
80105ea3:	6a 5a                	push   $0x5a
  jmp alltraps
80105ea5:	e9 cf f7 ff ff       	jmp    80105679 <alltraps>
...
80105eac:	6a 5b                	push   $0x5b
  jmp alltraps
80105eae:	e9 c6 f7 ff ff       	jmp    80105679 <alltraps>
...
80105eb5:	6a 5c                	push   $0x5c
  jmp alltraps
80105eb7:	e9 bd f7 ff ff       	jmp    80105679 <alltraps>
...
80105ebe:	6a 5d                	push   $0x5d
  jmp alltraps
80105ec0:	e9 b4 f7 ff ff       	jmp    80105679 <alltraps>
...
80105ec7:	6a 5e                	push   $0x5e
  jmp alltraps
80105ec9:	e9 ab f7 ff ff       	jmp    80105679 <alltraps>
...
80105ed0:	6a 5f                	push   $0x5f
  jmp alltraps
80105ed2:	e9 a2 f7 ff ff       	jmp    80105679 <alltraps>
...
80105ed9:	6a 60                	push   $0x60
  jmp alltraps
80105edb:	e9 99 f7 ff ff       	jmp    80105679 <alltraps>
...
80105ee2:	6a 61                	push   $0x61
  jmp alltraps
80105ee4:	e9 90 f7 ff ff       	jmp    80105679 <alltraps>
...
80105eeb:	6a 62                	push   $0x62
  jmp alltraps
80105eed:	e9 87 f7 ff ff       	jmp    80105679 <alltraps>
...
80105ef4:	6a 63                	push   $0x63
  jmp alltraps
80105ef6:	e9 7e f7 ff ff       	jmp    80105679 <alltraps>
...
80105efd:	6a 64                	push   $0x64
  jmp alltraps
80105eff:	e9 75 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f06:	6a 65                	push   $0x65
  jmp alltraps
80105f08:	e9 6c f7 ff ff       	jmp    80105679 <alltraps>
...
80105f0f:	6a 66                	push   $0x66
  jmp alltraps
80105f11:	e9 63 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f18:	6a 67                	push   $0x67
  jmp alltraps
80105f1a:	e9 5a f7 ff ff       	jmp    80105679 <alltraps>
...
80105f21:	6a 68                	push   $0x68
  jmp alltraps
80105f23:	e9 51 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f2a:	6a 69                	push   $0x69
  jmp alltraps
80105f2c:	e9 48 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f33:	6a 6a                	push   $0x6a
  jmp alltraps
80105f35:	e9 3f f7 ff ff       	jmp    80105679 <alltraps>
...
80105f3c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f3e:	e9 36 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f45:	6a 6c                	push   $0x6c
  jmp alltraps
80105f47:	e9 2d f7 ff ff       	jmp    80105679 <alltraps>
...
80105f4e:	6a 6d                	push   $0x6d
  jmp alltraps
80105f50:	e9 24 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f57:	6a 6e                	push   $0x6e
  jmp alltraps
80105f59:	e9 1b f7 ff ff       	jmp    80105679 <alltraps>
...
80105f60:	6a 6f                	push   $0x6f
  jmp alltraps
80105f62:	e9 12 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f69:	6a 70                	push   $0x70
  jmp alltraps
80105f6b:	e9 09 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f72:	6a 71                	push   $0x71
  jmp alltraps
80105f74:	e9 00 f7 ff ff       	jmp    80105679 <alltraps>
...
80105f7b:	6a 72                	push   $0x72
  jmp alltraps
80105f7d:	e9 f7 f6 ff ff       	jmp    80105679 <alltraps>
...
80105f84:	6a 73                	push   $0x73
  jmp alltraps
80105f86:	e9 ee f6 ff ff       	jmp    80105679 <alltraps>
...
80105f8d:	6a 74                	push   $0x74
  jmp alltraps
80105f8f:	e9 e5 f6 ff ff       	jmp    80105679 <alltraps>
...
80105f96:	6a 75                	push   $0x75
  jmp alltraps
80105f98:	e9 dc f6 ff ff       	jmp    80105679 <alltraps>
...
80105f9f:	6a 76                	push   $0x76
  jmp alltraps
80105fa1:	e9 d3 f6 ff ff       	jmp    80105679 <alltraps>
...
80105fa8:	6a 77                	push   $0x77
  jmp alltraps
80105faa:	e9 ca f6 ff ff       	jmp    80105679 <alltraps>
...
80105fb1:	6a 78                	push   $0x78
  jmp alltraps
80105fb3:	e9 c1 f6 ff ff       	jmp    80105679 <alltraps>
...
80105fba:	6a 79                	push   $0x79
  jmp alltraps
80105fbc:	e9 b8 f6 ff ff       	jmp    80105679 <alltraps>
...
80105fc3:	6a 7a                	push   $0x7a
  jmp alltraps
80105fc5:	e9 af f6 ff ff       	jmp    80105679 <alltraps>
...
80105fcc:	6a 7b                	push   $0x7b
  jmp alltraps
80105fce:	e9 a6 f6 ff ff       	jmp    80105679 <alltraps>
...
80105fd5:	6a 7c                	push   $0x7c
  jmp alltraps
80105fd7:	e9 9d f6 ff ff       	jmp    80105679 <alltraps>
...
80105fde:	6a 7d                	push   $0x7d
  jmp alltraps
80105fe0:	e9 94 f6 ff ff       	jmp    80105679 <alltraps>
...
80105fe7:	6a 7e                	push   $0x7e
  jmp alltraps
80105fe9:	e9 8b f6 ff ff       	jmp    80105679 <alltraps>
...
80105ff0:	6a 7f                	push   $0x7f
  jmp alltraps
80105ff2:	e9 82 f6 ff ff       	jmp    80105679 <alltraps>
...
80105ff9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105ffe:	e9 76 f6 ff ff       	jmp    80105679 <alltraps>
...
80106005:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010600a:	e9 6a f6 ff ff       	jmp    80105679 <alltraps>
...
80106011:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106016:	e9 5e f6 ff ff       	jmp    80105679 <alltraps>
...
8010601d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106022:	e9 52 f6 ff ff       	jmp    80105679 <alltraps>
...
80106029:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010602e:	e9 46 f6 ff ff       	jmp    80105679 <alltraps>
...
80106035:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010603a:	e9 3a f6 ff ff       	jmp    80105679 <alltraps>
...
80106041:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106046:	e9 2e f6 ff ff       	jmp    80105679 <alltraps>
...
8010604d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106052:	e9 22 f6 ff ff       	jmp    80105679 <alltraps>
...
80106059:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010605e:	e9 16 f6 ff ff       	jmp    80105679 <alltraps>
...
80106065:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010606a:	e9 0a f6 ff ff       	jmp    80105679 <alltraps>
...
80106071:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106076:	e9 fe f5 ff ff       	jmp    80105679 <alltraps>
...
8010607d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106082:	e9 f2 f5 ff ff       	jmp    80105679 <alltraps>
...
80106089:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010608e:	e9 e6 f5 ff ff       	jmp    80105679 <alltraps>
...
80106095:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010609a:	e9 da f5 ff ff       	jmp    80105679 <alltraps>
...
801060a1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801060a6:	e9 ce f5 ff ff       	jmp    80105679 <alltraps>
...
801060ad:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801060b2:	e9 c2 f5 ff ff       	jmp    80105679 <alltraps>
...
801060b9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801060be:	e9 b6 f5 ff ff       	jmp    80105679 <alltraps>
...
801060c5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801060ca:	e9 aa f5 ff ff       	jmp    80105679 <alltraps>
...
801060d1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801060d6:	e9 9e f5 ff ff       	jmp    80105679 <alltraps>
...
801060dd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801060e2:	e9 92 f5 ff ff       	jmp    80105679 <alltraps>
...
801060e9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801060ee:	e9 86 f5 ff ff       	jmp    80105679 <alltraps>
...
801060f5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801060fa:	e9 7a f5 ff ff       	jmp    80105679 <alltraps>
...
80106101:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106106:	e9 6e f5 ff ff       	jmp    80105679 <alltraps>
...
8010610d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106112:	e9 62 f5 ff ff       	jmp    80105679 <alltraps>
...
80106119:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010611e:	e9 56 f5 ff ff       	jmp    80105679 <alltraps>
...
80106125:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010612a:	e9 4a f5 ff ff       	jmp    80105679 <alltraps>
...
80106131:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106136:	e9 3e f5 ff ff       	jmp    80105679 <alltraps>
...
8010613d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106142:	e9 32 f5 ff ff       	jmp    80105679 <alltraps>
...
80106149:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010614e:	e9 26 f5 ff ff       	jmp    80105679 <alltraps>
...
80106155:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010615a:	e9 1a f5 ff ff       	jmp    80105679 <alltraps>
...
80106161:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106166:	e9 0e f5 ff ff       	jmp    80105679 <alltraps>
...
8010616d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106172:	e9 02 f5 ff ff       	jmp    80105679 <alltraps>
...
80106179:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010617e:	e9 f6 f4 ff ff       	jmp    80105679 <alltraps>
...
80106185:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010618a:	e9 ea f4 ff ff       	jmp    80105679 <alltraps>
...
80106191:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106196:	e9 de f4 ff ff       	jmp    80105679 <alltraps>
...
8010619d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801061a2:	e9 d2 f4 ff ff       	jmp    80105679 <alltraps>
...
801061a9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801061ae:	e9 c6 f4 ff ff       	jmp    80105679 <alltraps>
...
801061b5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801061ba:	e9 ba f4 ff ff       	jmp    80105679 <alltraps>
...
801061c1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801061c6:	e9 ae f4 ff ff       	jmp    80105679 <alltraps>
...
801061cd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801061d2:	e9 a2 f4 ff ff       	jmp    80105679 <alltraps>
...
801061d9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801061de:	e9 96 f4 ff ff       	jmp    80105679 <alltraps>
...
801061e5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801061ea:	e9 8a f4 ff ff       	jmp    80105679 <alltraps>
...
801061f1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801061f6:	e9 7e f4 ff ff       	jmp    80105679 <alltraps>
...
801061fd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106202:	e9 72 f4 ff ff       	jmp    80105679 <alltraps>
...
80106209:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010620e:	e9 66 f4 ff ff       	jmp    80105679 <alltraps>
...
80106215:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010621a:	e9 5a f4 ff ff       	jmp    80105679 <alltraps>
...
80106221:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106226:	e9 4e f4 ff ff       	jmp    80105679 <alltraps>
...
8010622d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106232:	e9 42 f4 ff ff       	jmp    80105679 <alltraps>
...
80106239:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010623e:	e9 36 f4 ff ff       	jmp    80105679 <alltraps>
...
80106245:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010624a:	e9 2a f4 ff ff       	jmp    80105679 <alltraps>
...
80106251:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106256:	e9 1e f4 ff ff       	jmp    80105679 <alltraps>
...
8010625d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106262:	e9 12 f4 ff ff       	jmp    80105679 <alltraps>
...
80106269:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010626e:	e9 06 f4 ff ff       	jmp    80105679 <alltraps>
...
80106275:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010627a:	e9 fa f3 ff ff       	jmp    80105679 <alltraps>
...
80106281:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106286:	e9 ee f3 ff ff       	jmp    80105679 <alltraps>
...
8010628d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106292:	e9 e2 f3 ff ff       	jmp    80105679 <alltraps>
...
80106299:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010629e:	e9 d6 f3 ff ff       	jmp    80105679 <alltraps>
...
801062a5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801062aa:	e9 ca f3 ff ff       	jmp    80105679 <alltraps>
...
801062b1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801062b6:	e9 be f3 ff ff       	jmp    80105679 <alltraps>
...
801062bd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801062c2:	e9 b2 f3 ff ff       	jmp    80105679 <alltraps>
...
801062c9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801062ce:	e9 a6 f3 ff ff       	jmp    80105679 <alltraps>
...
801062d5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801062da:	e9 9a f3 ff ff       	jmp    80105679 <alltraps>
...
801062e1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801062e6:	e9 8e f3 ff ff       	jmp    80105679 <alltraps>
...
801062ed:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801062f2:	e9 82 f3 ff ff       	jmp    80105679 <alltraps>
...
801062f9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801062fe:	e9 76 f3 ff ff       	jmp    80105679 <alltraps>
...
80106305:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010630a:	e9 6a f3 ff ff       	jmp    80105679 <alltraps>
...
80106311:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106316:	e9 5e f3 ff ff       	jmp    80105679 <alltraps>
...
8010631d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106322:	e9 52 f3 ff ff       	jmp    80105679 <alltraps>
...
80106329:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010632e:	e9 46 f3 ff ff       	jmp    80105679 <alltraps>
...
80106335:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010633a:	e9 3a f3 ff ff       	jmp    80105679 <alltraps>
...
80106341:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106346:	e9 2e f3 ff ff       	jmp    80105679 <alltraps>
...
8010634d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106352:	e9 22 f3 ff ff       	jmp    80105679 <alltraps>
...
80106359:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010635e:	e9 16 f3 ff ff       	jmp    80105679 <alltraps>
...
80106365:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010636a:	e9 0a f3 ff ff       	jmp    80105679 <alltraps>
...
80106371:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106376:	e9 fe f2 ff ff       	jmp    80105679 <alltraps>
...
8010637d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106382:	e9 f2 f2 ff ff       	jmp    80105679 <alltraps>
...
80106389:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010638e:	e9 e6 f2 ff ff       	jmp    80105679 <alltraps>
...
80106395:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010639a:	e9 da f2 ff ff       	jmp    80105679 <alltraps>
...
801063a1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801063a6:	e9 ce f2 ff ff       	jmp    80105679 <alltraps>
...
801063ad:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801063b2:	e9 c2 f2 ff ff       	jmp    80105679 <alltraps>
...
801063b9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801063be:	e9 b6 f2 ff ff       	jmp    80105679 <alltraps>
...
801063c5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801063ca:	e9 aa f2 ff ff       	jmp    80105679 <alltraps>
...
801063d1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801063d6:	e9 9e f2 ff ff       	jmp    80105679 <alltraps>
...
801063dd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801063e2:	e9 92 f2 ff ff       	jmp    80105679 <alltraps>
...
801063e9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801063ee:	e9 86 f2 ff ff       	jmp    80105679 <alltraps>
...
801063f5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801063fa:	e9 7a f2 ff ff       	jmp    80105679 <alltraps>
...
80106401:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106406:	e9 6e f2 ff ff       	jmp    80105679 <alltraps>
...
8010640d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106412:	e9 62 f2 ff ff       	jmp    80105679 <alltraps>
...
80106419:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010641e:	e9 56 f2 ff ff       	jmp    80105679 <alltraps>
...
80106425:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010642a:	e9 4a f2 ff ff       	jmp    80105679 <alltraps>
...
80106431:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106436:	e9 3e f2 ff ff       	jmp    80105679 <alltraps>
...
8010643d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106442:	e9 32 f2 ff ff       	jmp    80105679 <alltraps>
...
80106449:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010644e:	e9 26 f2 ff ff       	jmp    80105679 <alltraps>
...
80106455:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010645a:	e9 1a f2 ff ff       	jmp    80105679 <alltraps>
...
80106461:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106466:	e9 0e f2 ff ff       	jmp    80105679 <alltraps>
...
8010646d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106472:	e9 02 f2 ff ff       	jmp    80105679 <alltraps>
...
80106479:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010647e:	e9 f6 f1 ff ff       	jmp    80105679 <alltraps>
...
80106485:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010648a:	e9 ea f1 ff ff       	jmp    80105679 <alltraps>
...
80106491:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106496:	e9 de f1 ff ff       	jmp    80105679 <alltraps>
...
8010649d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801064a2:	e9 d2 f1 ff ff       	jmp    80105679 <alltraps>
...
801064a9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801064ae:	e9 c6 f1 ff ff       	jmp    80105679 <alltraps>
...
801064b5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801064ba:	e9 ba f1 ff ff       	jmp    80105679 <alltraps>
...
801064c1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801064c6:	e9 ae f1 ff ff       	jmp    80105679 <alltraps>
...
801064cd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801064d2:	e9 a2 f1 ff ff       	jmp    80105679 <alltraps>
...
801064d9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801064de:	e9 96 f1 ff ff       	jmp    80105679 <alltraps>
...
801064e5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801064ea:	e9 8a f1 ff ff       	jmp    80105679 <alltraps>
...
801064f1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801064f6:	e9 7e f1 ff ff       	jmp    80105679 <alltraps>
...
801064fd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106502:	e9 72 f1 ff ff       	jmp    80105679 <alltraps>
...
80106509:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010650e:	e9 66 f1 ff ff       	jmp    80105679 <alltraps>
...
80106515:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010651a:	e9 5a f1 ff ff       	jmp    80105679 <alltraps>
...
80106521:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106526:	e9 4e f1 ff ff       	jmp    80105679 <alltraps>
...
8010652d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106532:	e9 42 f1 ff ff       	jmp    80105679 <alltraps>
...
80106539:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010653e:	e9 36 f1 ff ff       	jmp    80105679 <alltraps>
...
80106545:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010654a:	e9 2a f1 ff ff       	jmp    80105679 <alltraps>
...
80106551:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106556:	e9 1e f1 ff ff       	jmp    80105679 <alltraps>
...
8010655d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106562:	e9 12 f1 ff ff       	jmp    80105679 <alltraps>
...
80106569:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010656e:	e9 06 f1 ff ff       	jmp    80105679 <alltraps>
...
80106575:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010657a:	e9 fa f0 ff ff       	jmp    80105679 <alltraps>
...
80106581:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106586:	e9 ee f0 ff ff       	jmp    80105679 <alltraps>
...
8010658d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106592:	e9 e2 f0 ff ff       	jmp    80105679 <alltraps>
...
80106599:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010659e:	e9 d6 f0 ff ff       	jmp    80105679 <alltraps>
...
801065a5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801065aa:	e9 ca f0 ff ff       	jmp    80105679 <alltraps>
...
801065b1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801065b6:	e9 be f0 ff ff       	jmp    80105679 <alltraps>
...
801065bd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801065c2:	e9 b2 f0 ff ff       	jmp    80105679 <alltraps>
...
801065c9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801065ce:	e9 a6 f0 ff ff       	jmp    80105679 <alltraps>
...
801065d5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801065da:	e9 9a f0 ff ff       	jmp    80105679 <alltraps>
...
801065e1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801065e6:	e9 8e f0 ff ff       	jmp    80105679 <alltraps>
...
801065ed:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801065f2:	e9 82 f0 ff ff       	jmp    80105679 <alltraps>
...
8010665a:	e8 b1 dd ff ff       	call   80104410 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801066fd:	68 70 78 10 80       	push   $0x80107870
...
801067b3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801067b6:	e8 95 cf ff ff       	call   80103750 <cpuid>
...
801068f4:	0f 84 c4 00 00 00    	je     801069be <switchuvm+0xee>
  ...
  pushcli();
801068fa:	e8 31 d9 ff ff       	call   80104230 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068ff:	e8 cc cd ff ff       	call   801036d0 <mycpu>
80106904:	89 c3                	mov    %eax,%ebx
80106906:	e8 c5 cd ff ff       	call   801036d0 <mycpu>
8010690b:	89 c7                	mov    %eax,%edi
8010690d:	e8 be cd ff ff       	call   801036d0 <mycpu>
80106912:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106915:	83 c7 08             	add    $0x8,%edi
80106918:	e8 b3 cd ff ff       	call   801036d0 <mycpu>
...
80106959:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
8010695e:	e8 6d cd ff ff       	call   801036d0 <mycpu>
80106963:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
8010696a:	e8 61 cd ff ff       	call   801036d0 <mycpu>
...
80106986:	89 48 0c             	mov    %ecx,0xc(%eax)
  ...
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106989:	e8 42 cd ff ff       	call   801036d0 <mycpu>
...
801069ab:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801069ac:	e9 bf d8 ff ff       	jmp    80104270 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
801069b4:	68 76 78 10 80       	push   $0x80107876
...
801069c1:	68 a1 78 10 80       	push   $0x801078a1
...
801069ce:	68 8c 78 10 80       	push   $0x8010788c
...
80106a0f:	e8 fc d9 ff ff       	call   80104410 <memset>
...
80106a40:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106a41:	e9 7a da ff ff       	jmp    801044c0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106b63:	e8 a8 d8 ff ff       	call   80104410 <memset>
...
80106ba1:	68 ed 78 10 80       	push   $0x801078ed
...
80106cbc:	68 21 79 10 80       	push   $0x80107921
...
80106cf0:	e8 1b d7 ff ff       	call   80104410 <memset>
...
80106d8f:	68 32 79 10 80       	push   $0x80107932
...
80106de0:	e8 db d6 ff ff       	call   801044c0 <memmove>
...
80106e85:	68 56 79 10 80       	push   $0x80107956
...
80106e92:	68 3c 79 10 80       	push   $0x8010793c
...
80106f1f:	e8 9c d5 ff ff       	call   801044c0 <memmove>
    len -= n;
    buf += n;
