...
int main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
	...
	int pid=fork();
   f:	e8 76 02 00 00       	call   28a <fork>
  14:	89 c3                	mov    %eax,%ebx
  16:	eb 1f                	jmp    37 <main+0x37>
  18:	90                   	nop
  19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
	while(1)
	{
		if(pid==0) printf(1,"Child\n");
  20:	83 ec 08             	sub    $0x8,%esp
  23:	68 10 07 00 00       	push   $0x710
  28:	6a 01                	push   $0x1
  2a:	e8 c1 03 00 00       	call   3f0 <printf>
  2f:	83 c4 10             	add    $0x10,%esp
		else printf(1,"Parent\n");
		yield();
  32:	e8 03 03 00 00       	call   33a <yield>
{
  ...
  3e:	68 17 07 00 00       	push   $0x717
  43:	6a 01                	push   $0x1
  45:	e8 a6 03 00 00       	call   3f0 <printf>
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 1f 07 00 00       	mov    $0x71f,%eax
...
free(void *ap)
{
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 c4 09 00 00       	mov    %eax,0x9c4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 67f:	76 3f                	jbe    6c0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	39 05 c4 09 00 00    	cmp    %eax,0x9c4
 ...
 6a6:	e8 e5 fe ff ff       	call   590 <free>
  return freep;
 6ab:	8b 15 c4 09 00 00    	mov    0x9c4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 c4 09 00 00    	mov    %edx,0x9c4
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 c4 09 00 00 c8 	movl   $0x9c8,0x9c4
 6ed:	09 00 00 
 6f0:	c7 05 c8 09 00 00 c8 	movl   $0x9c8,0x9c8
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 c8 09 00 00       	mov    $0x9c8,%eax
 6ff:	c7 05 cc 09 00 00 00 	movl   $0x0,0x9cc
 706:	00 00 00 
