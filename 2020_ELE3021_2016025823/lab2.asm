...
main(int argc , char* argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
	printf(1,"pid\t: %d\n",getpid());
  11:	e8 ec 02 00 00       	call   302 <getpid>
  16:	83 ec 04             	sub    $0x4,%esp
  19:	50                   	push   %eax
  1a:	68 01 07 00 00       	push   $0x701
  1f:	6a 01                	push   $0x1
  21:	e8 ba 03 00 00       	call   3e0 <printf>
	printf(1,"ppid\t: %d\n",getppid());
  26:	e8 f7 02 00 00       	call   322 <getppid>
  2b:	83 c4 0c             	add    $0xc,%esp
  2e:	50                   	push   %eax
  2f:	68 00 07 00 00       	push   $0x700
  34:	6a 01                	push   $0x1
  36:	e8 a5 03 00 00       	call   3e0 <printf>
	exit();
  3b:	e8 42 02 00 00       	call   282 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 14 07 00 00 	movzbl 0x714(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 0b 07 00 00       	mov    $0x70b,%eax
